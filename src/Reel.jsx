...
{ q: "Who directed Get Out?", options: ["Jordan Peele", "Spike Lee", "Barry Jenkins", "Steve McQueen"], answer: "Jordan Peele", cat: "director", detail: "Jordan Peele's 2017 horror debut" },
  ...
  { q: "Who directed Jurassic Park?", options: ["Steven Spielberg", "James Cameron", "Ridley Scott", "George Lucas"], answer: "Steven Spielberg", cat: "director", detail: "The 1993 dinosaur blockbuster" },
  { q: "Who directed The Dark Knight?", options: ["Christopher Nolan", "Tim Burton", "Zack Snyder", "Matt Reeves"], answer: "Christopher Nolan", cat: "director", detail: "Nolan's 2008 Batman masterpiece" },
  { q: "Who directed Titanic?", options: ["James Cameron", "Steven Spielberg", "Ridley Scott", "Peter Jackson"], answer: "James Cameron", cat: "director", detail: "Cameron's 1997 epic romance" },
  { q: "Who directed Inception?", options: ["Christopher Nolan", "Denis Villeneuve", "Ridley Scott", "David Fincher"], answer: "Christopher Nolan", cat: "director", detail: "Nolan's 2010 dream heist" },
  { q: "Who played the lead in Gladiator?", options: ["Russell Crowe", "Brad Pitt", "Gerard Butler", "Orlando Bloom"], answer: "Russell Crowe", cat: "cast", detail: "Won Best Actor for the role" },
  { q: "Who played Shrek's voice?", options: ["Mike Myers", "Eddie Murphy", "Jack Black", "Will Ferrell"], answer: "Mike Myers", cat: "cast", detail: "Myers also voiced Fat Bastard in Austin Powers" },
  { q: "Who played Lara Croft in the 2001 Tomb Raider?", options: ["Angelina Jolie", "Milla Jovovich", "Kate Beckinsale", "Charlize Theron"], answer: "Angelina Jolie", cat: "cast", detail: "Jolie trained extensively for the role" },
  { q: "Who played the Genie in Aladdin (1992)?", options: ["Robin Williams", "Eddie Murphy", "Jim Carrey", "Will Smith"], answer: "Robin Williams", cat: "cast", detail: "Williams improvised many of his lines" },
  { q: "Who played Maximus in Gladiator?", options: ["Russell Crowe", "Brad Pitt", "Eric Bana", "Joaquin Phoenix"], answer: "Russell Crowe", cat: "cast", detail: "Crowe won the Oscar for the role" },
  { q: "Who played Thanos in the MCU?", options: ["Josh Brolin", "James Brolin", "Mark Ruffalo", "Karl Urban"], answer: "Josh Brolin", cat: "cast", detail: "Motion-capture performance" },
  { q: "Who played John Wick?", options: ["Keanu Reeves", "Liam Neeson", "Jason Statham", "Chris Pratt"], answer: "Keanu Reeves", cat: "cast", detail: "Reeves did most of his own stunts" },
  { q: "Who played Elsa's voice in Frozen?", options: ["Idina Menzel", "Kristen Bell", "Mandy Moore", "Amy Adams"], answer: "Idina Menzel", cat: "cast", detail: "Sang Let It Go" },
  { q: "Who played the lead in Elf?", options: ["Will Ferrell", "Jim Carrey", "Adam Sandler", "Ben Stiller"], answer: "Will Ferrell", cat: "cast", detail: "Buddy the Elf" },
  { q: "Who played Wonder Woman in the 2017 film?", options: ["Gal Gadot", "Scarlett Johansson", "Brie Larson", "Margot Robbie"], answer: "Gal Gadot", cat: "cast", detail: "Gadot's breakout role" },
  { q: "\"That's my secret, Captain. I'm always angry.\"", options: ["The Avengers", "Hulk", "Age of Ultron", "Thor: Ragnarok"], answer: "The Avengers", cat: "quote", detail: "Bruce Banner before transforming" },
  { q: "What color lightsaber does Luke Skywalker originally have?", options: ["Blue", "Green", "Red", "Purple"], answer: "Blue", cat: "trivia", detail: "He gets a green one in Return of the Jedi" },
  { q: "What is the name of Batman's butler?", options: ["Alfred", "Jarvis", "Watson", "Jeeves"], answer: "Alfred", cat: "trivia", detail: "Alfred Pennyworth" },
  { q: "In The Wizard of Oz, what does the Tin Man want?", options: ["A heart", "A brain", "Courage", "A home"], answer: "A heart", cat: "trivia", detail: "The Scarecrow wants a brain" },
  { q: "What type of fish is Nemo?", options: ["Clownfish", "Goldfish", "Angelfish", "Blowfish"], answer: "Clownfish", cat: "trivia", detail: "An ocellaris clownfish" },
  { q: "What is the name of Simba's father?", options: ["Mufasa", "Scar", "Rafiki", "Zazu"], answer: "Mufasa", cat: "trivia", detail: "Voiced by James Earl Jones" },
  { q: "How many films are in the Harry Potter series?", options: ["8", "7", "9", "6"], answer: "8", cat: "trivia", detail: "Deathly Hallows was split into two" },
  { q: "What does Buzz Lightyear think he is?", options: ["A real space ranger", "A robot", "A superhero", "An alien"], answer: "A real space ranger", cat: "trivia", detail: "He doesn't know he's a toy" },
  { q: "In Monsters, Inc., what powers the city?", options: ["Children's screams", "Electricity", "Laughter", "Fear gas"], answer: "Children's screams", cat: "trivia", detail: "Later they switch to laughter" },
  { q: "What do the characters in Inside Out represent?", options: ["Emotions", "Memories", "Dreams", "Personality traits"], answer: "Emotions", cat: "trivia", detail: "Joy, Sadness, Anger, Fear, and Disgust" },
  { q: "What animal does Remy want to become in Ratatouille?", options: ["A chef", "A waiter", "A food critic", "A baker"], answer: "A chef", cat: "trivia", detail: "A rat who dreams of cooking in Paris" },
  { q: "What is Thor's hammer called?", options: ["Mjolnir", "Stormbreaker", "Excalibur", "Gungnir"], answer: "Mjolnir", cat: "trivia", detail: "Only the worthy can lift it" },
  { q: "Who composed the Jurassic Park theme?", options: ["John Williams", "Hans Zimmer", "James Horner", "Danny Elfman"], answer: "John Williams", cat: "soundtrack", detail: "One of Williams' most recognizable melodies" },
  { q: "\"Circle of Life\" is from which film?", options: ["The Lion King", "Bambi", "Tarzan", "The Jungle Book"], answer: "The Lion King", cat: "soundtrack", detail: "Elton John and Tim Rice" },
  { q: "\"Hakuna Matata\" means what?", options: ["No worries", "Hello friend", "Good luck", "Let's eat"], answer: "No worries", cat: "soundtrack", detail: "Timon and Pumbaa's philosophy" },
  { q: "What is the name of the kingdom in Frozen?", options: ["Arendelle", "Corona", "Agrabah", "Genovia"], answer: "Arendelle", cat: "trivia", detail: "Inspired by Norway" },
  { q: "Which film features a volleyball named Wilson?", options: ["Cast Away", "The Blue Lagoon", "Life of Pi", "Swiss Family Robinson"], answer: "Cast Away", cat: "trivia", detail: "Tom Hanks' only companion" },
  { q: "Who played the lead in The Truman Show?", options: ["Jim Carrey", "Robin Williams", "Adam Sandler", "Ben Stiller"], answer: "Jim Carrey", cat: "cast", detail: "Carrey's dramatic breakthrough" },
  { q: "Who played Mia Wallace in Pulp Fiction?", options: ["Uma Thurman", "Sharon Stone", "Nicole Kidman", "Jodie Foster"], answer: "Uma Thurman", cat: "cast", detail: "The twist dance scene" },
  { q: "Who plays Dominic Toretto in Fast and Furious?", options: ["Vin Diesel", "Dwayne Johnson", "Paul Walker", "Jason Statham"], answer: "Vin Diesel", cat: "cast", detail: "Family is everything" },
  { q: "Who played Mrs. Doubtfire?", options: ["Robin Williams", "Dustin Hoffman", "Eddie Murphy", "Martin Lawrence"], answer: "Robin Williams", cat: "cast", detail: "Williams in prosthetic makeup" },
  { q: "Who played Loki in the MCU?", options: ["Tom Hiddleston", "Benedict Cumberbatch", "Tom Hardy", "Cillian Murphy"], answer: "Tom Hiddleston", cat: "cast", detail: "Fan-favorite villain turned antihero" },
  { q: "What are the names of the Home Alone burglars?", options: ["Harry and Marv", "Joe and Bill", "Frank and Dave", "Nick and Steve"], answer: "Harry and Marv", cat: "trivia", detail: "The Wet Bandits" },

  { q: "Who directed Gravity?", options: ["Alfonso Cuarón", "Christopher Nolan", "Ridley Scott", "Denis Villeneuve"], answer: "Alfonso Cuarón", cat: "director", detail: "Won Best Director in 2014" },
  { q: "Who played Groot's voice in Guardians of the Galaxy?", options: ["Vin Diesel", "Bradley Cooper", "Chris Pratt", "Dave Bautista"], answer: "Vin Diesel", cat: "cast", detail: "Only three words but many deliveries" },
  { q: "Who played the voice of Dory in Finding Nemo?", options: ["Ellen DeGeneres", "Tina Fey", "Amy Poehler", "Whoopi Goldberg"], answer: "Ellen DeGeneres", cat: "cast", detail: "Just keep swimming" },
  { q: "Who played Captain America?", options: ["Chris Evans", "Chris Hemsworth", "Robert Downey Jr.", "Sebastian Stan"], answer: "Chris Evans", cat: "cast", detail: "Originally turned down the role twice" },
  { q: "Who played Maleficent in the 2014 film?", options: ["Angelina Jolie", "Cate Blanchett", "Helena Bonham Carter", "Charlize Theron"], answer: "Angelina Jolie", cat: "cast", detail: "A live-action Sleeping Beauty retelling" },
  { q: "Who plays Deadpool?", options: ["Ryan Reynolds", "Chris Pratt", "Ryan Gosling", "Jake Gyllenhaal"], answer: "Ryan Reynolds", cat: "cast", detail: "Reynolds fought for years to make the film" },
  { q: "Who played Willy Wonka in the 1971 film?", options: ["Gene Wilder", "Johnny Depp", "Robin Williams", "Tim Curry"], answer: "Gene Wilder", cat: "cast", detail: "Wilder's iconic candy man" },
  { q: "\"I wish I knew how to quit you.\"", options: ["Brokeback Mountain", "The Notebook", "Call Me by Your Name", "Moonlight"], answer: "Brokeback Mountain", cat: "quote", detail: "Jake Gyllenhaal to Heath Ledger" },
  { q: "What animal does Hagrid give Harry for his birthday?", options: ["An owl", "A cat", "A toad", "A rat"], answer: "An owl", cat: "trivia", detail: "Hedwig the snowy owl" },
  { q: "In Back to the Future, what year does Marty travel to?", options: ["1955", "1965", "1945", "1975"], answer: "1955", cat: "trivia", detail: "The year his parents met" },
  { q: "What is the name of Han Solo's ship?", options: ["Millennium Falcon", "X-Wing", "TIE Fighter", "Star Destroyer"], answer: "Millennium Falcon", cat: "trivia", detail: "She made the Kessel Run in less than twelve parsecs" },
  { q: "In The Matrix, what color pill does Neo take?", options: ["Red", "Blue", "Green", "White"], answer: "Red", cat: "trivia", detail: "The truth pill" },
  { q: "Which Disney film features \"A Whole New World\"?", options: ["Aladdin", "The Little Mermaid", "Beauty and the Beast", "Mulan"], answer: "Aladdin", cat: "soundtrack", detail: "Won Best Original Song" },
  { q: "\"Under the Sea\" is from which film?", options: ["The Little Mermaid", "Finding Nemo", "Moana", "The SpongeBob Movie"], answer: "The Little Mermaid", cat: "soundtrack", detail: "Sebastian the crab's big number" },
  { q: "Which Pixar film was the highest-grossing animated film when released?", options: ["Finding Nemo", "Toy Story", "The Incredibles", "Monsters, Inc."], answer: "Finding Nemo", cat: "boxoffice", detail: "Held the record until Shrek 2" },
  { q: "Which superhero film first crossed $2 billion?", options: ["Avengers: Endgame", "Avatar", "The Avengers", "Black Panther"], answer: "Avengers: Endgame", cat: "boxoffice", detail: "Briefly overtook Avatar as #1 all time" },
  { q: "Who won Best Supporting Actor for The Dark Knight?", options: ["Heath Ledger", "Aaron Eckhart", "Christian Bale", "Gary Oldman"], answer: "Heath Ledger", cat: "oscar", detail: "Posthumous award" },
  { q: "Which animated film has the most Oscar nominations?", options: ["Beauty and the Beast (6)", "Up (5)", "Toy Story 3 (5)", "WALL-E (6)"], answer: "Beauty and the Beast (6)", cat: "oscar", detail: "First animated film nominated for Best Picture" },

  { q: "Who played the voice of Buzz Lightyear in Toy Story?", options: ["Tim Allen", "Tom Hanks", "Billy Crystal", "Robin Williams"], answer: "Tim Allen", cat: "cast", detail: "To infinity and beyond" },
  { q: "Who played Legolas in Lord of the Rings?", options: ["Orlando Bloom", "Viggo Mortensen", "Elijah Wood", "Sean Astin"], answer: "Orlando Bloom", cat: "cast", detail: "The elf archer" },
  { q: "Who played Clarice Starling in The Silence of the Lambs?", options: ["Jodie Foster", "Sigourney Weaver", "Julia Roberts", "Meg Ryan"], answer: "Jodie Foster", cat: "cast", detail: "Won Best Actress" },
  { q: "Who played the lead in The Notebook?", options: ["Ryan Gosling", "Ryan Reynolds", "Josh Hartnett", "Channing Tatum"], answer: "Ryan Gosling", cat: "cast", detail: "Gosling and McAdams as Noah and Allie" },
  { q: "Who played Aragorn in Lord of the Rings?", options: ["Viggo Mortensen", "Orlando Bloom", "Sean Bean", "Karl Urban"], answer: "Viggo Mortensen", cat: "cast", detail: "He actually deflected a real knife thrown at him" },
  { q: "Who played Agent Smith in The Matrix?", options: ["Hugo Weaving", "Keanu Reeves", "Laurence Fishburne", "Ralph Fiennes"], answer: "Hugo Weaving", cat: "cast", detail: "Mr. Anderson..." },
  { q: "Who played Simba's voice in The Lion King (1994)?", options: ["Matthew Broderick", "Jonathan Taylor Thomas", "Jeremy Irons", "James Earl Jones"], answer: "Matthew Broderick", cat: "cast", detail: "Adult Simba" },
  { q: "\"I'm walking here!\"", options: ["Midnight Cowboy", "Taxi Driver", "Saturday Night Fever", "Goodfellas"], answer: "Midnight Cowboy", cat: "quote", detail: "Dustin Hoffman improvised it" },
  { q: "\"Mama says stupid is as stupid does.\"", options: ["Forrest Gump", "The Waterboy", "Big Daddy", "Billy Madison"], answer: "Forrest Gump", cat: "quote", detail: "Tom Hanks as Forrest" },
  { q: "\"Keep your friends close, but your enemies closer.\"", options: ["The Godfather Part II", "The Godfather", "Scarface", "Goodfellas"], answer: "The Godfather Part II", cat: "quote", detail: "Michael Corleone's wisdom" },
  { q: "What is the name of the necklace in Titanic?", options: ["The Heart of the Ocean", "The Star of India", "The Blue Diamond", "The Hope Diamond"], answer: "The Heart of the Ocean", cat: "trivia", detail: "A blue diamond necklace" },
  { q: "In Toy Story, what is the neighbor kid's name?", options: ["Sid", "Todd", "Greg", "Mike"], answer: "Sid", cat: "trivia", detail: "The toy-destroying bully" },
  { q: "What are the names of the two main characters in Up?", options: ["Carl and Russell", "Bob and Kevin", "Walter and Jesse", "Fred and George"], answer: "Carl and Russell", cat: "trivia", detail: "The old man and the boy scout" },
  { q: "What is the name of Ariel's fish friend?", options: ["Flounder", "Sebastian", "Scuttle", "Gill"], answer: "Flounder", cat: "trivia", detail: "The Little Mermaid's sidekick" },
  { q: "What is Darth Vader's real name?", options: ["Anakin Skywalker", "Luke Skywalker", "Obi-Wan Kenobi", "Palpatine"], answer: "Anakin Skywalker", cat: "trivia", detail: "Turned to the dark side" },
  { q: "What is the name of the dragon in How to Train Your Dragon?", options: ["Toothless", "Smaug", "Drogon", "Mushu"], answer: "Toothless", cat: "trivia", detail: "A Night Fury dragon" },
  { q: "In Ghostbusters, what should you never do?", options: ["Cross the streams", "Look at the trap", "Touch the proton pack", "Say the name"], answer: "Cross the streams", cat: "trivia", detail: "Total protonic reversal" },
  { q: "\"Some people are worth melting for.\"", options: ["Frozen", "Ice Age", "The Snowman", "Happy Feet"], answer: "Frozen", cat: "quote", detail: "Olaf the snowman" },
  { q: "Who plays Shuri in Black Panther?", options: ["Letitia Wright", "Lupita Nyong'o", "Danai Gurira", "Angela Bassett"], answer: "Letitia Wright", cat: "cast", detail: "T'Challa's genius sister" },
  { q: "Who plays Newt Scamander in Fantastic Beasts?", options: ["Eddie Redmayne", "Benedict Cumberbatch", "Tom Holland", "Robert Pattinson"], answer: "Eddie Redmayne", cat: "cast", detail: "The magizoologist" },
  { q: "Which Disney film features \"Part of Your World\"?", options: ["The Little Mermaid", "Frozen", "Moana", "Tangled"], answer: "The Little Mermaid", cat: "soundtrack", detail: "Ariel's dream of being human" },
  { q: "Which was the first sequel to win Best Picture?", options: ["The Godfather Part II", "The Lord of the Rings: Return of the King", "The Silence of the Lambs", "Aliens"], answer: "The Godfather Part II", cat: "oscar", detail: "In 1975" },

  { q: "Who played Draco Malfoy in Harry Potter?", options: ["Tom Felton", "Rupert Grint", "Daniel Radcliffe", "Robert Pattinson"], answer: "Tom Felton", cat: "cast", detail: "Harry's school rival" },
  { q: "Who played Buzz Lightyear's voice in the Toy Story sequels?", options: ["Tim Allen", "Tom Hanks", "Chris Evans", "Patrick Warburton"], answer: "Tim Allen", cat: "cast", detail: "Allen voiced Buzz in all four films" },
  { q: "Who played Mufasa's voice in The Lion King (1994)?", options: ["James Earl Jones", "Matthew Broderick", "Jeremy Irons", "Tim Curry"], answer: "James Earl Jones", cat: "cast", detail: "The same voice as Darth Vader" },
  { q: "Who played Mary Poppins in the 1964 film?", options: ["Julie Andrews", "Audrey Hepburn", "Debbie Reynolds", "Angela Lansbury"], answer: "Julie Andrews", cat: "cast", detail: "Won Best Actress for her film debut" },
  { q: "Who played Rapunzel's voice in Tangled?", options: ["Mandy Moore", "Kristen Bell", "Idina Menzel", "Amy Adams"], answer: "Mandy Moore", cat: "cast", detail: "Moore also sang all the songs" },
  { q: "Who played the voice of Donkey in Shrek?", options: ["Eddie Murphy", "Chris Rock", "Kevin Hart", "Mike Myers"], answer: "Eddie Murphy", cat: "cast", detail: "Murphy improvised many of his lines" },
  { q: "Who played Spider-Man in the original trilogy?", options: ["Tobey Maguire", "Andrew Garfield", "Tom Holland", "Jake Gyllenhaal"], answer: "Tobey Maguire", cat: "cast", detail: "Sam Raimi's 2002-2007 trilogy" },
  { q: "\"Wakanda forever!\"", options: ["Black Panther", "Avengers: Endgame", "Thor: Ragnarok", "Captain America: Civil War"], answer: "Black Panther", cat: "quote", detail: "The Wakandan salute" },
  { q: "\"I am inevitable.\"", options: ["Avengers: Endgame", "Avengers: Infinity War", "Thor", "Guardians of the Galaxy"], answer: "Avengers: Endgame", cat: "quote", detail: "Thanos before the snap" },
  { q: "In Monsters, Inc., what is Boo's real name?", options: ["Mary", "Emma", "Lucy", "Sarah"], answer: "Mary", cat: "trivia", detail: "You can see it on her drawings" },
  { q: "What is Shrek's wife's name?", options: ["Fiona", "Elsa", "Rapunzel", "Belle"], answer: "Fiona", cat: "trivia", detail: "Princess by day, ogre by night" },
  { q: "In The Incredibles, what is the family's last name?", options: ["Parr", "Powers", "Strong", "Incredible"], answer: "Parr", cat: "trivia", detail: "Bob and Helen Parr" },
  { q: "How many Harry Potter books and films are there?", options: ["7 books, 8 films", "8 books, 8 films", "7 books, 7 films", "6 books, 8 films"], answer: "7 books, 8 films", cat: "trivia", detail: "Deathly Hallows was split into two films" },
  { q: "What is the name of Buzz Lightyear's archenemy?", options: ["Emperor Zurg", "Sid", "Lotso", "Stinky Pete"], answer: "Emperor Zurg", cat: "trivia", detail: "Also claims to be his father" },
  { q: "Which film features \"You've Got a Friend in Me\"?", options: ["Toy Story", "Finding Nemo", "Cars", "Inside Out"], answer: "Toy Story", cat: "soundtrack", detail: "Randy Newman's classic" },
  { q: "Which Disney film features \"Be Our Guest\"?", options: ["Beauty and the Beast", "Aladdin", "The Little Mermaid", "Cinderella"], answer: "Beauty and the Beast", cat: "soundtrack", detail: "Lumière's showstopper" },
  { q: "Which Pixar film has the highest Rotten Tomatoes score?", options: ["Toy Story 2 (100%)", "Inside Out (98%)", "Finding Nemo (99%)", "WALL-E (96%)"], answer: "Toy Story 2 (100%)", cat: "boxoffice", detail: "A perfect score from critics" },
  { q: "What was the highest-grossing film of 2019?", options: ["Avengers: Endgame", "The Lion King", "Frozen II", "Spider-Man: Far From Home"], answer: "Avengers: Endgame", cat: "boxoffice", detail: "Briefly the highest-grossing film ever" },
  { q: "Who won Best Actress for La La Land?", options: ["Emma Stone", "Natalie Portman", "Isabelle Huppert", "Ruth Negga"], answer: "Emma Stone", cat: "oscar", detail: "Stone's first Oscar" },
  { q: "Which Disney Renaissance film was released first?", options: ["The Little Mermaid", "Beauty and the Beast", "Aladdin", "The Lion King"], answer: "The Little Mermaid", cat: "year", detail: "1989 kicked off the Renaissance" },

  { q: "Who directed the first Transformers movie?", options: ["Michael Bay", "Steven Spielberg", "James Cameron", "Zack Snyder"], answer: "Michael Bay", cat: "director", detail: "Bay's 2007 blockbuster" },
  { q: "Who played the Grinch in the 2000 film?", options: ["Jim Carrey", "Mike Myers", "Robin Williams", "Eddie Murphy"], answer: "Jim Carrey", cat: "cast", detail: "Carrey spent hours in makeup daily" },
  { q: "Who played Marty McFly in Back to the Future?", options: ["Michael J. Fox", "Tom Cruise", "Matthew Broderick", "John Cusack"], answer: "Michael J. Fox", cat: "cast", detail: "Fox replaced Eric Stoltz during filming" },
  { q: "Who played Princess Leia?", options: ["Carrie Fisher", "Natalie Portman", "Daisy Ridley", "Felicity Jones"], answer: "Carrie Fisher", cat: "cast", detail: "An icon of cinema" },
  { q: "Who played Sandy in Grease?", options: ["Olivia Newton-John", "Debbie Harry", "Carrie Fisher", "Farrah Fawcett"], answer: "Olivia Newton-John", cat: "cast", detail: "Newton-John was 29 playing a teenager" },
  { q: "Who played the Cat in the Hat in the 2003 film?", options: ["Mike Myers", "Jim Carrey", "Jack Black", "Eddie Murphy"], answer: "Mike Myers", cat: "cast", detail: "Dr. Seuss adaptation" },
  { q: "Who played Ace Ventura?", options: ["Jim Carrey", "Adam Sandler", "Chris Farley", "Dana Carvey"], answer: "Jim Carrey", cat: "cast", detail: "Carrey's breakout comedy role" },
  { q: "\"This is Sparta!\"", options: ["300", "Gladiator", "Troy", "Braveheart"], answer: "300", cat: "quote", detail: "Gerard Butler kicking a messenger" },
  { q: "\"You're a wizard, Harry.\"", options: ["Harry Potter and the Philosopher's Stone", "Harry Potter and the Chamber of Secrets", "Fantastic Beasts", "The Lord of the Rings"], answer: "Harry Potter and the Philosopher's Stone", cat: "quote", detail: "Hagrid delivers the news" },
  { q: "\"Run, Forrest, run!\"", options: ["Forrest Gump", "The Fugitive", "Logan", "Mission Impossible"], answer: "Forrest Gump", cat: "quote", detail: "Young Jenny shouting from the porch" },
  { q: "\"I am Iron Man.\"", options: ["Iron Man", "Avengers: Endgame", "Iron Man 2", "The Avengers"], answer: "Iron Man", cat: "quote", detail: "Tony Stark's press conference reveal" },
  { q: "\"So you're telling me there's a chance?\"", options: ["Dumb and Dumber", "Ace Ventura", "Liar Liar", "The Mask"], answer: "Dumb and Dumber", cat: "quote", detail: "Jim Carrey's eternal optimism" },
  { q: "What is the name of Rapunzel's chameleon?", options: ["Pascal", "Maximus", "Flynn", "Lance"], answer: "Pascal", cat: "trivia", detail: "A green chameleon sidekick" },
  { q: "What is the name of the restaurant in Ratatouille?", options: ["Gusteau's", "Linguini's", "Remy's", "Le Cordon Bleu"], answer: "Gusteau's", cat: "trivia", detail: "Anyone can cook" },
  { q: "In Up, where does Carl want to go?", options: ["Paradise Falls", "Angel Falls", "Niagara Falls", "Victoria Falls"], answer: "Paradise Falls", cat: "trivia", detail: "Based on Angel Falls in Venezuela" },
  { q: "Who sang \"How Far I'll Go\" in Moana?", options: ["Auli'i Cravalho", "Idina Menzel", "Mandy Moore", "Kristen Bell"], answer: "Auli'i Cravalho", cat: "soundtrack", detail: "Cravalho was 14 when she recorded it" },
  { q: "\"We Don't Talk About Bruno\" is from which film?", options: ["Encanto", "Coco", "Moana", "Luca"], answer: "Encanto", cat: "soundtrack", detail: "Lin-Manuel Miranda's viral hit" },
  { q: "Which was the highest-grossing film of 2023?", options: ["Barbie", "Oppenheimer", "The Super Mario Bros. Movie", "Guardians of the Galaxy Vol. 3"], answer: "Barbie", cat: "boxoffice", detail: "Over $1.4 billion worldwide" },
  { q: "Which animated film was the first to gross $1 billion?", options: ["Toy Story 3", "Frozen", "Finding Nemo", "Shrek 2"], answer: "Toy Story 3", cat: "boxoffice", detail: "In 2010" },

  { q: "Who played Obi-Wan Kenobi in the prequel trilogy?", options: ["Ewan McGregor", "Liam Neeson", "Hayden Christensen", "Samuel L. Jackson"], answer: "Ewan McGregor", cat: "cast", detail: "Taking over from Alec Guinness" },
  { q: "Who played Jason Bourne?", options: ["Matt Damon", "Jeremy Renner", "Mark Wahlberg", "Liam Neeson"], answer: "Matt Damon", cat: "cast", detail: "Damon's action franchise" },
  { q: "Who played Albus Dumbledore in most of the Harry Potter films?", options: ["Michael Gambon", "Richard Harris", "Ian McKellen", "Patrick Stewart"], answer: "Michael Gambon", cat: "cast", detail: "Took over after Richard Harris passed away" },
  { q: "Who played Groot in Guardians of the Galaxy?", options: ["Vin Diesel", "Dave Bautista", "Chris Pratt", "Bradley Cooper"], answer: "Vin Diesel", cat: "cast", detail: "I am Groot" },
  { q: "Who played the lead in The Mask?", options: ["Jim Carrey", "Mike Myers", "Adam Sandler", "Ben Stiller"], answer: "Jim Carrey", cat: "cast", detail: "Carrey's 1994 rubber-faced comedy" },
  { q: "\"I'm the Dude.\"", options: ["The Big Lebowski", "Ferris Bueller's Day Off", "Bill & Ted's Excellent Adventure", "Fast Times at Ridgemont High"], answer: "The Big Lebowski", cat: "quote", detail: "The Dude abides" },
  { q: "\"Shaken, not stirred.\"", options: ["James Bond series", "The Sting", "Casablanca", "The Maltese Falcon"], answer: "James Bond series", cat: "quote", detail: "How Bond likes his martini" },
  { q: "What is the name of the toy store in Toy Story 2?", options: ["Al's Toy Barn", "Toys R Us", "Andy's Room", "Sunnyside"], answer: "Al's Toy Barn", cat: "trivia", detail: "Run by Al McWhiggin" },
  { q: "What is the name of Elsa and Anna's kingdom?", options: ["Arendelle", "Corona", "DunBroch", "Motunui"], answer: "Arendelle", cat: "trivia", detail: "Inspired by Norway" },
  { q: "What powers the cars in Cars?", options: ["Gasoline (they're real cars)", "Electricity", "Solar power", "Magic"], answer: "Gasoline (they're real cars)", cat: "trivia", detail: "Pixar's automobile world" },
  { q: "Which film features \"Let It Go\"?", options: ["Frozen", "Moana", "Tangled", "Brave"], answer: "Frozen", cat: "soundtrack", detail: "Idina Menzel's massive hit" },
  { q: "Which was the highest-grossing animated film of 2023?", options: ["The Super Mario Bros. Movie", "Elemental", "Wish", "Spider-Man: Across the Spider-Verse"], answer: "The Super Mario Bros. Movie", cat: "boxoffice", detail: "Over $1.3 billion worldwide" },
  { q: "Who won Best Animated Feature for Spider-Man: Into the Spider-Verse?", options: ["Sony Pictures Animation", "Pixar", "Disney", "DreamWorks"], answer: "Sony Pictures Animation", cat: "oscar", detail: "Beat Incredibles 2 and Ralph Breaks the Internet" },

  { q: "Who played Scar's voice in The Lion King (1994)?", options: ["Jeremy Irons", "James Earl Jones", "Tim Curry", "Alan Rickman"], answer: "Jeremy Irons", cat: "cast", detail: "Be prepared" },
  { q: "Who played Maui's voice in Moana?", options: ["Dwayne Johnson", "Kevin Hart", "Jason Momoa", "Jack Black"], answer: "Dwayne Johnson", cat: "cast", detail: "You're welcome" },
  { q: "Who plays Venom?", options: ["Tom Hardy", "Woody Harrelson", "Tom Holland", "Andrew Garfield"], answer: "Tom Hardy", cat: "cast", detail: "Hardy voices both Eddie and Venom" },
  { q: "Who plays the lead in Jumanji: Welcome to the Jungle?", options: ["Dwayne Johnson", "Kevin Hart", "Jack Black", "Karen Gillan"], answer: "Dwayne Johnson", cat: "cast", detail: "Johnson as Dr. Smolder Bravestone" },
  { q: "\"Let's put a smile on that face.\"", options: ["The Dark Knight", "Joker", "IT", "Batman (1989)"], answer: "The Dark Knight", cat: "quote", detail: "Heath Ledger's Joker" },
  { q: "\"I'm just a girl, standing in front of a boy, asking him to love her.\"", options: ["Notting Hill", "Pretty Woman", "When Harry Met Sally", "Bridget Jones's Diary"], answer: "Notting Hill", cat: "quote", detail: "Julia Roberts to Hugh Grant" },
  { q: "\"Toto, I've a feeling we're not in Kansas anymore.\"", options: ["The Wizard of Oz", "Twister", "Superman", "Alice in Wonderland"], answer: "The Wizard of Oz", cat: "quote", detail: "Dorothy arriving in Oz" },
  { q: "What is the name of Lightning McQueen's best friend?", options: ["Mater", "Cruz", "Doc", "Sally"], answer: "Mater", cat: "trivia", detail: "Tow Mater, voiced by Larry the Cable Guy" },
  { q: "What is the name of the villain in The Little Mermaid?", options: ["Ursula", "Maleficent", "Cruella", "The Evil Queen"], answer: "Ursula", cat: "trivia", detail: "The sea witch" },
  { q: "What is the highest-grossing animated franchise?", options: ["Despicable Me / Minions", "Shrek", "Toy Story", "Frozen"], answer: "Despicable Me / Minions", cat: "boxoffice", detail: "Over $4.6 billion combined" },
  { q: "Who directed Avatar?", options: ["James Cameron", "Steven Spielberg", "Peter Jackson", "Ridley Scott"], answer: "James Cameron", cat: "director", detail: "Cameron's 2009 3D epic" },
  { q: "Who directed The Matrix?", options: ["The Wachowskis", "James Cameron", "Ridley Scott", "Christopher Nolan"], answer: "The Wachowskis", cat: "director", detail: "Revolutionized action filmmaking" },
  { q: "Who played Buzz Lightyear's voice in Toy Story?", options: ["Tim Allen", "Tom Hanks", "Billy Crystal", "Robin Williams"], answer: "Tim Allen", cat: "cast", detail: "To infinity and beyond" },
  { q: "Who played the lead in The Hunger Games?", options: ["Jennifer Lawrence", "Shailene Woodley", "Emma Watson", "Kristen Stewart"], answer: "Jennifer Lawrence", cat: "cast", detail: "Lawrence was 21 when cast" },
  { q: "Who played Elsa in Frozen (voice)?", options: ["Idina Menzel", "Kristen Bell", "Mandy Moore", "Demi Lovato"], answer: "Idina Menzel", cat: "cast", detail: "Broadway legend" },
  { q: "Who played Han Solo in Star Wars?", options: ["Harrison Ford", "Mark Hamill", "Alec Guinness", "Billy Dee Williams"], answer: "Harrison Ford", cat: "cast", detail: "Ford's iconic role" },
  { q: "Who played Simba in The Lion King (2019 voice)?", options: ["Donald Glover", "Chiwetel Ejiofor", "John Oliver", "Keegan-Michael Key"], answer: "Donald Glover", cat: "cast", detail: "Also known as Childish Gambino" },
  { q: "Who played Spider-Man in the MCU?", options: ["Tom Holland", "Tobey Maguire", "Andrew Garfield", "Jake Gyllenhaal"], answer: "Tom Holland", cat: "cast", detail: "Youngest Spider-Man" },
  { q: "Who played Darth Vader (voice)?", options: ["James Earl Jones", "David Prowse", "Hayden Christensen", "Ian McDiarmid"], answer: "James Earl Jones", cat: "cast", detail: "Iconic deep voice" },
  { q: "Who plays Groot in Guardians of the Galaxy?", options: ["Vin Diesel", "Dave Bautista", "Bradley Cooper", "Chris Pratt"], answer: "Vin Diesel", cat: "cast", detail: "Only says I am Groot" },
  { q: "What color is Shrek?", options: ["Green", "Blue", "Brown", "Purple"], answer: "Green", cat: "trivia", detail: "The big green ogre" },
  { q: "What kind of fish is Nemo?", options: ["Clownfish", "Goldfish", "Angelfish", "Betta fish"], answer: "Clownfish", cat: "trivia", detail: "Also called anemonefish" },
  { q: "In Toy Story, what is Buzz Lightyear?", options: ["A space ranger", "A cowboy", "A dinosaur", "A slinky dog"], answer: "A space ranger", cat: "trivia", detail: "Star Command's finest" },
  { q: "What does the Infinity Gauntlet do when all stones are collected?", options: ["Allows the user to reshape reality", "Destroys all galaxies", "Grants immortality", "Creates new universes"], answer: "Allows the user to reshape reality", cat: "trivia", detail: "Thanos used it to snap away half of all life" },
  { q: "In Frozen, what is Elsa's power?", options: ["Ice and snow", "Fire", "Wind", "Water"], answer: "Ice and snow", cat: "trivia", detail: "The cold never bothered her anyway" },
  { q: "In The Wizard of Oz, where does Dorothy want to go?", options: ["Home", "Emerald City", "The castle", "Kansas City"], answer: "Home", cat: "trivia", detail: "There's no place like home" },
  { q: "What animal does Remy want to be in Ratatouille?", options: ["A chef", "A waiter", "A food critic", "A baker"], answer: "A chef", cat: "trivia", detail: "Anyone can cook" },
  { q: "What does Dory keep forgetting in Finding Nemo?", options: ["Everything (short-term memory loss)", "Her name", "Where she lives", "Her parents"], answer: "Everything (short-term memory loss)", cat: "trivia", detail: "Just keep swimming" },
  { q: "In UP, what does Carl's house fly with?", options: ["Balloons", "Rockets", "A propeller", "Magic"], answer: "Balloons", cat: "trivia", detail: "Thousands of helium balloons" },
  { q: "What is the name of Harry Potter's owl?", options: ["Hedwig", "Errol", "Pigwidgeon", "Scabbers"], answer: "Hedwig", cat: "trivia", detail: "A snowy owl" },
  { q: "\"You're a wizard, Harry.\"", options: ["Harry Potter", "The Lord of the Rings", "The Chronicles of Narnia", "Percy Jackson"], answer: "Harry Potter", cat: "quote", detail: "Hagrid's iconic line" },
  { q: "\"I am your father.\"", options: ["Star Wars: The Empire Strikes Back", "Star Wars: A New Hope", "Star Wars: Return of the Jedi", "Star Wars: Revenge of the Sith"], answer: "Star Wars: The Empire Strikes Back", cat: "quote", detail: "Darth Vader's big reveal" },
  { q: "Which film is the highest-grossing animated film of all time?", options: ["Frozen II", "The Lion King (2019)", "Incredibles 2", "Toy Story 4"], answer: "Frozen II", cat: "boxoffice", detail: "Over $1.4 billion worldwide" },
  { q: "Which Spider-Man actor's first film made the most opening weekend?", options: ["Tom Holland", "Tobey Maguire", "Andrew Garfield", "They all tied"], answer: "Tom Holland", cat: "boxoffice", detail: "Spider-Man: Homecoming opened big thanks to MCU" },
  { q: "Who won Best Picture for 2023 (96th ceremony)?", options: ["Oppenheimer", "Barbie", "Poor Things", "Killers of the Flower Moon"], answer: "Oppenheimer", cat: "oscar", detail: "Christopher Nolan's first win" },
  { q: "How many films are in the main Harry Potter series?", options: ["8", "7", "9", "6"], answer: "8", cat: "trivia", detail: "Deathly Hallows was split into two" },
  { q: "How many Toy Story films are there?", options: ["4", "3", "5", "2"], answer: "4", cat: "trivia", detail: "Toy Story 4 released in 2019" },
  { q: "What is the name of the school in Harry Potter?", options: ["Hogwarts", "Beauxbatons", "Durmstrang", "Ilvermorny"], answer: "Hogwarts", cat: "trivia", detail: "Hogwarts School of Witchcraft and Wizardry" },
  { q: "Who is Buzz Lightyear's nemesis in Toy Story 2?", options: ["Emperor Zurg", "Stinky Pete", "Lotso", "Sid"], answer: "Emperor Zurg", cat: "trivia", detail: "Parody of Darth Vader" },
  { q: "Who directed Ghostbusters (1984)?", options: ["Ivan Reitman", "Harold Ramis", "Dan Aykroyd", "John Landis"], answer: "Ivan Reitman", cat: "director", detail: "Comedy classic" },
  { q: "Who played Puss in Boots in Shrek 2?", options: ["Antonio Banderas", "Benicio Del Toro", "Javier Bardem", "Penélope Cruz"], answer: "Antonio Banderas", cat: "cast", detail: "Got his own spinoff film" },
  { q: "Who played Luke Skywalker?", options: ["Mark Hamill", "Harrison Ford", "Alec Guinness", "Ewan McGregor"], answer: "Mark Hamill", cat: "cast", detail: "The original trilogy's hero" },
  { q: "Who played Lara Croft in the original Tomb Raider films?", options: ["Angelina Jolie", "Alicia Vikander", "Milla Jovovich", "Kate Beckinsale"], answer: "Angelina Jolie", cat: "cast", detail: "2001 and 2003 films" },
  { q: "In The Lion King, what phrase means 'no worries'?", options: ["Hakuna Matata", "Asante Sana", "Jambo Bwana", "Simba Kuu"], answer: "Hakuna Matata", cat: "trivia", detail: "For the rest of your days" },
  { q: "What is the name of Thor's hammer?", options: ["Mjolnir", "Stormbreaker", "Gungnir", "Hofund"], answer: "Mjolnir", cat: "trivia", detail: "Only the worthy can lift it" },
  { q: "How many films are in the Star Wars original trilogy?", options: ["3", "4", "6", "2"], answer: "3", cat: "trivia", detail: "A New Hope, Empire, Return of the Jedi" },
  { q: "What is the name of the lion villain in The Lion King?", options: ["Scar", "Mufasa", "Simba", "Rafiki"], answer: "Scar", cat: "trivia", detail: "Long live the king" },
  { q: "What color lightsaber does Darth Vader use?", options: ["Red", "Blue", "Green", "Purple"], answer: "Red", cat: "trivia", detail: "Sith use red kyber crystals" },
  { q: "Who is Iron Man's AI assistant?", options: ["JARVIS", "FRIDAY", "EDITH", "Karen"], answer: "JARVIS", cat: "trivia", detail: "Later became Vision" },
  { q: "What does Groot always say?", options: ["I am Groot", "We are Groot", "Groot says hello", "I'm Groot, baby"], answer: "I am Groot", cat: "trivia", detail: "Three words, infinite meanings" },
  { q: "What is WALL-E's job?", options: ["Trash compactor", "Space explorer", "Garden robot", "Security bot"], answer: "Trash compactor", cat: "trivia", detail: "Waste Allocation Load Lifter Earth-class" },
  { q: "Who is Woody's love interest in Toy Story?", options: ["Bo Peep", "Jessie", "Barbie", "Dolly"], answer: "Bo Peep", cat: "trivia", detail: "Returns in Toy Story 4" },
  { q: "What type of toy is Rex in Toy Story?", options: ["T-Rex dinosaur", "Dragon", "Stegosaurus", "Raptor"], answer: "T-Rex dinosaur", cat: "trivia", detail: "Anxious and lovable" },
  { q: "\"You had me at hello.\"", options: ["Jerry Maguire", "When Harry Met Sally", "Notting Hill", "Sleepless in Seattle"], answer: "Jerry Maguire", cat: "quote", detail: "Renée Zellweger to Tom Cruise" },
  { q: "Which film made more: Barbie or Oppenheimer?", options: ["Barbie", "Oppenheimer", "They tied", "Neither crossed $1B"], answer: "Barbie", cat: "boxoffice", detail: "$1.4B vs $950M worldwide" },
  { q: "Which Pixar film was the first to gross $1 billion?", options: ["Toy Story 3", "Finding Nemo", "Incredibles 2", "Inside Out"], answer: "Toy Story 3", cat: "boxoffice", detail: "In 2010" },
  { q: "How many films has Tom Hanks been in?", options: ["Over 80", "Over 50", "Over 100", "Over 40"], answer: "Over 80", cat: "bts", detail: "Including voice roles" },
  { q: "Which Disney princess was the first to not have a love interest?", options: ["Merida (Brave)", "Moana", "Elsa (Frozen)", "Rapunzel"], answer: "Merida (Brave)", cat: "bts", detail: "2012's Brave broke the mold" },
  { q: "Which film was the first to use CGI?", options: ["Westworld (1973)", "Tron", "Star Wars", "The Last Starfighter"], answer: "Westworld (1973)", cat: "bts", detail: "Used pixelated imagery for robot POV" },
  { q: "Who plays Maui in Moana?", options: ["Dwayne Johnson", "Jason Momoa", "Chris Hemsworth", "John Cena"], answer: "Dwayne Johnson", cat: "cast", detail: "You're welcome!" },
  { q: "Who plays Rapunzel in Tangled?", options: ["Mandy Moore", "Kristen Bell", "Amanda Seyfried", "Anna Kendrick"], answer: "Mandy Moore", cat: "cast", detail: "Moore also sang all the songs" },
  { q: "Who plays Dory in Finding Nemo?", options: ["Ellen DeGeneres", "Tina Fey", "Amy Poehler", "Wanda Sykes"], answer: "Ellen DeGeneres", cat: "cast", detail: "Just keep swimming" },
  { q: "Who plays Sulley in Monsters, Inc.?", options: ["John Goodman", "Billy Crystal", "Steve Buscemi", "James Coburn"], answer: "John Goodman", cat: "cast", detail: "The big blue monster" },
  { q: "Who plays Mike Wazowski in Monsters, Inc.?", options: ["Billy Crystal", "John Goodman", "Steve Buscemi", "Ben Stiller"], answer: "Billy Crystal", cat: "cast", detail: "The green one-eyed monster" },
  { q: "Who plays Po in Kung Fu Panda?", options: ["Jack Black", "Seth Rogen", "Ben Stiller", "Will Ferrell"], answer: "Jack Black", cat: "cast", detail: "The Dragon Warrior" },
  { q: "Who plays Lightning McQueen in Cars?", options: ["Owen Wilson", "Paul Newman", "Larry the Cable Guy", "Cheech Marin"], answer: "Owen Wilson", cat: "cast", detail: "Ka-chow!" },
  { q: "Who played James Bond before Daniel Craig?", options: ["Pierce Brosnan", "Timothy Dalton", "Sean Connery", "Roger Moore"], answer: "Pierce Brosnan", cat: "cast", detail: "From 1995 to 2002" },
  { q: "Who played Frodo in Lord of the Rings?", options: ["Elijah Wood", "Daniel Radcliffe", "Tobey Maguire", "Orlando Bloom"], answer: "Elijah Wood", cat: "cast", detail: "Ring bearer" },
  { q: "What are the names of the Toy Story aliens' catchphrase?", options: ["The Claw!", "Take me to your leader!", "We come in peace!", "Ooooooh!"], answer: "The Claw!", cat: "trivia", detail: "The claw chooses who will go and who will stay" },
  { q: "In Cars, what number is Lightning McQueen?", options: ["95", "86", "42", "7"], answer: "95", cat: "trivia", detail: "Named after Pixar's founding year" },
  { q: "What is the name of Carl's wife in Up?", options: ["Ellie", "Eva", "Emma", "Emily"], answer: "Ellie", cat: "trivia", detail: "Their love story opens the film" },
  { q: "In Inside Out, what are the 5 emotions?", options: ["Joy, Sadness, Anger, Fear, Disgust", "Joy, Sadness, Anger, Fear, Surprise", "Joy, Sadness, Rage, Fear, Disgust", "Joy, Sadness, Anger, Panic, Disgust"], answer: "Joy, Sadness, Anger, Fear, Disgust", cat: "trivia", detail: "Inside Riley's head" },
  { q: "What is the name of Andy's neighbor who destroys toys in Toy Story?", options: ["Sid", "Scud", "Spike", "Stinky Pete"], answer: "Sid", cat: "trivia", detail: "Sid Phillips" },
  { q: "What is the name of Rapunzel's chameleon in Tangled?", options: ["Pascal", "Maximus", "Flynn", "Shorty"], answer: "Pascal", cat: "trivia", detail: "Her loyal companion" },
  { q: "What kind of animal is Timon in The Lion King?", options: ["Meerkat", "Warthog", "Mongoose", "Prairie dog"], answer: "Meerkat", cat: "trivia", detail: "Timon and Pumbaa" },
  { q: "\"Oh yes, the past can hurt.\"", options: ["The Lion King", "Kung Fu Panda", "Mulan", "Bambi"], answer: "The Lion King", cat: "quote", detail: "Rafiki's wisdom" },
  { q: "Which studio made Shrek?", options: ["DreamWorks", "Pixar", "Disney", "Blue Sky"], answer: "DreamWorks", cat: "bts", detail: "DreamWorks Animation" },
  { q: "Which was the first film to gross over $1 billion worldwide?", options: ["Titanic", "Jurassic Park", "Star Wars", "The Lord of the Rings"], answer: "Titanic", cat: "boxoffice", detail: "In 1997" },
  { q: "Who directed Spirited Away?", options: ["Hayao Miyazaki", "Isao Takahata", "Mamoru Hosoda", "Makoto Shinkai"], answer: "Hayao Miyazaki", cat: "director", detail: "Studio Ghibli's Oscar winner" },
  { q: "Who plays Maleficent in the live-action film?", options: ["Angelina Jolie", "Cate Blanchett", "Helena Bonham Carter", "Eva Green"], answer: "Angelina Jolie", cat: "cast", detail: "2014 Disney reimagining" },
  { q: "Who plays the voice of Joy in Inside Out?", options: ["Amy Poehler", "Tina Fey", "Maya Rudolph", "Kristen Wiig"], answer: "Amy Poehler", cat: "cast", detail: "Inside Riley's mind" },
  { q: "Who plays the voice of Sadness in Inside Out?", options: ["Phyllis Smith", "Amy Poehler", "Mindy Kaling", "Maya Rudolph"], answer: "Phyllis Smith", cat: "cast", detail: "The surprise breakout character" },
  { q: "Who plays Anna in Frozen?", options: ["Kristen Bell", "Idina Menzel", "Mandy Moore", "Auli'i Cravalho"], answer: "Kristen Bell", cat: "cast", detail: "Elsa's sister" },
  { q: "Who played Dumbledore in the first two Harry Potter films?", options: ["Richard Harris", "Michael Gambon", "Ian McKellen", "Patrick Stewart"], answer: "Richard Harris", cat: "cast", detail: "Harris passed away in 2002" },
  { q: "Who plays Neville Longbottom in Harry Potter?", options: ["Matthew Lewis", "Tom Felton", "Rupert Grint", "Devon Murray"], answer: "Matthew Lewis", cat: "cast", detail: "The unlikely hero" },
  { q: "Who played Severus Snape in Harry Potter?", options: ["Alan Rickman", "Ralph Fiennes", "Gary Oldman", "Jason Isaacs"], answer: "Alan Rickman", cat: "cast", detail: "Always." },
  { q: "Who played Hagrid in Harry Potter?", options: ["Robbie Coltrane", "Brendan Gleeson", "Jim Broadbent", "Timothy Spall"], answer: "Robbie Coltrane", cat: "cast", detail: "You're a wizard, Harry" },
  { q: "What is WALL-E's love interest named?", options: ["EVE", "ANNA", "LILY", "ROSE"], answer: "EVE", cat: "trivia", detail: "Extraterrestrial Vegetation Evaluator" },
  { q: "In Coco, what is the Land of the Dead called?", options: ["The Land of the Dead", "The Underworld", "El Más Allá", "Ghost Town"], answer: "The Land of the Dead", cat: "trivia", detail: "Where ancestors live on" },
  { q: "What magical item does Elsa have in Frozen?", options: ["Her ice powers (no item)", "A magic necklace", "A crystal wand", "Snow boots"], answer: "Her ice powers (no item)", cat: "trivia", detail: "Born with the power" },
  { q: "In Monsters University, what fraternity does Mike join?", options: ["Oozma Kappa", "Roar Omega Roar", "Jaws Theta Chi", "Slugma Slugma Kappa"], answer: "Oozma Kappa", cat: "trivia", detail: "The lovable underdogs" },
  { q: "What is Lightning McQueen's catchphrase?", options: ["Ka-chow!", "Speed! I am speed!", "First place, baby!", "Zoom zoom!"], answer: "Ka-chow!", cat: "trivia", detail: "Said with a wink" },
  { q: "In Brave, what does Merida's mother turn into?", options: ["A bear", "A wolf", "A deer", "A hawk"], answer: "A bear", cat: "trivia", detail: "From a witch's spell" },
  { q: "\"Adventure is out there!\"", options: ["Up", "Moana", "Brave", "Tangled"], answer: "Up", cat: "quote", detail: "Carl and Ellie's motto" },
  { q: "\"I just can't wait to be king!\"", options: ["The Lion King", "Frozen", "Brave", "Tangled"], answer: "The Lion King", cat: "quote", detail: "Young Simba's song" },
  { q: "\"Do you want to build a snowman?\"", options: ["Frozen", "The Snowman", "Jack Frost", "Ice Age"], answer: "Frozen", cat: "quote", detail: "Anna's plea to Elsa" },
  { q: "\"Honey, where's my super suit?\"", options: ["The Incredibles", "Sky High", "Megamind", "Despicable Me"], answer: "The Incredibles", cat: "quote", detail: "Frozone's iconic question" },
  { q: "\"Not all treasure is silver and gold, mate.\"", options: ["Pirates of the Caribbean", "Treasure Island", "The Goonies", "Indiana Jones"], answer: "Pirates of the Caribbean", cat: "quote", detail: "Captain Jack Sparrow" },
  { q: "\"I'm Mary Poppins, y'all!\"", options: ["Guardians of the Galaxy Vol. 2", "Mary Poppins Returns", "The Avengers", "Thor: Ragnarok"], answer: "Guardians of the Galaxy Vol. 2", cat: "quote", detail: "Yondu's floating scene" },
  { q: "\"Dude, where's my car?\"", options: ["Dude, Where's My Car?", "The Hangover", "Fast and Furious", "Harold & Kumar"], answer: "Dude, Where's My Car?", cat: "quote", detail: "Ashton Kutcher and Seann William Scott" },
  { q: "How many Oscars did The Lord of the Rings: Return of the King win?", options: ["11", "10", "12", "9"], answer: "11", cat: "oscar", detail: "Won every category it was nominated for" },
  { q: "Which animated film earned the most Oscar nominations?", options: ["Beauty and the Beast", "Up", "Toy Story 3", "WALL-E"], answer: "Beauty and the Beast", cat: "oscar", detail: "6 nominations including Best Picture in 1992" },
  { q: "What film held the opening weekend record before Avengers: Endgame?", options: ["Avengers: Infinity War", "Star Wars: The Force Awakens", "Jurassic World", "The Avengers"], answer: "Avengers: Infinity War", cat: "boxoffice", detail: "$257 million opening weekend" },
  { q: "Which was the first animated film to gross $1 billion?", options: ["Toy Story 3", "Frozen", "Finding Nemo", "Shrek 2"], answer: "Toy Story 3", cat: "boxoffice", detail: "In 2010" },
  { q: "What was the first fully CGI human character in a live-action film?", options: ["Young Jeff Bridges in Tron: Legacy", "Gollum in Lord of the Rings", "Jar Jar Binks", "Davy Jones in Pirates"], answer: "Young Jeff Bridges in Tron: Legacy", cat: "bts", detail: "De-aging technology pioneer (2010)" },
  { q: "Which Disney film was the first to have a Black princess?", options: ["The Princess and the Frog", "Moana", "Encanto", "Brave"], answer: "The Princess and the Frog", cat: "bts", detail: "Princess Tiana in 2009" },
...
const MEDIUM_QUESTIONS = [
  ...
  { q: "What song plays during the ear-cutting scene in Reservoir Dogs?", options: ["Stuck in the Middle with You", "Little Green Bag", "Hooked on a Feeling", "Coconut"], answer: "Stuck in the Middle with You", cat: "soundtrack", detail: "Stealers Wheel's 1972 hit" },
  { q: "Which film won the first Best Picture Oscar?", options: ["Wings", "Sunrise", "The Jazz Singer", "All Quiet on the Western Front"], answer: "Wings", cat: "oscar", detail: "Won at the 1st Academy Awards in 1929" },
  { q: "Who composed the music for Up?", options: ["Michael Giacchino", "John Williams", "Hans Zimmer", "Thomas Newman"], answer: "Michael Giacchino", cat: "soundtrack", detail: "Won Best Original Score" },
  { q: "Who sang \"Remember Me\" in Coco?", options: ["Benjamin Bratt (as Ernesto de la Cruz)", "Anthony Gonzalez", "Gael García Bernal", "Edward James Olmos"], answer: "Benjamin Bratt (as Ernesto de la Cruz)", cat: "soundtrack", detail: "Won Best Original Song" },
  { q: "Which Pixar film won the first Best Animated Feature Oscar?", options: ["Shrek (DreamWorks, not Pixar)", "Finding Nemo", "Monsters, Inc.", "Spirited Away"], answer: "Shrek (DreamWorks, not Pixar)", cat: "oscar", detail: "Trick question — Shrek won, not a Pixar film" },
  { q: "Who composed the music for The Incredibles?", options: ["Michael Giacchino", "John Williams", "Hans Zimmer", "Danny Elfman"], answer: "Michael Giacchino", cat: "soundtrack", detail: "Jazz-inspired superhero score" },
...
{ q: "Who played Travis Bickle in Taxi Driver?", options: ["Robert De Niro", "Peter Finch", "Maria Falconetti", "Cillian Murphy"], answer: "Robert De Niro", cat: "cast", detail: "Robert De Niro in Taxi Driver" },
  ...
  { q: "Who directed La La Land?", options: ["Damien Chazelle", "Greta Gerwig", "Edgar Wright", "Wes Anderson"], answer: "Damien Chazelle", cat: "director", detail: "Youngest Best Director winner at 32" },
  { q: "Who directed The Social Network?", options: ["David Fincher", "Aaron Sorkin", "Danny Boyle", "Steven Soderbergh"], answer: "David Fincher", cat: "director", detail: "Fincher's 2010 Facebook film" },
  { q: "Who directed Blade Runner 2049?", options: ["Denis Villeneuve", "Ridley Scott", "Christopher Nolan", "Alex Garland"], answer: "Denis Villeneuve", cat: "director", detail: "Villeneuve's stunning sequel" },
  { q: "Who directed Whiplash?", options: ["Damien Chazelle", "David Fincher", "Bennett Miller", "Paul Thomas Anderson"], answer: "Damien Chazelle", cat: "director", detail: "Chazelle's intense jazz drama" },
  { q: "Who directed Arrival?", options: ["Denis Villeneuve", "Christopher Nolan", "Alex Garland", "Ridley Scott"], answer: "Denis Villeneuve", cat: "director", detail: "Villeneuve's 2016 sci-fi masterpiece" },
  { q: "Who directed No Country for Old Men?", options: ["Joel & Ethan Coen", "David Fincher", "Denis Villeneuve", "Martin McDonagh"], answer: "Joel & Ethan Coen", cat: "director", detail: "Won Best Picture, Director, and Supporting Actor" },
  { q: "Who directed The Shape of Water?", options: ["Guillermo del Toro", "Alfonso Cuarón", "Alejandro González Iñárritu", "Denis Villeneuve"], answer: "Guillermo del Toro", cat: "director", detail: "Won Best Picture and Director in 2018" },
  { q: "Who played the lead in The Revenant?", options: ["Leonardo DiCaprio", "Tom Hardy", "Brad Pitt", "Christian Bale"], answer: "Leonardo DiCaprio", cat: "cast", detail: "DiCaprio's first Oscar win" },
  { q: "Who played the lead in Birdman?", options: ["Michael Keaton", "Edward Norton", "Jake Gyllenhaal", "Joaquin Phoenix"], answer: "Michael Keaton", cat: "cast", detail: "A former Batman playing a former superhero" },
  { q: "Who played Nina in Black Swan?", options: ["Natalie Portman", "Mila Kunis", "Rooney Mara", "Jennifer Lawrence"], answer: "Natalie Portman", cat: "cast", detail: "Won Best Actress for the role" },
  { q: "Who played the Joker in Joker (2019)?", options: ["Joaquin Phoenix", "Jared Leto", "Heath Ledger", "Willem Dafoe"], answer: "Joaquin Phoenix", cat: "cast", detail: "Phoenix lost 52 pounds for the role" },
  { q: "Who played Mark Zuckerberg in The Social Network?", options: ["Jesse Eisenberg", "Michael Cera", "Andrew Garfield", "Armie Hammer"], answer: "Jesse Eisenberg", cat: "cast", detail: "Eisenberg's breakout dramatic role" },
  { q: "\"You shall not pass!\"", options: ["The Lord of the Rings: The Fellowship of the Ring", "Harry Potter", "The Hobbit", "Game of Thrones"], answer: "The Lord of the Rings: The Fellowship of the Ring", cat: "quote", detail: "Gandalf on the Bridge of Khazad-dûm" },
  { q: "\"Forget it, Jake. It's Chinatown.\"", options: ["Chinatown", "L.A. Confidential", "Mulholland Drive", "The Big Sleep"], answer: "Chinatown", cat: "quote", detail: "The devastating final line" },
  { q: "\"I'm the king of the world!\"", options: ["Titanic", "The Lion King", "Gladiator", "Braveheart"], answer: "Titanic", cat: "quote", detail: "DiCaprio on the bow of the ship" },
  { q: "\"I've seen things you people wouldn't believe.\"", options: ["Blade Runner", "2001: A Space Odyssey", "Alien", "The Matrix"], answer: "Blade Runner", cat: "quote", detail: "Roy Batty's tears in rain monologue" },
  { q: "\"The first rule of leadership: everything is your fault.\"", options: ["A Bug's Life", "The Lion King", "Antz", "Toy Story 2"], answer: "A Bug's Life", cat: "quote", detail: "Hopper's twisted wisdom" },
  { q: "What year was Pulp Fiction released?", options: ["1994", "1993", "1995", "1992"], answer: "1994", cat: "year", detail: "Won the Palme d'Or at Cannes" },
  { q: "What year was Schindler's List released?", options: ["1993", "1994", "1992", "1995"], answer: "1993", cat: "year", detail: "The same year as Jurassic Park" },
  { q: "What year was The Matrix released?", options: ["1999", "1998", "2000", "1997"], answer: "1999", cat: "year", detail: "Redefined sci-fi action" },
  { q: "What year was Fight Club released?", options: ["1999", "1998", "2000", "2001"], answer: "1999", cat: "year", detail: "A commercial flop that became a cult classic" },
  { q: "What year was Goodfellas released?", options: ["1990", "1991", "1989", "1992"], answer: "1990", cat: "year", detail: "Scorsese's mob masterpiece" },
  { q: "What year was The Silence of the Lambs released?", options: ["1991", "1990", "1992", "1993"], answer: "1991", cat: "year", detail: "Won all five major Oscars" },
  { q: "What year was Gladiator released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Revived the sword-and-sandal genre" },
  { q: "What year was Avatar released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "Cameron's 3D revolution" },
  { q: "What year was There Will Be Blood released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "The same year as No Country for Old Men" },
  { q: "What year was Parasite released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "First non-English Best Picture winner" },
  { q: "In what year did The Lord of the Rings: Return of the King win Best Picture?", options: ["2004", "2003", "2002", "2005"], answer: "2004", cat: "oscar", detail: "Won all 11 of its nominations" },
  { q: "Which film won Best Picture in 2020?", options: ["Parasite", "1917", "Joker", "Once Upon a Time in Hollywood"], answer: "Parasite", cat: "oscar", detail: "Bong Joon-ho made history" },
  { q: "Which actor has been nominated most times without winning?", options: ["Peter O'Toole (8)", "Glenn Close (8)", "Amy Adams (6)", "Leonardo DiCaprio (6)"], answer: "Peter O'Toole (8)", cat: "oscar", detail: "Received an honorary Oscar in 2003" },
  { q: "What film was the first to use CGI characters extensively?", options: ["Jurassic Park", "Terminator 2", "Toy Story", "The Abyss"], answer: "Jurassic Park", cat: "bts", detail: "ILM created the groundbreaking dinosaurs" },
  { q: "Which actor broke his ankle during filming and the shot was kept in the movie?", options: ["Leonardo DiCaprio in Django Unchained", "Tom Cruise in Mission Impossible", "Viggo Mortensen in LOTR", "Harrison Ford in Indiana Jones"], answer: "Leonardo DiCaprio in Django Unchained", cat: "bts", detail: "He cut his hand on glass and kept acting" },
  { q: "Which film used real skeletons as props due to budget constraints?", options: ["Poltergeist", "The Exorcist", "Psycho", "Halloween"], answer: "Poltergeist", cat: "bts", detail: "Real skeletons were cheaper than plastic ones" },
  { q: "What film was almost entirely improvised by its cast?", options: ["This Is Spinal Tap", "The Blair Witch Project", "Borat", "Curb Your Enthusiasm"], answer: "This Is Spinal Tap", cat: "bts", detail: "Rob Reiner's 1984 mockumentary" },
  { q: "Who composed the score for The Dark Knight?", options: ["Hans Zimmer & James Newton Howard", "John Williams", "Howard Shore", "Danny Elfman"], answer: "Hans Zimmer & James Newton Howard", cat: "soundtrack", detail: "The Joker's single-note theme" },
  { q: "Which composer is known for spaghetti western scores?", options: ["Ennio Morricone", "John Williams", "Bernard Herrmann", "Jerry Goldsmith"], answer: "Ennio Morricone", cat: "soundtrack", detail: "The Good, the Bad and the Ugly" },
  { q: "Who composed the score for Interstellar?", options: ["Hans Zimmer", "John Williams", "Ludwig Göransson", "Alexandre Desplat"], answer: "Hans Zimmer", cat: "soundtrack", detail: "The organ-driven score" },
  { q: "What song plays during the opening of Guardians of the Galaxy?", options: ["Come and Get Your Love", "Hooked on a Feeling", "Spirit in the Sky", "Cherry Bomb"], answer: "Come and Get Your Love", cat: "soundtrack", detail: "Redbone's 1974 hit" },
  { q: "Which was the first R-rated film to gross $1 billion?", options: ["Joker", "Deadpool", "The Matrix Reloaded", "It"], answer: "Joker", cat: "boxoffice", detail: "Made over $1.07 billion in 2019" },
  { q: "What was the most expensive film ever made (adjusted for inflation)?", options: ["Pirates of the Caribbean: On Stranger Tides", "Avengers: Age of Ultron", "Avatar", "Titanic"], answer: "Pirates of the Caribbean: On Stranger Tides", cat: "boxoffice", detail: "Budget of approximately $379 million" },
  { q: "Which Star Wars film has the highest worldwide gross?", options: ["The Force Awakens", "The Last Jedi", "A New Hope", "The Rise of Skywalker"], answer: "The Force Awakens", cat: "boxoffice", detail: "Over $2 billion worldwide" },
  { q: "The shower scene in Psycho uses how many camera cuts?", options: ["70", "30", "50", "90"], answer: "70", cat: "bts", detail: "78 camera setups for 45 seconds of footage" },
  { q: "What film popularized the Wilhelm Scream?", options: ["Charge at Feather River", "Star Wars", "Indiana Jones", "Lord of the Rings"], answer: "Charge at Feather River", cat: "bts", detail: "The scream has appeared in 400+ films since" },

  { q: "Who directed The Witch?", options: ["Robert Eggers", "Ari Aster", "Jordan Peele", "David Robert Mitchell"], answer: "Robert Eggers", cat: "director", detail: "Eggers' 2015 period horror debut" },
  { q: "Who directed Ex Machina?", options: ["Alex Garland", "Denis Villeneuve", "Spike Jonze", "Jonathan Glazer"], answer: "Alex Garland", cat: "director", detail: "Garland's directorial debut" },
  { q: "Who directed Hereditary?", options: ["Ari Aster", "Robert Eggers", "Jordan Peele", "Mike Flanagan"], answer: "Ari Aster", cat: "director", detail: "Aster's terrifying debut" },
  { q: "Who directed The Lobster?", options: ["Yorgos Lanthimos", "Lars von Trier", "Michael Haneke", "Ruben Östlund"], answer: "Yorgos Lanthimos", cat: "director", detail: "Lanthimos's absurdist dystopia" },
  { q: "Who directed Drive (2011)?", options: ["Nicolas Winding Refn", "David Fincher", "Edgar Wright", "Michael Mann"], answer: "Nicolas Winding Refn", cat: "director", detail: "Refn's neon-soaked neo-noir" },
  { q: "Who directed Prisoners?", options: ["Denis Villeneuve", "David Fincher", "Christopher Nolan", "Cary Joji Fukunaga"], answer: "Denis Villeneuve", cat: "director", detail: "Villeneuve's 2013 thriller" },
  { q: "Who directed Everything Everywhere All at Once?", options: ["Daniel Kwan & Daniel Scheinert", "Taika Waititi", "Edgar Wright", "Bong Joon-ho"], answer: "Daniel Kwan & Daniel Scheinert", cat: "director", detail: "The Daniels' multiverse adventure" },
  { q: "Who directed Three Billboards Outside Ebbing, Missouri?", options: ["Martin McDonagh", "Joel Coen", "Quentin Tarantino", "Taylor Sheridan"], answer: "Martin McDonagh", cat: "director", detail: "McDonagh's 2017 dark comedy" },
  { q: "Who directed The Banshees of Inisherin?", options: ["Martin McDonagh", "Yorgos Lanthimos", "Ken Loach", "Steve McQueen"], answer: "Martin McDonagh", cat: "director", detail: "Reuniting the In Bruges duo" },
  { q: "Who directed The Zone of Interest?", options: ["Jonathan Glazer", "Michael Haneke", "Steve McQueen", "Paul Thomas Anderson"], answer: "Jonathan Glazer", cat: "director", detail: "The horror next door to Auschwitz" },
  { q: "Who played the lead in Nightcrawler?", options: ["Jake Gyllenhaal", "Ryan Gosling", "Oscar Isaac", "Rami Malek"], answer: "Jake Gyllenhaal", cat: "cast", detail: "Gyllenhaal lost 30 pounds for the role" },
  { q: "Who played the lead in Phantom Thread?", options: ["Daniel Day-Lewis", "Ralph Fiennes", "Jude Law", "Colin Firth"], answer: "Daniel Day-Lewis", cat: "cast", detail: "Day-Lewis's final role" },
  { q: "Who played Tonya Harding in I, Tonya?", options: ["Margot Robbie", "Saoirse Ronan", "Florence Pugh", "Emma Stone"], answer: "Margot Robbie", cat: "cast", detail: "Robbie did some of her own skating" },
  { q: "Who played Elio in Call Me by Your Name?", options: ["Timothée Chalamet", "Lucas Hedges", "Tom Holland", "Ansel Elgort"], answer: "Timothée Chalamet", cat: "cast", detail: "Chalamet's breakout performance" },
  { q: "Who played Elvis in Elvis (2022)?", options: ["Austin Butler", "Harry Styles", "Timothée Chalamet", "Ansel Elgort"], answer: "Austin Butler", cat: "cast", detail: "Butler kept the accent for months after filming" },
  { q: "\"I could've been a contender.\"", options: ["On the Waterfront", "Raging Bull", "Rocky", "The Fighter"], answer: "On the Waterfront", cat: "quote", detail: "Brando in the taxi scene" },
  { q: "\"Here's Johnny!\"", options: ["The Shining", "The Tonight Show", "Ed McMahon Show", "Batman (1989)"], answer: "The Shining", cat: "quote", detail: "Jack Nicholson improvised this line" },
  { q: "\"You either die a hero, or you live long enough to see yourself become the villain.\"", options: ["The Dark Knight", "Batman Begins", "Watchmen", "Logan"], answer: "The Dark Knight", cat: "quote", detail: "Harvey Dent's prophetic words" },
  { q: "\"It's not who I am underneath, but what I do that defines me.\"", options: ["Batman Begins", "The Dark Knight", "Spider-Man", "Superman"], answer: "Batman Begins", cat: "quote", detail: "Bruce Wayne to Rachel" },
  { q: "What year was La La Land released?", options: ["2016", "2017", "2015", "2018"], answer: "2016", cat: "year", detail: "Briefly announced as Best Picture winner" },
  { q: "What year was Get Out released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Jordan Peele's horror debut" },
  { q: "What year was Mad Max: Fury Road released?", options: ["2015", "2016", "2014", "2017"], answer: "2015", cat: "year", detail: "Won six Oscars" },
  { q: "What year was Dunkirk released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Nolan's WWII epic shot on IMAX" },
  { q: "What year was Birdman released?", options: ["2014", "2015", "2013", "2016"], answer: "2014", cat: "year", detail: "Won Best Picture" },
  { q: "What year was Moonlight released?", options: ["2016", "2017", "2015", "2018"], answer: "2016", cat: "year", detail: "Won Best Picture after the envelope mix-up" },
  { q: "What year was Hereditary released?", options: ["2018", "2019", "2017", "2020"], answer: "2018", cat: "year", detail: "Aster's terrifying debut" },
  { q: "What year was Black Panther released?", options: ["2018", "2017", "2019", "2016"], answer: "2018", cat: "year", detail: "First superhero film nominated for Best Picture" },
  { q: "Which film famously had its Best Picture announcement corrected live on air?", options: ["Moonlight / La La Land", "The Shape of Water / Three Billboards", "Parasite / 1917", "CODA / Power of the Dog"], answer: "Moonlight / La La Land", cat: "oscar", detail: "Warren Beatty read the wrong envelope" },
  { q: "Who won Best Picture for 2023 (96th Oscars)?", options: ["Oppenheimer", "Poor Things", "Anatomy of a Fall", "Killers of the Flower Moon"], answer: "Oppenheimer", cat: "oscar", detail: "Nolan's first win" },
  { q: "Who won Best Director for Everything Everywhere All at Once?", options: ["Daniel Kwan & Daniel Scheinert", "Steven Spielberg", "Martin McDonagh", "Todd Field"], answer: "Daniel Kwan & Daniel Scheinert", cat: "oscar", detail: "The Daniels won seven Oscars total for the film" },
  { q: "How many Oscars did Everything Everywhere All at Once win?", options: ["7", "6", "8", "5"], answer: "7", cat: "oscar", detail: "Including Picture, Director, Actress, Supporting Actor/Actress" },
  { q: "Who composed the score for Inception?", options: ["Hans Zimmer", "John Williams", "Ludwig Göransson", "Jonny Greenwood"], answer: "Hans Zimmer", cat: "soundtrack", detail: "The BRAAAM heard round the world" },
  { q: "Who composed the score for Tenet?", options: ["Ludwig Göransson", "Hans Zimmer", "Jonny Greenwood", "Trent Reznor"], answer: "Ludwig Göransson", cat: "soundtrack", detail: "Göransson also scored Black Panther" },
  { q: "Which film features \"Bohemian Rhapsody\" during a famous car scene?", options: ["Wayne's World", "Bohemian Rhapsody", "Almost Famous", "Dazed and Confused"], answer: "Wayne's World", cat: "soundtrack", detail: "Mike Myers headbanging" },
  { q: "What was the first streaming film to be nominated for Best Picture?", options: ["Roma", "The Irishman", "Marriage Story", "Mank"], answer: "Roma", cat: "oscar", detail: "Netflix's first Best Picture nominee" },
  { q: "Which actor has won the most Oscars overall?", options: ["Walt Disney (22 competitive)", "Katharine Hepburn (4)", "John Ford (4)", "Edith Head (8)"], answer: "Walt Disney (22 competitive)", cat: "oscar", detail: "Plus 4 honorary awards" },
  { q: "What Quentin Tarantino film grossed the most worldwide?", options: ["Django Unchained", "Once Upon a Time in Hollywood", "Inglourious Basterds", "Kill Bill Vol 1"], answer: "Django Unchained", cat: "boxoffice", detail: "Over $425 million worldwide" },
  { q: "Which was Christopher Nolan's highest-grossing film?", options: ["The Dark Knight Rises", "Oppenheimer", "Inception", "The Dark Knight"], answer: "The Dark Knight Rises", cat: "boxoffice", detail: "Over $1.08 billion worldwide" },
  { q: "What was the first horror film to be nominated for Best Picture?", options: ["The Exorcist", "Jaws", "Rosemary's Baby", "Get Out"], answer: "The Exorcist", cat: "oscar", detail: "Nominated in 1974" },
  { q: "Which film used forced perspective instead of CGI to make hobbits look small?", options: ["The Lord of the Rings", "The Hobbit", "Willow", "Time Bandits"], answer: "The Lord of the Rings", cat: "bts", detail: "Peter Jackson's ingenious practical effects" },
  { q: "Which director famously ate a shoe after losing a bet?", options: ["Werner Herzog", "Lars von Trier", "Terry Gilliam", "Wim Wenders"], answer: "Werner Herzog", cat: "bts", detail: "He bet Errol Morris couldn't finish Gates of Heaven" },
  { q: "What film was shot in chronological order so the child actors' growth matched the story?", options: ["Boyhood", "Moonlight", "The Florida Project", "Beasts of the Southern Wild"], answer: "Boyhood", cat: "bts", detail: "Richard Linklater filmed over 12 years" },
  { q: "Which director hid from creditors during the production of Apocalypse Now?", options: ["Francis Ford Coppola", "Martin Scorsese", "Stanley Kubrick", "Michael Cimino"], answer: "Francis Ford Coppola", cat: "bts", detail: "The shoot was famously chaotic" },

  { q: "Who directed Pan's Labyrinth?", options: ["Guillermo del Toro", "Alfonso Cuarón", "Alejandro González Iñárritu", "Pedro Almodóvar"], answer: "Guillermo del Toro", cat: "director", detail: "Del Toro's Spanish Civil War dark fantasy" },
  { q: "Who directed Spirited Away?", options: ["Hayao Miyazaki", "Isao Takahata", "Makoto Shinkai", "Satoshi Kon"], answer: "Hayao Miyazaki", cat: "director", detail: "Won Best Animated Feature" },
  { q: "Who directed Lost in Translation?", options: ["Sofia Coppola", "Wes Anderson", "Wong Kar-wai", "Jim Jarmusch"], answer: "Sofia Coppola", cat: "director", detail: "Won Best Original Screenplay" },
  { q: "Who directed The Grand Budapest Hotel?", options: ["Wes Anderson", "Noah Baumbach", "Sofia Coppola", "Edgar Wright"], answer: "Wes Anderson", cat: "director", detail: "Anderson's pastel-colored caper" },
  { q: "Who directed Kill Bill Vol. 1?", options: ["Quentin Tarantino", "Robert Rodriguez", "Takashi Miike", "Park Chan-wook"], answer: "Quentin Tarantino", cat: "director", detail: "Tarantino's revenge epic" },
  { q: "Who directed The Florida Project?", options: ["Sean Baker", "Barry Jenkins", "Greta Gerwig", "Chloé Zhao"], answer: "Sean Baker", cat: "director", detail: "Baker's 2017 film about childhood poverty" },
  { q: "Who played the lead in Taxi Driver?", options: ["Robert De Niro", "Al Pacino", "Harvey Keitel", "Jack Nicholson"], answer: "Robert De Niro", cat: "cast", detail: "De Niro as Travis Bickle" },
  { q: "Who played the lead in A Clockwork Orange?", options: ["Malcolm McDowell", "Peter Sellers", "Michael Caine", "Oliver Reed"], answer: "Malcolm McDowell", cat: "cast", detail: "McDowell as Alex DeLarge" },
  { q: "Who played the lead in Raging Bull?", options: ["Robert De Niro", "Al Pacino", "Joe Pesci", "Harvey Keitel"], answer: "Robert De Niro", cat: "cast", detail: "De Niro gained 60 pounds for the older Jake LaMotta" },
  { q: "Who played the lead in Schindler's List?", options: ["Liam Neeson", "Ralph Fiennes", "Ben Kingsley", "Daniel Day-Lewis"], answer: "Liam Neeson", cat: "cast", detail: "As Oskar Schindler" },
  { q: "\"We'll always have Paris.\"", options: ["Casablanca", "Midnight in Paris", "Before Sunset", "An American in Paris"], answer: "Casablanca", cat: "quote", detail: "Rick to Ilsa" },
  { q: "\"Elementary, my dear Watson.\"", options: ["Never actually said in any Sherlock Holmes film", "The Adventures of Sherlock Holmes", "Sherlock Holmes (2009)", "A Study in Scarlet"], answer: "Never actually said in any Sherlock Holmes film", cat: "quote", detail: "One of the most commonly misquoted lines" },
  { q: "What year was No Country for Old Men released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "Won Best Picture" },
  { q: "What year was The Grand Budapest Hotel released?", options: ["2014", "2013", "2015", "2012"], answer: "2014", cat: "year", detail: "Anderson's most decorated film" },
  { q: "What year was Inglourious Basterds released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "Tarantino's WWII revisionism" },
  { q: "What year was Drive released?", options: ["2011", "2012", "2010", "2013"], answer: "2011", cat: "year", detail: "Refn's neon-soaked thriller" },
  { q: "What year was Spirited Away released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "Miyazaki's Oscar-winning masterpiece" },
  { q: "What year was Kill Bill Vol. 1 released?", options: ["2003", "2004", "2002", "2005"], answer: "2003", cat: "year", detail: "Tarantino's revenge saga" },
  { q: "What year was Pan's Labyrinth released?", options: ["2006", "2007", "2005", "2008"], answer: "2006", cat: "year", detail: "Del Toro's dark fairy tale" },
  { q: "Which actor has been in the most Martin Scorsese films?", options: ["Robert De Niro", "Leonardo DiCaprio", "Joe Pesci", "Harvey Keitel"], answer: "Robert De Niro", cat: "trivia", detail: "Nine films together" },
  { q: "What is the name of the fictional drug in Pulp Fiction?", options: ["There is no fictional drug — it's heroin", "Spice", "Kronole", "Red Eye"], answer: "There is no fictional drug — it's heroin", cat: "trivia", detail: "Mia Wallace overdoses on heroin" },
  { q: "What film was Spielberg's directorial debut?", options: ["Duel", "Jaws", "Sugarland Express", "Close Encounters"], answer: "Duel", cat: "trivia", detail: "A 1971 TV movie about a truck" },
  { q: "How many films has Quentin Tarantino directed?", options: ["10 (he says he'll stop)", "8", "12", "9"], answer: "10 (he says he'll stop)", cat: "trivia", detail: "Claims he'll retire after 10" },
  { q: "Who composed the score for Dunkirk?", options: ["Hans Zimmer", "Ludwig Göransson", "Jonny Greenwood", "John Williams"], answer: "Hans Zimmer", cat: "soundtrack", detail: "Used a ticking clock throughout" },
  { q: "What song opens Reservoir Dogs?", options: ["Little Green Bag", "Stuck in the Middle with You", "Hooked on a Feeling", "Coconut"], answer: "Little Green Bag", cat: "soundtrack", detail: "George Baker Selection's 1970 hit" },
  { q: "What is the most expensive animated film ever made?", options: ["Tangled", "Toy Story 4", "Frozen II", "The Lion King (2019)"], answer: "Tangled", cat: "boxoffice", detail: "Cost approximately $260 million" },
  { q: "Which was the first film to gross $1 billion worldwide?", options: ["Titanic", "Star Wars: The Phantom Menace", "The Lord of the Rings: Return of the King", "Avatar"], answer: "Titanic", cat: "boxoffice", detail: "In its original 1997-1998 run" },
  { q: "What practical effect did Kubrick use for the blood elevator in The Shining?", options: ["Real dyed water from a dam release", "Corn syrup and food coloring", "Red paint", "CG added later"], answer: "Corn syrup and food coloring", cat: "bts", detail: "Took 9 days and dozens of takes" },
  { q: "Which actor broke his toe kicking a helmet but the take was kept?", options: ["Viggo Mortensen in LOTR: The Two Towers", "Orlando Bloom in LOTR", "Sean Astin in LOTR", "Karl Urban in LOTR"], answer: "Viggo Mortensen in LOTR: The Two Towers", cat: "bts", detail: "His scream of anguish was real" },

  { q: "Who directed Burning (2018)?", options: ["Lee Chang-dong", "Park Chan-wook", "Bong Joon-ho", "Kim Jee-woon"], answer: "Lee Chang-dong", cat: "director", detail: "Based on a Murakami short story" },
  { q: "Who directed Portrait of a Lady on Fire?", options: ["Céline Sciamma", "Claire Denis", "Julia Ducournau", "Mia Hansen-Løve"], answer: "Céline Sciamma", cat: "director", detail: "Won Best Screenplay at Cannes 2019" },
  { q: "Who directed Midsommar?", options: ["Ari Aster", "Robert Eggers", "Jordan Peele", "David Robert Mitchell"], answer: "Ari Aster", cat: "director", detail: "Aster's folk horror follow-up to Hereditary" },
  { q: "Who directed Nomadland?", options: ["Chloé Zhao", "Greta Gerwig", "Sofia Coppola", "Kelly Reichardt"], answer: "Chloé Zhao", cat: "director", detail: "Won Best Picture and Director" },
  { q: "Who directed The Favourite?", options: ["Yorgos Lanthimos", "Martin McDonagh", "Emerald Fennell", "Florian Zeller"], answer: "Yorgos Lanthimos", cat: "director", detail: "Olivia Colman won Best Actress" },
  { q: "Who directed Uncut Gems?", options: ["Josh & Benny Safdie", "Ari Aster", "Robert Eggers", "Sean Baker"], answer: "Josh & Benny Safdie", cat: "director", detail: "Adam Sandler's dramatic tour de force" },
  { q: "Who directed Promising Young Woman?", options: ["Emerald Fennell", "Greta Gerwig", "Chloé Zhao", "Sofia Coppola"], answer: "Emerald Fennell", cat: "director", detail: "Won Best Original Screenplay" },
  { q: "Who played Howard Ratner in Uncut Gems?", options: ["Adam Sandler", "Jonah Hill", "Seth Rogen", "Ben Stiller"], answer: "Adam Sandler", cat: "cast", detail: "Sandler's most intense performance" },
  { q: "Who played Cassie in Promising Young Woman?", options: ["Carey Mulligan", "Margot Robbie", "Florence Pugh", "Saoirse Ronan"], answer: "Carey Mulligan", cat: "cast", detail: "Mulligan's revenge performance" },
  { q: "Who played Fern in Nomadland?", options: ["Frances McDormand", "Chloé Zhao", "Tilda Swinton", "Cate Blanchett"], answer: "Frances McDormand", cat: "cast", detail: "McDormand's third Best Actress Oscar" },
  { q: "Who played the lead in Power of the Dog?", options: ["Benedict Cumberbatch", "Jesse Plemons", "Kodi Smit-McPhee", "Kirsten Dunst"], answer: "Benedict Cumberbatch", cat: "cast", detail: "Jane Campion's western" },
  { q: "Who played Queen Anne in The Favourite?", options: ["Olivia Colman", "Rachel Weisz", "Emma Stone", "Helena Bonham Carter"], answer: "Olivia Colman", cat: "cast", detail: "Won Best Actress" },
  { q: "\"In this world, you get what you pay for.\"", options: ["Parasite", "The Wolf of Wall Street", "Wall Street", "American Psycho"], answer: "Parasite", cat: "quote", detail: "The class divide theme" },
  { q: "\"Perfectly balanced, as all things should be.\"", options: ["Avengers: Infinity War", "The Dark Knight", "Doctor Strange", "Thor: Ragnarok"], answer: "Avengers: Infinity War", cat: "quote", detail: "Thanos's philosophy" },
  { q: "What year was Uncut Gems released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "The Safdie brothers' anxiety masterpiece" },
  { q: "What year was Everything Everywhere All at Once released?", options: ["2022", "2023", "2021", "2024"], answer: "2022", cat: "year", detail: "Won 7 Oscars" },
  { q: "What year was Midsommar released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Ari Aster's daylight horror" },
  { q: "What year was Portrait of a Lady on Fire released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Sciamma's period romance" },
  { q: "What year was Nomadland released?", options: ["2020", "2021", "2019", "2022"], answer: "2020", cat: "year", detail: "Won Best Picture during COVID" },
  { q: "What year was The Lighthouse released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Eggers' black-and-white madness" },
  { q: "Who won Best Picture for 2022 (95th Oscars)?", options: ["Everything Everywhere All at Once", "The Banshees of Inisherin", "All Quiet on the Western Front", "Tár"], answer: "Everything Everywhere All at Once", cat: "oscar", detail: "The multiverse swept the Oscars" },
  { q: "Who composed the score for Arrival?", options: ["Jóhann Jóhannsson", "Hans Zimmer", "Jonny Greenwood", "Max Richter"], answer: "Jóhann Jóhannsson", cat: "soundtrack", detail: "Jóhannsson's haunting alien soundscape" },
  { q: "Who composed the score for Black Panther?", options: ["Ludwig Göransson", "Hans Zimmer", "Kendrick Lamar", "Trent Reznor"], answer: "Ludwig Göransson", cat: "soundtrack", detail: "Won Best Original Score" },
  { q: "Which was the lowest-budget film to ever win Best Picture?", options: ["Moonlight ($1.5M)", "Rocky ($1M)", "Marty ($343K)", "The Hurt Locker ($15M)"], answer: "Marty ($343K)", cat: "boxoffice", detail: "Delbert Mann's 1955 film" },
  { q: "What was Greta Gerwig's directorial debut?", options: ["Lady Bird", "Little Women", "Barbie", "Nights and Weekends"], answer: "Lady Bird", cat: "trivia", detail: "2017's coming-of-age masterpiece" },
  { q: "Which film uses a single long take for a border crossing scene?", options: ["Sicario", "No Country for Old Men", "Traffic", "Babel"], answer: "Sicario", cat: "bts", detail: "Roger Deakins' stunning cinematography" },
  { q: "Which film's editor was also the director's wife?", options: ["Star Wars (Marcia Lucas)", "The Hurt Locker", "Bonnie and Clyde", "Easy Rider"], answer: "Star Wars (Marcia Lucas)", cat: "bts", detail: "Marcia Lucas won the editing Oscar" },
  { q: "Which director has been banned from leaving their country?", options: ["Jafar Panahi", "Abbas Kiarostami", "Mohsen Makhmalbaf", "Asghar Farhadi"], answer: "Jafar Panahi", cat: "bts", detail: "Banned from filmmaking and travel by Iran since 2010" },

  { q: "Who directed Memento?", options: ["Christopher Nolan", "David Lynch", "David Fincher", "Darren Aronofsky"], answer: "Christopher Nolan", cat: "director", detail: "Nolan's breakthrough film" },
  { q: "Who directed Mulholland Drive?", options: ["David Lynch", "David Fincher", "Brian De Palma", "David Cronenberg"], answer: "David Lynch", cat: "director", detail: "Lynch's Hollywood nightmare" },
  { q: "Who directed The Truman Show?", options: ["Peter Weir", "Jim Carrey", "Steven Spielberg", "Ron Howard"], answer: "Peter Weir", cat: "director", detail: "Weir's prescient reality TV satire" },
  { q: "Who directed American Beauty?", options: ["Sam Mendes", "David Fincher", "Alexander Payne", "Todd Solondz"], answer: "Sam Mendes", cat: "director", detail: "Won Best Picture 2000" },
  { q: "Who directed The Pianist?", options: ["Roman Polanski", "Steven Spielberg", "Terrence Malick", "Wim Wenders"], answer: "Roman Polanski", cat: "director", detail: "Won Best Director and Best Actor" },
  { q: "Who played the Wicked Witch of the West in The Wizard of Oz?", options: ["Margaret Hamilton", "Judy Garland", "Billie Burke", "Clara Blandick"], answer: "Margaret Hamilton", cat: "cast", detail: "Hamilton was burned during a fire effect gone wrong" },
  { q: "Who played Vito Corleone in The Godfather?", options: ["Marlon Brando", "Al Pacino", "Robert De Niro", "James Caan"], answer: "Marlon Brando", cat: "cast", detail: "Brando used cotton in his cheeks" },
  { q: "Who played the lead in Requiem for a Dream?", options: ["Jared Leto", "Christian Bale", "Edward Norton", "Joaquin Phoenix"], answer: "Jared Leto", cat: "cast", detail: "Leto, Connelly, Burstyn, and Wayans" },
  { q: "Who played the lead in Memento?", options: ["Guy Pearce", "Edward Norton", "Christian Bale", "Brad Pitt"], answer: "Guy Pearce", cat: "cast", detail: "Pearce as the amnesiac Leonard" },
  { q: "Who played the lead in American Beauty?", options: ["Kevin Spacey", "Brad Pitt", "Ed Norton", "Russell Crowe"], answer: "Kevin Spacey", cat: "cast", detail: "Won Best Actor" },
  { q: "\"I see now that the circumstances of one's birth are irrelevant.\"", options: ["Mewtwo Strikes Back (Pokémon)", "Gattaca", "The Matrix", "A.I."], answer: "Mewtwo Strikes Back (Pokémon)", cat: "quote", detail: "Mewtwo's philosophical conclusion" },
  { q: "What year was Se7en released?", options: ["1995", "1996", "1994", "1997"], answer: "1995", cat: "year", detail: "Fincher's dark detective thriller" },
  { q: "What year was Memento released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Nolan's reverse-chronology thriller" },
  { q: "What year was Requiem for a Dream released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Aronofsky's addiction nightmare" },
  { q: "What year was American Beauty released?", options: ["1999", "2000", "1998", "2001"], answer: "1999", cat: "year", detail: "Won Best Picture" },
  { q: "What year was The Pianist released?", options: ["2002", "2003", "2001", "2004"], answer: "2002", cat: "year", detail: "Polanski's WWII masterpiece" },
  { q: "What year was Zodiac released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "Fincher's true crime obsession" },
  { q: "What year was Barbie released?", options: ["2023", "2024", "2022", "2021"], answer: "2023", cat: "year", detail: "Greta Gerwig's pink phenomenon" },
  { q: "What year was Oppenheimer released?", options: ["2023", "2024", "2022", "2021"], answer: "2023", cat: "year", detail: "Released the same day as Barbie" },
  { q: "Which film coined the term Barbenheimer?", options: ["Both Barbie and Oppenheimer releasing the same day", "A fan-made film", "A documentary", "A late-night comedy sketch"], answer: "Both Barbie and Oppenheimer releasing the same day", cat: "trivia", detail: "July 21, 2023" },
  { q: "Who composed the score for Oppenheimer?", options: ["Ludwig Göransson", "Hans Zimmer", "Jonny Greenwood", "Trent Reznor"], answer: "Ludwig Göransson", cat: "soundtrack", detail: "Won Best Original Score" },
  { q: "What Christopher Nolan film did not use CGI for its spaceship?", options: ["Interstellar", "Inception", "Tenet", "The Dark Knight"], answer: "Interstellar", cat: "bts", detail: "Used rear projection with IMAX footage" },
  { q: "Which actor stayed in character for an entire film shoot?", options: ["Daniel Day-Lewis in Lincoln", "Christian Bale in The Machinist", "Jared Leto in Suicide Squad", "Heath Ledger in The Dark Knight"], answer: "Daniel Day-Lewis in Lincoln", cat: "bts", detail: "Crew members called him Mr. President" },
  { q: "How long did it take to make Boyhood?", options: ["12 years", "8 years", "15 years", "6 years"], answer: "12 years", cat: "bts", detail: "Linklater filmed annually from 2002-2013" },

  { q: "Who directed Annihilation?", options: ["Alex Garland", "Denis Villeneuve", "Ari Aster", "Robert Eggers"], answer: "Alex Garland", cat: "director", detail: "Garland's 2018 sci-fi horror" },
  { q: "Who directed Under the Skin?", options: ["Jonathan Glazer", "Alex Garland", "Denis Villeneuve", "Nicolas Winding Refn"], answer: "Jonathan Glazer", cat: "director", detail: "Glazer's alien predator film" },
  { q: "Who directed Moonrise Kingdom?", options: ["Wes Anderson", "Noah Baumbach", "Sofia Coppola", "Richard Linklater"], answer: "Wes Anderson", cat: "director", detail: "Anderson's quirky young love story" },
  { q: "Who directed Marriage Story?", options: ["Noah Baumbach", "Greta Gerwig", "Sofia Coppola", "Richard Linklater"], answer: "Noah Baumbach", cat: "director", detail: "Baumbach's divorce drama" },
  { q: "Who directed 1917?", options: ["Sam Mendes", "Christopher Nolan", "Steven Spielberg", "Peter Jackson"], answer: "Sam Mendes", cat: "director", detail: "Shot to appear as one continuous take" },
  { q: "Who directed Tár?", options: ["Todd Field", "Paul Thomas Anderson", "Martin Scorsese", "Terrence Malick"], answer: "Todd Field", cat: "director", detail: "Field's first film in 16 years" },
  { q: "Who directed Past Lives?", options: ["Celine Song", "Greta Gerwig", "Chloé Zhao", "Lulu Wang"], answer: "Celine Song", cat: "director", detail: "Song's stunning directorial debut" },
  { q: "Who played Lydia Tár in Tár?", options: ["Cate Blanchett", "Tilda Swinton", "Nicole Kidman", "Julianne Moore"], answer: "Cate Blanchett", cat: "cast", detail: "Blanchett's towering performance" },
  { q: "Who played Charlie in Marriage Story?", options: ["Adam Driver", "Joaquin Phoenix", "Oscar Isaac", "Jake Gyllenhaal"], answer: "Adam Driver", cat: "cast", detail: "Driver opposite Scarlett Johansson" },
  { q: "Who played the lead in Killers of the Flower Moon?", options: ["Leonardo DiCaprio", "Robert De Niro", "Jesse Plemons", "Brendan Fraser"], answer: "Leonardo DiCaprio", cat: "cast", detail: "DiCaprio and De Niro together for Scorsese" },
  { q: "Who played the lead in The Whale?", options: ["Brendan Fraser", "Adam Sandler", "Philip Seymour Hoffman", "John Goodman"], answer: "Brendan Fraser", cat: "cast", detail: "Fraser's Oscar-winning comeback" },
  { q: "Who played Gollum in Lord of the Rings?", options: ["Andy Serkis", "Hugo Weaving", "Cate Blanchett", "Ian McKellen"], answer: "Andy Serkis", cat: "cast", detail: "Pioneered performance capture" },
  { q: "\"I volunteer as tribute!\"", options: ["The Hunger Games", "Gladiator", "Braveheart", "300"], answer: "The Hunger Games", cat: "quote", detail: "Katniss takes Prim's place" },
  { q: "\"It's alive! It's alive!\"", options: ["Frankenstein (1931)", "Young Frankenstein", "Bride of Frankenstein", "The Fly"], answer: "Frankenstein (1931)", cat: "quote", detail: "Colin Clive as Dr. Frankenstein" },
  { q: "What year was 1917 released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Sam Mendes' one-shot war film" },
  { q: "What year was Tár released?", options: ["2022", "2023", "2021", "2024"], answer: "2022", cat: "year", detail: "Blanchett's masterclass" },
  { q: "What year was Killers of the Flower Moon released?", options: ["2023", "2024", "2022", "2021"], answer: "2023", cat: "year", detail: "Scorsese's 3.5-hour epic" },
  { q: "What year was Marriage Story released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Netflix's divorce drama" },
  { q: "What year was Past Lives released?", options: ["2023", "2024", "2022", "2021"], answer: "2023", cat: "year", detail: "Celine Song's debut" },
  { q: "What year was The Whale released?", options: ["2022", "2023", "2021", "2024"], answer: "2022", cat: "year", detail: "Fraser's comeback" },
  { q: "Who won Best Actor for The Whale?", options: ["Brendan Fraser", "Austin Butler", "Colin Farrell", "Bill Nighy"], answer: "Brendan Fraser", cat: "oscar", detail: "One of Hollywood's most emotional wins" },
  { q: "Who won Best Director for Nomadland?", options: ["Chloé Zhao", "David Fincher", "Thomas Vinterberg", "Emerald Fennell"], answer: "Chloé Zhao", cat: "oscar", detail: "Second woman to win Best Director" },
  { q: "Who was the first woman to win Best Director?", options: ["Kathryn Bigelow", "Chloé Zhao", "Sofia Coppola", "Greta Gerwig"], answer: "Kathryn Bigelow", cat: "oscar", detail: "Won for The Hurt Locker in 2010" },
  { q: "Who composed the score for Marriage Story?", options: ["Randy Newman", "Thomas Newman", "Hans Zimmer", "Alexandre Desplat"], answer: "Randy Newman", cat: "soundtrack", detail: "Newman's emotional orchestral score" },
  { q: "Who composed the score for 1917?", options: ["Thomas Newman", "Hans Zimmer", "John Williams", "Alexandre Desplat"], answer: "Thomas Newman", cat: "soundtrack", detail: "Newman's war-time score" },
  { q: "Which film was shot in one take for real (not faked)?", options: ["Victoria (2015)", "1917", "Birdman", "Russian Ark"], answer: "Victoria (2015)", cat: "bts", detail: "2 hours 18 minutes, single take through Berlin" },
  { q: "What percentage of Barbie's production budget went to the color pink?", options: ["That's a myth — no specific pink budget was disclosed", "12%", "25%", "30%"], answer: "That's a myth — no specific pink budget was disclosed", cat: "bts", detail: "Though they did reportedly cause a worldwide pink paint shortage" },
  { q: "Which director insists on shooting on film rather than digital?", options: ["Christopher Nolan", "Denis Villeneuve", "Martin Scorsese", "Steven Spielberg"], answer: "Christopher Nolan", cat: "bts", detail: "Nolan is cinema's biggest champion of film" },

  { q: "Who directed Phantom Thread?", options: ["Paul Thomas Anderson", "Martin Scorsese", "Wes Anderson", "David Fincher"], answer: "Paul Thomas Anderson", cat: "director", detail: "Day-Lewis's final film" },
  { q: "Who directed There Will Be Blood?", options: ["Paul Thomas Anderson", "Martin Scorsese", "Coen Brothers", "David Fincher"], answer: "Paul Thomas Anderson", cat: "director", detail: "PTA's epic American story" },
  { q: "Who directed Birdman?", options: ["Alejandro González Iñárritu", "Alfonso Cuarón", "Guillermo del Toro", "Pedro Almodóvar"], answer: "Alejandro González Iñárritu", cat: "director", detail: "Won Best Picture and Director" },
  { q: "Who directed Once Upon a Time in Hollywood?", options: ["Quentin Tarantino", "Martin Scorsese", "Paul Thomas Anderson", "David Fincher"], answer: "Quentin Tarantino", cat: "director", detail: "Tarantino's love letter to 1969 LA" },
  { q: "Who directed The Power of the Dog?", options: ["Jane Campion", "Chloé Zhao", "Kelly Reichardt", "Sofia Coppola"], answer: "Jane Campion", cat: "director", detail: "Won Best Director at the 2022 Oscars" },
  { q: "Who played Cliff Booth in Once Upon a Time in Hollywood?", options: ["Brad Pitt", "Leonardo DiCaprio", "Margot Robbie", "Al Pacino"], answer: "Brad Pitt", cat: "cast", detail: "Won Best Supporting Actor" },
  { q: "Who played Fletcher in Whiplash?", options: ["J.K. Simmons", "Ed Harris", "Michael Shannon", "F. Murray Abraham"], answer: "J.K. Simmons", cat: "cast", detail: "Won Best Supporting Actor" },
  { q: "Who played Jordan Belfort in The Wolf of Wall Street?", options: ["Leonardo DiCaprio", "Jonah Hill", "Matthew McConaughey", "Margot Robbie"], answer: "Leonardo DiCaprio", cat: "cast", detail: "DiCaprio at his most manic" },
  { q: "Who played the lead in The Shape of Water?", options: ["Sally Hawkins", "Frances McDormand", "Saoirse Ronan", "Margot Robbie"], answer: "Sally Hawkins", cat: "cast", detail: "A mute janitor falls in love with an amphibian" },
  { q: "\"Not quite my tempo.\"", options: ["Whiplash", "La La Land", "A Star Is Born", "Soul"], answer: "Whiplash", cat: "quote", detail: "J.K. Simmons terrorizing his student" },
  { q: "\"I'm not a smart man, but I know what love is.\"", options: ["Forrest Gump", "Rain Man", "Good Will Hunting", "A Beautiful Mind"], answer: "Forrest Gump", cat: "quote", detail: "Forrest to Jenny" },
  { q: "\"It's not personal, Sonny. It's strictly business.\"", options: ["The Godfather", "Goodfellas", "Casino", "Scarface"], answer: "The Godfather", cat: "quote", detail: "Michael Corleone's transformation" },
  { q: "What year was Whiplash released?", options: ["2014", "2015", "2013", "2016"], answer: "2014", cat: "year", detail: "Chazelle's Sundance breakout" },
  { q: "What year was The Wolf of Wall Street released?", options: ["2013", "2014", "2012", "2015"], answer: "2013", cat: "year", detail: "Scorsese's longest narrative film at 3 hours" },
  { q: "What year was Once Upon a Time in Hollywood released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Tarantino's ninth film" },
  { q: "What year was The Shape of Water released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Won Best Picture" },
  { q: "What year was Phantom Thread released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Day-Lewis's swan song" },
  { q: "Which film's budget was so small they couldn't afford a dolly?", options: ["El Mariachi ($7,000)", "Clerks ($27,000)", "Pi ($60,000)", "Primer ($7,000)"], answer: "El Mariachi ($7,000)", cat: "bts", detail: "Robert Rodriguez sold his body to medical research" },
  { q: "Which actor lost 62 pounds for a role?", options: ["Christian Bale for The Machinist", "Jared Leto for Dallas Buyers Club", "Matthew McConaughey for Dallas Buyers Club", "Tom Hanks for Cast Away"], answer: "Christian Bale for The Machinist", cat: "bts", detail: "Went down to 120 pounds" },
  { q: "Which film was entirely shot on an iPhone?", options: ["Tangerine", "Unsane", "High Flying Bird", "Searching"], answer: "Tangerine", cat: "bts", detail: "Sean Baker shot it on an iPhone 5s" },
  { q: "Who wrote the screenplay for Pulp Fiction?", options: ["Quentin Tarantino & Roger Avary", "Quentin Tarantino alone", "Aaron Sorkin", "Charlie Kaufman"], answer: "Quentin Tarantino & Roger Avary", cat: "bts", detail: "Won Best Original Screenplay" },
  { q: "Which Martin Scorsese film was his longest?", options: ["Killers of the Flower Moon (3h 26m)", "The Irishman (3h 29m)", "The Wolf of Wall Street (3h)", "Gangs of New York (2h 47m)"], answer: "The Irishman (3h 29m)", cat: "trivia", detail: "Released on Netflix in 2019" },
  { q: "What is the name of the fictional newspaper in Wes Anderson's The French Dispatch?", options: ["The French Dispatch of the Liberty, Kansas Evening Sun", "Le Monde Dispatch", "The Paris Journal", "The Continental Times"], answer: "The French Dispatch of the Liberty, Kansas Evening Sun", cat: "trivia", detail: "Inspired by The New Yorker" },
  { q: "Who directed Her (2013)?", options: ["Spike Jonze", "Sofia Coppola", "Michel Gondry", "Wes Anderson"], answer: "Spike Jonze", cat: "director", detail: "Joaquin Phoenix falls for an AI" },
  { q: "Who directed Arrival (2016)?", options: ["Denis Villeneuve", "Christopher Nolan", "Alex Garland", "Ridley Scott"], answer: "Denis Villeneuve", cat: "director", detail: "Linguistics meets aliens" },
  { q: "Who directed Nightcrawler?", options: ["Dan Gilroy", "David Fincher", "Michael Mann", "Nicolas Winding Refn"], answer: "Dan Gilroy", cat: "director", detail: "Jake Gyllenhaal's intense performance" },
  { q: "Who directed The Witch (2015)?", options: ["Robert Eggers", "Ari Aster", "Jordan Peele", "David Robert Mitchell"], answer: "Robert Eggers", cat: "director", detail: "Eggers' period horror debut" },
  { q: "Who played the lead in Ratatouille (voice)?", options: ["Patton Oswalt", "Owen Wilson", "Jack Black", "Ben Stiller"], answer: "Patton Oswalt", cat: "cast", detail: "Voiced Remy the rat" },
  { q: "Who played both twins in The Parent Trap (1998)?", options: ["Lindsay Lohan", "Mary-Kate Olsen", "Hilary Duff", "Amanda Bynes"], answer: "Lindsay Lohan", cat: "cast", detail: "Lohan's film debut" },
  { q: "Who played Vito Corleone in The Godfather Part II?", options: ["Robert De Niro", "Marlon Brando", "Al Pacino", "James Caan"], answer: "Robert De Niro", cat: "cast", detail: "De Niro won Best Supporting Actor" },
  { q: "Who played both Gollum and Caesar via motion capture?", options: ["Andy Serkis", "Benedict Cumberbatch", "Zoe Saldana", "Mark Ruffalo"], answer: "Andy Serkis", cat: "cast", detail: "Pioneer of performance capture acting" },
  { q: "Who played Clarice Starling in Silence of the Lambs?", options: ["Jodie Foster", "Julianne Moore", "Sigourney Weaver", "Glenn Close"], answer: "Jodie Foster", cat: "cast", detail: "Foster won Best Actress" },
  { q: "Who played the lead in Amelie?", options: ["Audrey Tautou", "Marion Cotillard", "Léa Seydoux", "Juliette Binoche"], answer: "Audrey Tautou", cat: "cast", detail: "French romantic comedy classic" },
  { q: "What was Pixar's first film that didn't get a sequel?", options: ["Ratatouille", "Up", "WALL-E", "Brave"], answer: "Up", cat: "trivia", detail: "Though Dug Days is a spinoff" },
  { q: "What is Quentin Tarantino's first film?", options: ["Reservoir Dogs", "Pulp Fiction", "True Romance", "Natural Born Killers"], answer: "Reservoir Dogs", cat: "trivia", detail: "Released in 1992" },
  { q: "Which MCU film introduced Black Panther?", options: ["Captain America: Civil War", "Black Panther", "Avengers: Age of Ultron", "The Avengers"], answer: "Captain America: Civil War", cat: "trivia", detail: "Before his solo film in 2018" },
  { q: "What was Stanley Kubrick's last film?", options: ["Eyes Wide Shut", "Full Metal Jacket", "A Clockwork Orange", "The Shining"], answer: "Eyes Wide Shut", cat: "trivia", detail: "Kubrick died days after the final cut" },
  { q: "Which film popularized the Wilhelm Scream?", options: ["Star Wars", "Indiana Jones", "Charge at Feather River", "The Lord of the Rings"], answer: "Charge at Feather River", cat: "trivia", detail: "1953 film that named the stock sound effect" },
  { q: "How many films has Christopher Nolan directed?", options: ["12", "10", "8", "15"], answer: "12", cat: "trivia", detail: "From Following (1998) to Oppenheimer (2023)" },
  { q: "What is the MacGuffin in Pulp Fiction?", options: ["The briefcase", "The watch", "The samurai sword", "The adrenaline shot"], answer: "The briefcase", cat: "trivia", detail: "Its contents are never revealed" },
  { q: "Who scored The Dark Knight?", options: ["Hans Zimmer & James Newton Howard", "John Williams", "Howard Shore", "Danny Elfman"], answer: "Hans Zimmer & James Newton Howard", cat: "soundtrack", detail: "The Joker's single-note motif" },
  { q: "Who composed the Interstellar score?", options: ["Hans Zimmer", "John Williams", "Alexandre Desplat", "Jonny Greenwood"], answer: "Hans Zimmer", cat: "soundtrack", detail: "Church organ-driven score" },
  { q: "What Radiohead song appears in Romeo + Juliet (1996)?", options: ["Talk Show Host", "Exit Music (For a Film)", "Creep", "No Surprises"], answer: "Talk Show Host", cat: "soundtrack", detail: "Baz Luhrmann's modern adaptation" },
  { q: "What was the first DreamWorks animated film?", options: ["Antz", "Shrek", "Prince of Egypt", "Chicken Run"], answer: "Antz", cat: "bts", detail: "Released in 1998, weeks before A Bug's Life" },
  { q: "Which film was shot in a single take (or made to look like it)?", options: ["1917", "Birdman", "Both 1917 and Birdman", "Rope"], answer: "Both 1917 and Birdman", cat: "bts", detail: "Both used hidden cuts to simulate continuous takes" },
  { q: "What film launched the career of Quentin Tarantino?", options: ["Reservoir Dogs", "Pulp Fiction", "True Romance", "Four Rooms"], answer: "Reservoir Dogs", cat: "bts", detail: "Premiered at Sundance 1992" },
  { q: "Which director has been nominated for Best Director the most times?", options: ["William Wyler", "Martin Scorsese", "Steven Spielberg", "John Ford"], answer: "William Wyler", cat: "oscar", detail: "12 nominations, won 3" },
  { q: "Which film won Best Picture with the lowest budget?", options: ["Moonlight", "Rocky", "12 Years a Slave", "The Hurt Locker"], answer: "Moonlight", cat: "oscar", detail: "Made for $1.5 million" },
  { q: "Who is the most nominated living actor without a win?", options: ["Glenn Close", "Amy Adams", "Bradley Cooper", "Edward Norton"], answer: "Glenn Close", cat: "oscar", detail: "8 nominations as of 2024" },
  { q: "Which film won both Best Picture and Palme d'Or?", options: ["Parasite", "The Artist", "Marty", "The Lost Weekend"], answer: "Parasite", cat: "oscar", detail: "First film to win both in the same year" },
  { q: "What year was Blade Runner released?", options: ["1982", "1984", "1979", "1986"], answer: "1982", cat: "year", detail: "Ridley Scott's sci-fi noir" },
  { q: "What year was The Departed released?", options: ["2006", "2007", "2005", "2008"], answer: "2006", cat: "year", detail: "Scorsese's Boston crime drama" },
  { q: "Which Tarantino film grossed the most worldwide?", options: ["Django Unchained", "Inglourious Basterds", "Once Upon a Time in Hollywood", "Kill Bill Vol. 1"], answer: "Django Unchained", cat: "boxoffice", detail: "Over $425 million worldwide" },
  { q: "Which horror film grossed over $700 million on a $20 million budget?", options: ["It (2017)", "Get Out", "A Quiet Place", "Hereditary"], answer: "It (2017)", cat: "boxoffice", detail: "Highest-grossing horror film at the time" },
  { q: "Which Best Picture winner made the least at the box office?", options: ["The Hurt Locker", "Moonlight", "Birdman", "The Artist"], answer: "The Hurt Locker", cat: "boxoffice", detail: "Only $49 million worldwide" },
  { q: "Who directed Prisoners (2013)?", options: ["Denis Villeneuve", "David Fincher", "Rian Johnson", "Taylor Sheridan"], answer: "Denis Villeneuve", cat: "director", detail: "Hugh Jackman's desperate father" },
  { q: "Who directed The Prestige?", options: ["Christopher Nolan", "David Fincher", "Ridley Scott", "Peter Jackson"], answer: "Christopher Nolan", cat: "director", detail: "Dueling magicians" },
  { q: "Who directed Children of Men?", options: ["Alfonso Cuarón", "Guillermo del Toro", "Denis Villeneuve", "Alex Garland"], answer: "Alfonso Cuarón", cat: "director", detail: "Dystopian fertility crisis" },
  { q: "Who directed Kill Bill?", options: ["Quentin Tarantino", "Robert Rodriguez", "John Woo", "Ang Lee"], answer: "Quentin Tarantino", cat: "director", detail: "Uma Thurman's revenge epic" },
  { q: "Who played Amy in Gone Girl?", options: ["Rosamund Pike", "Emily Blunt", "Cate Blanchett", "Nicole Kidman"], answer: "Rosamund Pike", cat: "cast", detail: "Pike was nominated for Best Actress" },
  { q: "Who played the lead in A Beautiful Mind?", options: ["Russell Crowe", "Matt Damon", "Leonardo DiCaprio", "Edward Norton"], answer: "Russell Crowe", cat: "cast", detail: "As mathematician John Nash" },
  { q: "Who played Alan Turing in The Imitation Game?", options: ["Benedict Cumberbatch", "Eddie Redmayne", "Colin Firth", "Tom Hiddleston"], answer: "Benedict Cumberbatch", cat: "cast", detail: "Breaking the Enigma code" },
  { q: "Who played the lead in Room (2015)?", options: ["Brie Larson", "Carey Mulligan", "Saoirse Ronan", "Alicia Vikander"], answer: "Brie Larson", cat: "cast", detail: "Larson won Best Actress" },
  { q: "What was Stanley Kubrick's only X-rated film?", options: ["A Clockwork Orange", "Eyes Wide Shut", "Barry Lyndon", "Lolita"], answer: "A Clockwork Orange", cat: "trivia", detail: "Originally rated X in the US" },
  { q: "Which Coen Brothers film won Best Picture?", options: ["No Country for Old Men", "Fargo", "The Big Lebowski", "True Grit"], answer: "No Country for Old Men", cat: "trivia", detail: "2008 ceremony" },
  { q: "What was the first R-rated film to gross $1 billion?", options: ["Joker", "Deadpool", "The Matrix Reloaded", "It"], answer: "Joker", cat: "boxoffice", detail: "2019, on a $55M budget" },
  { q: "What film technique is associated with Wes Anderson?", options: ["Symmetrical framing", "Shaky cam", "Long tracking shots", "Jump cuts"], answer: "Symmetrical framing", cat: "trivia", detail: "Anderson's signature visual style" },
  { q: "What is the name of the fictional drug in Scarface?", options: ["Cocaine (it's real)", "Blue Sky", "Slam", "Slo-Mo"], answer: "Cocaine (it's real)", cat: "trivia", detail: "Tony Montana's cocaine empire" },
  { q: "Who composed the score for The Social Network?", options: ["Trent Reznor & Atticus Ross", "Hans Zimmer", "Jonny Greenwood", "Nicholas Britell"], answer: "Trent Reznor & Atticus Ross", cat: "soundtrack", detail: "Won the Oscar for Best Score" },
  { q: "What Bowie song opens The Life Aquatic's climax?", options: ["Life on Mars?", "Starman", "Heroes", "Space Oddity"], answer: "Life on Mars?", cat: "soundtrack", detail: "Performed in Portuguese by Seu Jorge throughout" },
  { q: "What year was The Shawshank Redemption released?", options: ["1994", "1993", "1995", "1992"], answer: "1994", cat: "year", detail: "Competed with Forrest Gump and Pulp Fiction" },
  { q: "What year was Casino Royale (Daniel Craig) released?", options: ["2006", "2005", "2007", "2004"], answer: "2006", cat: "year", detail: "Craig's Bond debut" },
  { q: "Who won Best Director for Roma?", options: ["Alfonso Cuarón", "Guillermo del Toro", "Denis Villeneuve", "Bong Joon-ho"], answer: "Alfonso Cuarón", cat: "oscar", detail: "First Netflix film to win major Oscars" },
  { q: "Which film won the first Best Animated Feature Oscar?", options: ["Shrek", "Monsters, Inc.", "Spirited Away", "Ice Age"], answer: "Shrek", cat: "oscar", detail: "The category was introduced in 2002" },
  { q: "Who is the oldest person to win Best Director?", options: ["Clint Eastwood", "John Huston", "Anthony Hopkins", "Martin Scorsese"], answer: "Clint Eastwood", cat: "oscar", detail: "Age 74 for Million Dollar Baby" },
  { q: "What was the first horror film nominated for Best Picture?", options: ["The Exorcist", "Jaws", "Silence of the Lambs", "Get Out"], answer: "The Exorcist", cat: "oscar", detail: "Nominated in 1974" },
  { q: "Who directed Training Day?", options: ["Antoine Fuqua", "Spike Lee", "F. Gary Gray", "John Singleton"], answer: "Antoine Fuqua", cat: "director", detail: "Denzel Washington won Best Actor" },
  { q: "Who directed The Departed?", options: ["Martin Scorsese", "Ridley Scott", "Michael Mann", "David Fincher"], answer: "Martin Scorsese", cat: "director", detail: "Scorsese's long-awaited Best Director win" },
  { q: "Who directed The Big Short?", options: ["Adam McKay", "David O. Russell", "Martin Scorsese", "Bennett Miller"], answer: "Adam McKay", cat: "director", detail: "Comedy director turned serious" },
  { q: "Who directed Uncut Gems?", options: ["Safdie Brothers", "Ari Aster", "Robert Eggers", "David Fincher"], answer: "Safdie Brothers", cat: "director", detail: "Adam Sandler's dramatic turn" },
  { q: "Who directed Jojo Rabbit?", options: ["Taika Waititi", "Wes Anderson", "Edgar Wright", "Martin McDonagh"], answer: "Taika Waititi", cat: "director", detail: "Waititi played imaginary Hitler" },
  { q: "Who directed Knives Out?", options: ["Rian Johnson", "Edgar Wright", "Martin McDonagh", "Taika Waititi"], answer: "Rian Johnson", cat: "director", detail: "Daniel Craig's detective" },
  { q: "Who played the lead in Everything Everywhere All at Once?", options: ["Michelle Yeoh", "Ke Huy Quan", "Jamie Lee Curtis", "Stephanie Hsu"], answer: "Michelle Yeoh", cat: "cast", detail: "Won Best Actress" },
  { q: "Who played Jordan Belfort in Wolf of Wall Street?", options: ["Leonardo DiCaprio", "Matthew McConaughey", "Jonah Hill", "Kyle Chandler"], answer: "Leonardo DiCaprio", cat: "cast", detail: "Based on the real Belfort" },
  { q: "Who played the lead in Whiplash?", options: ["Miles Teller", "Timothée Chalamet", "Lucas Hedges", "Ansel Elgort"], answer: "Miles Teller", cat: "cast", detail: "Drumming through blood" },
  { q: "Who played the teacher in Whiplash?", options: ["J.K. Simmons", "Michael Keaton", "Ed Harris", "J.K. Rowling"], answer: "J.K. Simmons", cat: "cast", detail: "Won Best Supporting Actor" },
  { q: "Who played the lead in Black Swan?", options: ["Natalie Portman", "Mila Kunis", "Winona Ryder", "Rooney Mara"], answer: "Natalie Portman", cat: "cast", detail: "Won Best Actress" },
  { q: "What is the twist in Fight Club?", options: ["Tyler Durden is the narrator's alter ego", "Tyler is a ghost", "The narrator is dreaming", "Tyler is his brother"], answer: "Tyler Durden is the narrator's alter ego", cat: "trivia", detail: "First rule: don't talk about it" },
  { q: "What is the twist in The Sixth Sense?", options: ["Bruce Willis' character is dead", "The boy is imagining things", "The ghosts are alive", "It was all a dream"], answer: "Bruce Willis' character is dead", cat: "trivia", detail: "I see dead people" },
  { q: "What does 'Rosebud' refer to in Citizen Kane?", options: ["His childhood sled", "His mother", "His first love", "His newspaper"], answer: "His childhood sled", cat: "trivia", detail: "Cinema's most famous MacGuffin" },
  { q: "What year was Knives Out released?", options: ["2019", "2020", "2018", "2021"], answer: "2019", cat: "year", detail: "Rian Johnson's whodunit" },
  { q: "What year was Lady Bird released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Greta Gerwig's solo directing debut" },
  { q: "Which A24 film was the first to win Best Picture?", options: ["Everything Everywhere All at Once", "Moonlight", "Lady Bird", "Nomadland"], answer: "Everything Everywhere All at Once", cat: "oscar", detail: "2023 ceremony" },
  { q: "Who won Best Supporting Actor for Once Upon a Time in Hollywood?", options: ["Brad Pitt", "Leonardo DiCaprio", "Al Pacino", "Timothy Olyphant"], answer: "Brad Pitt", cat: "oscar", detail: "Pitt's first acting Oscar" },
  { q: "Which was the first streaming film to win Best Picture?", options: ["No streaming film has won yet", "CODA", "Roma", "The Power of the Dog"], answer: "No streaming film has won yet", cat: "oscar", detail: "CODA was distributed by Apple but produced traditionally" },
  { q: "Who composed the score for Moonlight?", options: ["Nicholas Britell", "Jonny Greenwood", "Mica Levi", "Trent Reznor"], answer: "Nicholas Britell", cat: "soundtrack", detail: "Chopped and screwed classical music" },
  { q: "Which David Lynch film features the line 'In dreams, I walk with you'?", options: ["Blue Velvet", "Mulholland Drive", "Twin Peaks: Fire Walk with Me", "Lost Highway"], answer: "Blue Velvet", cat: "soundtrack", detail: "Roy Orbison's haunting song" },
  { q: "What technique did Mad Max: Fury Road use for its action scenes?", options: ["Center-framing to guide the eye", "Shaky cam throughout", "Slow motion exclusively", "All CGI environments"], answer: "Center-framing to guide the eye", cat: "bts", detail: "The action is always in the center of frame" },
  { q: "How long did it take Richard Linklater to film Boyhood?", options: ["12 years", "8 years", "15 years", "10 years"], answer: "12 years", cat: "bts", detail: "Filmed the same actors from 2002 to 2013" },
  { q: "Which film was shot entirely on an iPhone?", options: ["Tangerine", "Searching", "Unfriended", "Paranormal Activity"], answer: "Tangerine", cat: "bts", detail: "Sean Baker shot it on an iPhone 5S" },
  { q: "Which A24 film had the highest box office?", options: ["Everything Everywhere All at Once", "Uncut Gems", "Hereditary", "Midsommar"], answer: "Everything Everywhere All at Once", cat: "boxoffice", detail: "Over $140 million worldwide" },
  { q: "Who directed Us (2019)?", options: ["Jordan Peele", "Ari Aster", "Robert Eggers", "Mike Flanagan"], answer: "Jordan Peele", cat: "director", detail: "Peele's follow-up to Get Out" },
  { q: "Who directed Dunkirk?", options: ["Christopher Nolan", "Ridley Scott", "Sam Mendes", "Steven Spielberg"], answer: "Christopher Nolan", cat: "director", detail: "WWII survival from land, sea, and air" },
  { q: "Who directed Interstellar?", options: ["Christopher Nolan", "Denis Villeneuve", "Ridley Scott", "Alfonso Cuarón"], answer: "Christopher Nolan", cat: "director", detail: "Time dilation and father-daughter love" },
  { q: "Who directed Gravity?", options: ["Alfonso Cuarón", "Christopher Nolan", "Ridley Scott", "Denis Villeneuve"], answer: "Alfonso Cuarón", cat: "director", detail: "Sandra Bullock lost in space" },
  { q: "Who directed Dune (2021)?", options: ["Denis Villeneuve", "Christopher Nolan", "Ridley Scott", "Alex Garland"], answer: "Denis Villeneuve", cat: "director", detail: "Frank Herbert's sci-fi epic" },
  { q: "Who played Paul Atreides in Dune (2021)?", options: ["Timothée Chalamet", "Tom Holland", "Robert Pattinson", "Austin Butler"], answer: "Timothée Chalamet", cat: "cast", detail: "Chalamet's blockbuster role" },
  { q: "Who played Barbie in Barbie (2023)?", options: ["Margot Robbie", "Gal Gadot", "Emma Stone", "Florence Pugh"], answer: "Margot Robbie", cat: "cast", detail: "Pink plastic fantastic" },
  { q: "Who played Ken in Barbie (2023)?", options: ["Ryan Gosling", "Simu Liu", "John Cena", "Will Ferrell"], answer: "Ryan Gosling", cat: "cast", detail: "I'm just Ken" },
  { q: "Who played Oppenheimer?", options: ["Cillian Murphy", "Robert Downey Jr.", "Matt Damon", "Josh Hartnett"], answer: "Cillian Murphy", cat: "cast", detail: "Murphy's first leading Oscar role" },
  { q: "Who played the lead in The Lighthouse?", options: ["Robert Pattinson & Willem Dafoe", "Daniel Radcliffe", "Adam Driver", "Joaquin Phoenix"], answer: "Robert Pattinson & Willem Dafoe", cat: "cast", detail: "Two-hander descent into madness" },
  { q: "What does 'mise-en-scène' mean?", options: ["Everything placed in the frame", "Camera movement", "Film editing", "Sound design"], answer: "Everything placed in the frame", cat: "trivia", detail: "French term: setting, lighting, costume, staging" },
  { q: "What is a 'tracking shot'?", options: ["Camera follows a subject in continuous motion", "A close-up of footsteps", "A zoom lens technique", "A type of time-lapse"], answer: "Camera follows a subject in continuous motion", cat: "trivia", detail: "Goodfellas' Copacabana shot is iconic" },
  { q: "What is 'chiaroscuro' in cinematography?", options: ["Strong contrast between light and dark", "A type of camera lens", "Background music technique", "A type of film grain"], answer: "Strong contrast between light and dark", cat: "trivia", detail: "Used heavily in film noir" },
  { q: "Which film festival awards the Golden Lion?", options: ["Venice", "Cannes", "Berlin", "Toronto"], answer: "Venice", cat: "trivia", detail: "The oldest film festival in the world" },
  { q: "Which film festival awards the Golden Bear?", options: ["Berlin", "Venice", "Cannes", "Locarno"], answer: "Berlin", cat: "trivia", detail: "The Berlinale" },
  { q: "What year was Mulholland Drive released?", options: ["2001", "2003", "1999", "2005"], answer: "2001", cat: "year", detail: "David Lynch's surreal Hollywood nightmare" },
  { q: "What year was Eternal Sunshine of the Spotless Mind released?", options: ["2004", "2003", "2005", "2006"], answer: "2004", cat: "year", detail: "Gondry and Kaufman's romance" },
  { q: "What year was In Bruges released?", options: ["2008", "2007", "2009", "2010"], answer: "2008", cat: "year", detail: "McDonagh's dark comedy" },
  { q: "What year was District 9 released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "Neill Blomkamp's apartheid allegory" },
  { q: "Who won Best Supporting Actress for Everything Everywhere All at Once?", options: ["Jamie Lee Curtis", "Michelle Yeoh", "Stephanie Hsu", "Ke Huy Quan"], answer: "Jamie Lee Curtis", cat: "oscar", detail: "Curtis's first Oscar" },
  { q: "Who won Best Supporting Actor for Everything Everywhere All at Once?", options: ["Ke Huy Quan", "Jamie Lee Curtis", "Brendan Fraser", "Barry Keoghan"], answer: "Ke Huy Quan", cat: "oscar", detail: "Former child actor's comeback" },
  { q: "Who composed the score for Everything Everywhere All at Once?", options: ["Son Lux", "Nicholas Britell", "Trent Reznor", "Jonny Greenwood"], answer: "Son Lux", cat: "soundtrack", detail: "Experimental trio" },
  { q: "What Simon & Garfunkel song bookends The Graduate?", options: ["The Sound of Silence", "Mrs. Robinson", "Scarborough Fair", "Bridge Over Troubled Water"], answer: "The Sound of Silence", cat: "soundtrack", detail: "Hello darkness, my old friend" },
  { q: "How much did it cost to make Barbie (2023)?", options: ["$145 million", "$200 million", "$100 million", "$80 million"], answer: "$145 million", cat: "boxoffice", detail: "And earned over $1.4 billion" },
  { q: "How much did Oppenheimer cost to make?", options: ["$100 million", "$150 million", "$200 million", "$80 million"], answer: "$100 million", cat: "boxoffice", detail: "Shot on IMAX film, not digital" },
  { q: "What was the Barbenheimer phenomenon?", options: ["Barbie and Oppenheimer released the same day", "A movie about barbershops", "A Barbie horror film", "A Nolan-Gerwig collaboration"], answer: "Barbie and Oppenheimer released the same day", cat: "bts", detail: "July 21, 2023 became a cultural event" },
  { q: "Which film used real nuclear explosion footage?", options: ["Oppenheimer", "Dr. Strangelove", "The Day After", "Threads"], answer: "Oppenheimer", cat: "bts", detail: "Nolan recreated the Trinity test without CGI" },
  ...
  { q: "Who directed The Lion King (1994)?", options: ["Roger Allers & Rob Minkoff", "John Lasseter", "Don Bluth", "Tim Burton"], answer: "Roger Allers & Rob Minkoff", cat: "director", detail: "Disney's animated classic" },
  { q: "Who directed Home Alone?", options: ["Chris Columbus", "John Hughes", "Steven Spielberg", "Robert Zemeckis"], answer: "Chris Columbus", cat: "director", detail: "Columbus directed the first two films" },
  { q: "Who directed Shrek?", options: ["Andrew Adamson & Vicky Jenson", "Brad Bird", "Pete Docter", "John Lasseter"], answer: "Andrew Adamson & Vicky Jenson", cat: "director", detail: "DreamWorks' ogre hit" },
  { q: "Who directed The Avengers (2012)?", options: ["Joss Whedon", "Jon Favreau", "Anthony Russo", "James Gunn"], answer: "Joss Whedon", cat: "director", detail: "The first MCU team-up" },
  { q: "Who directed Forrest Gump?", options: ["Robert Zemeckis", "Steven Spielberg", "Ron Howard", "Barry Levinson"], answer: "Robert Zemeckis", cat: "director", detail: "Won Best Director at the 1995 Oscars" },
  { q: "Who directed Frozen?", options: ["Chris Buck & Jennifer Lee", "Pete Docter", "Byron Howard", "Lee Unkrich"], answer: "Chris Buck & Jennifer Lee", cat: "director", detail: "Disney's 2013 mega-hit" },
  { q: "Who directed E.T. the Extra-Terrestrial?", options: ["Steven Spielberg", "George Lucas", "Robert Zemeckis", "James Cameron"], answer: "Steven Spielberg", cat: "director", detail: "Spielberg's 1982 classic" },
  { q: "Who directed Finding Nemo?", options: ["Andrew Stanton", "John Lasseter", "Pete Docter", "Brad Bird"], answer: "Andrew Stanton", cat: "director", detail: "Pixar's 2003 underwater adventure" },
  { q: "What year was the first Star Wars film released?", options: ["1977", "1980", "1975", "1983"], answer: "1977", cat: "year", detail: "A New Hope changed cinema forever" },
  { q: "What year was Titanic released?", options: ["1997", "1998", "1996", "1999"], answer: "1997", cat: "year", detail: "Cameron's record-breaking epic" },
  { q: "What year was The Lion King (original) released?", options: ["1994", "1995", "1993", "1996"], answer: "1994", cat: "year", detail: "Disney's animated masterpiece" },
  { q: "What year was Jurassic Park released?", options: ["1993", "1994", "1992", "1995"], answer: "1993", cat: "year", detail: "Spielberg's dinosaur revolution" },
  { q: "What year was Finding Nemo released?", options: ["2003", "2004", "2002", "2001"], answer: "2003", cat: "year", detail: "Pixar's underwater hit" },
  { q: "What year was The Dark Knight released?", options: ["2008", "2007", "2009", "2006"], answer: "2008", cat: "year", detail: "Heath Ledger's final complete role" },
  { q: "What year was Frozen released?", options: ["2013", "2014", "2012", "2015"], answer: "2013", cat: "year", detail: "Let It Go took over the world" },
  { q: "What year was Inception released?", options: ["2010", "2011", "2009", "2012"], answer: "2010", cat: "year", detail: "Nolan's mind-bending thriller" },
  { q: "Who directed Up?", options: ["Pete Docter", "Andrew Stanton", "Brad Bird", "Lee Unkrich"], answer: "Pete Docter", cat: "director", detail: "Pixar's 2009 emotional adventure" },
  { q: "Who directed Coco?", options: ["Lee Unkrich", "Pete Docter", "Adrian Molina", "Andrew Stanton"], answer: "Lee Unkrich", cat: "director", detail: "Pixar's Day of the Dead story" },
  { q: "Who directed The Incredibles?", options: ["Brad Bird", "Pete Docter", "Andrew Stanton", "John Lasseter"], answer: "Brad Bird", cat: "director", detail: "Bird's 2004 superhero family film" },
  { q: "Who directed Guardians of the Galaxy?", options: ["James Gunn", "Taika Waititi", "Joss Whedon", "Jon Watts"], answer: "James Gunn", cat: "director", detail: "Gunn's space opera" },
  { q: "Who directed Spider-Man: Into the Spider-Verse?", options: ["Peter Ramsey, Bob Persichetti & Rodney Rothman", "Phil Lord", "Brad Bird", "Travis Knight"], answer: "Peter Ramsey, Bob Persichetti & Rodney Rothman", cat: "director", detail: "Won Best Animated Feature" },
  { q: "What does WALL-E stand for?", options: ["Waste Allocation Load Lifter Earth-class", "World Automated Living Logistics Engine", "Wide Area Land Lifter Excavator", "Wireless Automated Labor Litter Eliminator"], answer: "Waste Allocation Load Lifter Earth-class", cat: "trivia", detail: "Pixar's 2008 robot love story" },
  { q: "What is the name of the ship in Alien?", options: ["Nostromo", "Sulaco", "Prometheus", "Covenant"], answer: "Nostromo", cat: "trivia", detail: "A commercial towing spacecraft" },
  { q: "How many rings are there in Lord of the Rings?", options: ["20", "9", "3", "7"], answer: "20", cat: "trivia", detail: "Three for elves, seven for dwarves, nine for men, one to rule them all" },
  { q: "What is the name of the camp in The Parent Trap?", options: ["Camp Walden", "Camp Crystal Lake", "Camp Green Lake", "Camp Chippewa"], answer: "Camp Walden", cat: "trivia", detail: "Where the twins meet" },
  { q: "What flavor of Pop-Tarts does Buddy eat in Elf?", options: ["Chocolate", "Strawberry", "All flavors with syrup", "Blueberry"], answer: "All flavors with syrup", cat: "trivia", detail: "Part of the four main food groups for elves" },
  { q: "What year was Toy Story released?", options: ["1995", "1996", "1994", "1997"], answer: "1995", cat: "year", detail: "The first fully CG-animated feature" },
  { q: "What year was Shrek released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "Won the first Best Animated Feature Oscar" },
  { q: "What year was The Avengers released?", options: ["2012", "2011", "2013", "2010"], answer: "2012", cat: "year", detail: "The MCU's first crossover event" },
  { q: "What year was Up released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "Opened the Cannes Film Festival" },
  { q: "What year was E.T. released?", options: ["1982", "1983", "1981", "1984"], answer: "1982", cat: "year", detail: "Spielberg's beloved alien film" },
  { q: "What year was Home Alone released?", options: ["1990", "1991", "1989", "1992"], answer: "1990", cat: "year", detail: "The Christmas classic" },
  { q: "What year was Jaws released?", options: ["1975", "1976", "1974", "1977"], answer: "1975", cat: "year", detail: "The first summer blockbuster" },
  { q: "Who directed WALL-E?", options: ["Andrew Stanton", "Pete Docter", "Brad Bird", "Lee Unkrich"], answer: "Andrew Stanton", cat: "director", detail: "Pixar's 2008 robot love story" },
  { q: "Who directed Moana?", options: ["Ron Clements & John Musker", "Byron Howard", "Chris Buck", "Pete Docter"], answer: "Ron Clements & John Musker", cat: "director", detail: "Disney's Polynesian adventure" },
  { q: "Who directed Inside Out?", options: ["Pete Docter", "Andrew Stanton", "Brad Bird", "Lee Unkrich"], answer: "Pete Docter", cat: "director", detail: "Pixar's journey through the mind" },
  { q: "Who directed the first Iron Man?", options: ["Jon Favreau", "Joss Whedon", "Kenneth Branagh", "Shane Black"], answer: "Jon Favreau", cat: "director", detail: "The film that launched the MCU" },
  { q: "Who directed Ratatouille?", options: ["Brad Bird", "Andrew Stanton", "Pete Docter", "John Lasseter"], answer: "Brad Bird", cat: "director", detail: "Anyone can cook" },
  { q: "Who directed the first Pirates of the Caribbean?", options: ["Gore Verbinski", "Rob Marshall", "Jerry Bruckheimer", "Tim Burton"], answer: "Gore Verbinski", cat: "director", detail: "Curse of the Black Pearl" },
  { q: "What year was The Lord of the Rings: Fellowship of the Ring released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "The trilogy begins" },
  { q: "What year was Harry Potter and the Philosopher's Stone released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "Same year as Fellowship of the Ring" },
  { q: "What year was The Hunger Games released?", options: ["2012", "2013", "2011", "2014"], answer: "2012", cat: "year", detail: "Jennifer Lawrence became a superstar" },
  { q: "What year was Black Panther released?", options: ["2018", "2017", "2019", "2020"], answer: "2018", cat: "year", detail: "Wakanda forever" },
  { q: "What year was Forrest Gump released?", options: ["1994", "1995", "1993", "1996"], answer: "1994", cat: "year", detail: "Run Forrest run" },
  { q: "Who directed Toy Story 4?", options: ["Josh Cooley", "Pete Docter", "Andrew Stanton", "Lee Unkrich"], answer: "Josh Cooley", cat: "director", detail: "Woody finds a new purpose" },
  { q: "Who directed Despicable Me?", options: ["Pierre Coffin & Chris Renaud", "Gru", "Tim Burton", "Brad Bird"], answer: "Pierre Coffin & Chris Renaud", cat: "director", detail: "Minions were born" },
  { q: "Who directed Kung Fu Panda?", options: ["Mark Osborne & John Stevenson", "Andrew Adamson", "Pete Docter", "Dean DeBlois"], answer: "Mark Osborne & John Stevenson", cat: "director", detail: "DreamWorks' martial arts comedy" },
  { q: "Who directed The Hunger Games?", options: ["Gary Ross", "Francis Lawrence", "Suzanne Collins", "Lenny Kravitz"], answer: "Gary Ross", cat: "director", detail: "Ross directed the first film" },
  { q: "What year was Avengers: Endgame released?", options: ["2019", "2018", "2020", "2017"], answer: "2019", cat: "year", detail: "The culmination of 22 MCU films" },
  { q: "What year was Spider-Man (Tobey Maguire) released?", options: ["2002", "2003", "2001", "2004"], answer: "2002", cat: "year", detail: "Sam Raimi's superhero landmark" },
  { q: "What year was Shawshank Redemption released?", options: ["1994", "1995", "1993", "1996"], answer: "1994", cat: "year", detail: "Flopped at the box office, became a classic" },
  { q: "What year was Despicable Me released?", options: ["2010", "2011", "2009", "2012"], answer: "2010", cat: "year", detail: "Minions took over the world" },
  { q: "What year was The Matrix released?", options: ["1999", "2000", "1998", "2001"], answer: "1999", cat: "year", detail: "Red pill or blue pill" },
  { q: "What is the Pixar theory?", options: ["All Pixar films exist in the same universe", "All villains are related", "Every film has a Pizza Planet truck", "Pixar films are told in reverse"], answer: "All Pixar films exist in the same universe", cat: "trivia", detail: "A fan theory connecting all Pixar films" },
  { q: "Who directed Zootopia?", options: ["Byron Howard & Rich Moore", "Pete Docter", "Chris Buck", "Brad Bird"], answer: "Byron Howard & Rich Moore", cat: "director", detail: "Disney's 2016 animal city" },
  { q: "Who directed Wreck-It Ralph?", options: ["Rich Moore", "Byron Howard", "Pete Docter", "Chris Williams"], answer: "Rich Moore", cat: "director", detail: "Disney's video game adventure" },
  { q: "Who directed Encanto?", options: ["Byron Howard & Jared Bush", "Pete Docter", "Lee Unkrich", "Chris Buck"], answer: "Byron Howard & Jared Bush", cat: "director", detail: "We don't talk about Bruno" },
  { q: "What does JARVIS stand for in Iron Man?", options: ["Just A Rather Very Intelligent System", "Joint Automated Response Virtual Intelligence System", "Jarvis Automated Resource & Virtual Intelligence System", "None — it's just a name"], answer: "Just A Rather Very Intelligent System", cat: "trivia", detail: "Tony Stark's AI assistant" },
  { q: "What is the name of Woody's horse in Toy Story 2?", options: ["Bullseye", "Trigger", "Spirit", "Maximus"], answer: "Bullseye", cat: "trivia", detail: "A loyal toy horse" },
  { q: "What year was Beauty and the Beast (animated) released?", options: ["1991", "1992", "1990", "1993"], answer: "1991", cat: "year", detail: "First animated Best Picture nominee" },
  { q: "What year was Aladdin (animated) released?", options: ["1992", "1993", "1991", "1994"], answer: "1992", cat: "year", detail: "Robin Williams as the Genie" },
  { q: "What year was The Little Mermaid released?", options: ["1989", "1990", "1988", "1991"], answer: "1989", cat: "year", detail: "Started the Disney Renaissance" },
  { q: "What year was Coco released?", options: ["2017", "2018", "2016", "2019"], answer: "2017", cat: "year", detail: "Pixar's Day of the Dead story" },
  { q: "What year was Moana released?", options: ["2016", "2017", "2015", "2018"], answer: "2016", cat: "year", detail: "Disney's Polynesian adventure" },
  { q: "What year was WALL-E released?", options: ["2008", "2009", "2007", "2010"], answer: "2008", cat: "year", detail: "Pixar's nearly silent masterpiece" },
  { q: "What year was Ratatouille released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "Anyone can cook" },
  { q: "Who directed Tangled?", options: ["Nathan Greno & Byron Howard", "Chris Buck", "Lee Unkrich", "Pete Docter"], answer: "Nathan Greno & Byron Howard", cat: "director", detail: "Disney's Rapunzel story" },
  { q: "Who directed How to Train Your Dragon?", options: ["Dean DeBlois & Chris Sanders", "Andrew Adamson", "Pete Docter", "Brad Bird"], answer: "Dean DeBlois & Chris Sanders", cat: "director", detail: "DreamWorks' dragon epic" },
  { q: "Who directed the first Jumanji?", options: ["Joe Johnston", "Steven Spielberg", "Robert Zemeckis", "Barry Sonnenfeld"], answer: "Joe Johnston", cat: "director", detail: "The 1995 Robin Williams adventure" },
  { q: "What is the name of Nemo's dad?", options: ["Marlin", "Martin", "Marcus", "Merlin"], answer: "Marlin", cat: "trivia", detail: "Albert Brooks voiced him" },
  { q: "What year was Encanto released?", options: ["2021", "2022", "2020", "2023"], answer: "2021", cat: "year", detail: "We don't talk about Bruno" },
  { q: "What year was Tangled released?", options: ["2010", "2011", "2009", "2012"], answer: "2010", cat: "year", detail: "Disney's Rapunzel film" },
  { q: "What year was How to Train Your Dragon released?", options: ["2010", "2011", "2009", "2012"], answer: "2010", cat: "year", detail: "DreamWorks' Viking adventure" },
  { q: "What year was Inside Out released?", options: ["2015", "2016", "2014", "2017"], answer: "2015", cat: "year", detail: "Pixar's emotions masterpiece" },
  { q: "What year was Zootopia released?", options: ["2016", "2017", "2015", "2018"], answer: "2016", cat: "year", detail: "Disney's animal metropolis" },
  { q: "What year was Kung Fu Panda released?", options: ["2008", "2009", "2007", "2010"], answer: "2008", cat: "year", detail: "Skadoosh" },
  { q: "Who won Best Animated Feature for Coco?", options: ["Pixar (Lee Unkrich)", "Disney (Byron Howard)", "DreamWorks", "Studio Ghibli"], answer: "Pixar (Lee Unkrich)", cat: "oscar", detail: "Also won Best Original Song" },
  { q: "Who directed Brave?", options: ["Mark Andrews & Brenda Chapman", "Pete Docter", "Andrew Stanton", "Lee Unkrich"], answer: "Mark Andrews & Brenda Chapman", cat: "director", detail: "Pixar's Scottish princess story" },
  { q: "Who directed Lilo & Stitch?", options: ["Dean DeBlois & Chris Sanders", "Ron Clements", "John Musker", "Kirk Wise"], answer: "Dean DeBlois & Chris Sanders", cat: "director", detail: "Disney's Hawaiian alien buddy film" },
  { q: "Who directed Monsters University?", options: ["Dan Scanlon", "Pete Docter", "Lee Unkrich", "Andrew Stanton"], answer: "Dan Scanlon", cat: "director", detail: "The Monsters, Inc. prequel" },
  { q: "Who played Mr. Incredible?", options: ["Craig T. Nelson", "Samuel L. Jackson", "Brad Bird", "Jason Lee"], answer: "Craig T. Nelson", cat: "cast", detail: "Bob Parr, the retired superhero" },
  { q: "What is the name of Marlin's wife in Finding Nemo?", options: ["Coral", "Dory", "Pearl", "Sheldon"], answer: "Coral", cat: "trivia", detail: "She appears briefly at the beginning" },
  { q: "What year was Brave released?", options: ["2012", "2013", "2011", "2014"], answer: "2012", cat: "year", detail: "Pixar's first female lead" },
  { q: "What year was Monsters, Inc. released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "Pixar's scare factory" },
  { q: "What year was The Incredibles released?", options: ["2004", "2005", "2003", "2006"], answer: "2004", cat: "year", detail: "Brad Bird's superhero family" },
  { q: "What year was Cars released?", options: ["2006", "2007", "2005", "2008"], answer: "2006", cat: "year", detail: "Pixar's automotive world" },
  { q: "What year was Wreck-It Ralph released?", options: ["2012", "2013", "2011", "2014"], answer: "2012", cat: "year", detail: "Disney's video game homage" },
  { q: "Who directed Toy Story 3?", options: ["Lee Unkrich", "John Lasseter", "Pete Docter", "Andrew Stanton"], answer: "Lee Unkrich", cat: "director", detail: "First animated film to gross $1B" },
  { q: "Who directed E.T.?", options: ["Steven Spielberg", "George Lucas", "Robert Zemeckis", "Ron Howard"], answer: "Steven Spielberg", cat: "director", detail: "1982 sci-fi classic" },
  { q: "What year was Avatar released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "Highest-grossing film for a decade" },
  { q: "What year was Gladiator released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Russell Crowe's Best Actor win" },
  { q: "What year was The Incredibles 2 released?", options: ["2018", "2017", "2019", "2016"], answer: "2018", cat: "year", detail: "14 years after the original" },
  { q: "Who won Best Animated Feature for Toy Story 3?", options: ["Lee Unkrich", "Pete Docter", "Andrew Stanton", "Brad Bird"], answer: "Lee Unkrich", cat: "oscar", detail: "Pixar's 5th win in the category" },
  { q: "Who directed Coco?", options: ["Lee Unkrich & Adrian Molina", "Pete Docter", "Brad Bird", "Andrew Stanton"], answer: "Lee Unkrich & Adrian Molina", cat: "director", detail: "Pixar's Day of the Dead story" },
  { q: "Who directed Back to the Future?", options: ["Robert Zemeckis", "Steven Spielberg", "George Lucas", "James Cameron"], answer: "Robert Zemeckis", cat: "director", detail: "Spielberg produced it" },
  { q: "What is the name of the clownfish dad in Finding Nemo?", options: ["Marlin", "Nemo", "Gill", "Crush"], answer: "Marlin", cat: "trivia", detail: "Overprotective father" },
  { q: "What year was Back to the Future released?", options: ["1985", "1984", "1986", "1983"], answer: "1985", cat: "year", detail: "Michael J. Fox time travels" },
  { q: "What year was Ghostbusters released?", options: ["1984", "1985", "1983", "1986"], answer: "1984", cat: "year", detail: "Who you gonna call?" },
  { q: "What year was Spider-Man: Into the Spider-Verse released?", options: ["2018", "2019", "2017", "2020"], answer: "2018", cat: "year", detail: "Groundbreaking animation" },
  { q: "What year was The Lego Movie released?", options: ["2014", "2013", "2015", "2016"], answer: "2014", cat: "year", detail: "Everything is awesome" },
  { q: "What year was John Wick released?", options: ["2014", "2015", "2013", "2016"], answer: "2014", cat: "year", detail: "Keanu Reeves' action comeback" },
  { q: "What year was Guardians of the Galaxy released?", options: ["2014", "2015", "2013", "2016"], answer: "2014", cat: "year", detail: "MCU's cosmic hit" },
  { q: "What year was Wonder Woman (2017) released?", options: ["2017", "2016", "2018", "2019"], answer: "2017", cat: "year", detail: "Gal Gadot's solo debut" },
  { q: "What year was Mulan (animated) released?", options: ["1998", "1999", "1997", "2000"], answer: "1998", cat: "year", detail: "Disney's warrior princess" },
  { q: "What year was Big Hero 6 released?", options: ["2014", "2015", "2013", "2016"], answer: "2014", cat: "year", detail: "Baymax!" },
  { q: "Who directed The Nightmare Before Christmas?", options: ["Henry Selick", "Tim Burton", "Brad Bird", "Gore Verbinski"], answer: "Henry Selick", cat: "director", detail: "Burton produced, Selick directed" },
  { q: "Who directed The Iron Giant?", options: ["Brad Bird", "Pete Docter", "Andrew Stanton", "John Lasseter"], answer: "Brad Bird", cat: "director", detail: "Bird's animated debut" },
  { q: "What year was Pirates of the Caribbean: Curse of the Black Pearl released?", options: ["2003", "2004", "2002", "2005"], answer: "2003", cat: "year", detail: "Johnny Depp's surprise hit" },
  { q: "What year was Twilight released?", options: ["2008", "2009", "2007", "2010"], answer: "2008", cat: "year", detail: "The vampire phenomenon begins" },
  { q: "What year was Mean Girls released?", options: ["2004", "2005", "2003", "2006"], answer: "2004", cat: "year", detail: "On Wednesdays we wear pink" },
  { q: "What year was Napoleon Dynamite released?", options: ["2004", "2005", "2003", "2006"], answer: "2004", cat: "year", detail: "Vote for Pedro" },
  { q: "What year was The Notebook released?", options: ["2004", "2005", "2003", "2006"], answer: "2004", cat: "year", detail: "Ryan Gosling and Rachel McAdams" },
  { q: "What year was Superbad released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "Jonah Hill and Michael Cera" },
  { q: "What year was The Hangover released?", options: ["2009", "2010", "2008", "2011"], answer: "2009", cat: "year", detail: "What happened in Vegas?" },
  { q: "What year was Bridesmaids released?", options: ["2011", "2012", "2010", "2013"], answer: "2011", cat: "year", detail: "Kristen Wiig's breakout" },
  { q: "What year was 21 Jump Street (film) released?", options: ["2012", "2013", "2011", "2014"], answer: "2012", cat: "year", detail: "Channing Tatum and Jonah Hill" },
  { q: "What year was Pitch Perfect released?", options: ["2012", "2013", "2011", "2014"], answer: "2012", cat: "year", detail: "Anna Kendrick's aca-awesome film" },
  { q: "Who won Best Animated Feature for Frozen?", options: ["Chris Buck & Jennifer Lee", "Pete Docter", "Dean DeBlois", "Lee Unkrich"], answer: "Chris Buck & Jennifer Lee", cat: "oscar", detail: "Let it go to the Oscars" },
];
...
{ q: "Who played Daniel Plainview in There Will Be Blood?", options: ["Daniel Day-Lewis", "Peter Finch", "Morgan Freeman", "Hugh Jackman"], answer: "Daniel Day-Lewis", cat: "cast", detail: "Daniel Day-Lewis in There Will Be Blood" },
  ...
  { q: "Who directed Stalker (1979)?", options: ["Andrei Tarkovsky", "Ingmar Bergman", "Béla Tarr", "Krzysztof Kieślowski"], answer: "Andrei Tarkovsky", cat: "director", detail: "Tarkovsky's philosophical sci-fi" },
  { q: "Who directed Persona (1966)?", options: ["Ingmar Bergman", "Federico Fellini", "Michelangelo Antonioni", "Luis Buñuel"], answer: "Ingmar Bergman", cat: "director", detail: "Bergman's avant-garde masterpiece" },
  { q: "Who directed In the Mood for Love?", options: ["Wong Kar-wai", "Edward Yang", "Hou Hsiao-hsien", "Zhang Yimou"], answer: "Wong Kar-wai", cat: "director", detail: "Kar-wai's 2000 romantic masterpiece" },
  { q: "Who directed Amour (2012)?", options: ["Michael Haneke", "Lars von Trier", "Abbas Kiarostami", "Pedro Almodóvar"], answer: "Michael Haneke", cat: "director", detail: "Won the Palme d'Or" },
  { q: "Who directed The Turin Horse?", options: ["Béla Tarr", "Andrei Tarkovsky", "Theo Angelopoulos", "Terrence Malick"], answer: "Béla Tarr", cat: "director", detail: "Tarr's final film" },
  { q: "Who directed Taste of Cherry?", options: ["Abbas Kiarostami", "Asghar Farhadi", "Jafar Panahi", "Mohsen Makhmalbaf"], answer: "Abbas Kiarostami", cat: "director", detail: "Won the Palme d'Or in 1997" },
  { q: "Who directed A Separation?", options: ["Asghar Farhadi", "Abbas Kiarostami", "Jafar Panahi", "Majid Majidi"], answer: "Asghar Farhadi", cat: "director", detail: "Won Best Foreign Language Film Oscar" },
  { q: "Who directed Y Tu Mamá También?", options: ["Alfonso Cuarón", "Alejandro González Iñárritu", "Guillermo del Toro", "Carlos Reygadas"], answer: "Alfonso Cuarón", cat: "director", detail: "Cuarón's 2001 Mexican road film" },
  { q: "Who directed The Seventh Seal?", options: ["Ingmar Bergman", "Carl Theodor Dreyer", "Andrei Tarkovsky", "Federico Fellini"], answer: "Ingmar Bergman", cat: "director", detail: "Death plays chess" },
  { q: "Who played the lead in The Master?", options: ["Joaquin Phoenix", "Philip Seymour Hoffman", "Daniel Day-Lewis", "Christian Bale"], answer: "Joaquin Phoenix", cat: "cast", detail: "Phoenix and Hoffman both deserved Oscars" },
  { q: "Who played Llewyn Davis in Inside Llewyn Davis?", options: ["Oscar Isaac", "Adam Driver", "Jake Gyllenhaal", "Casey Affleck"], answer: "Oscar Isaac", cat: "cast", detail: "Isaac's breakout role for the Coen Brothers" },
  { q: "Who played the lead in Under the Skin?", options: ["Scarlett Johansson", "Tilda Swinton", "Natalie Portman", "Saoirse Ronan"], answer: "Scarlett Johansson", cat: "cast", detail: "Johansson as a predatory alien" },
  { q: "Who played the lead in The Lighthouse?", options: ["Robert Pattinson & Willem Dafoe", "Joaquin Phoenix & Josh Brolin", "Adam Driver & John David Washington", "Timothée Chalamet & Oscar Isaac"], answer: "Robert Pattinson & Willem Dafoe", cat: "cast", detail: "Eggers' black-and-white descent into madness" },
  { q: "Who played Furiosa in Mad Max: Fury Road?", options: ["Charlize Theron", "Cate Blanchett", "Emily Blunt", "Brie Larson"], answer: "Charlize Theron", cat: "cast", detail: "Theron shaved her head for the role" },
  { q: "Which film features the line \"I'm not here to make friends\"?", options: ["None — it's a reality TV cliché", "Wall Street", "The Devil Wears Prada", "Glengarry Glen Ross"], answer: "None — it's a reality TV cliché", cat: "quote", detail: "Commonly misattributed to films" },
  { q: "\"We're not in infinite, we're in a Honda Civic.\"", options: ["Good Will Hunting", "Clerks", "Dazed and Confused", "Superbad"], answer: "Good Will Hunting", cat: "quote", detail: "Ben Affleck's character" },
  { q: "\"Is it better to be feared or respected? I say, is it too much to ask for both?\"", options: ["Iron Man", "The Godfather", "Scarface", "Wall Street"], answer: "Iron Man", cat: "quote", detail: "Tony Stark's arms demo" },
  { q: "What year was Mulholland Drive released?", options: ["2001", "1999", "2003", "2000"], answer: "2001", cat: "year", detail: "Lynch's Hollywood nightmare" },
  { q: "What year was City of God released?", options: ["2002", "2003", "2001", "2004"], answer: "2002", cat: "year", detail: "Fernando Meirelles' Brazilian masterpiece" },
  { q: "What year was The Tree of Life released?", options: ["2011", "2010", "2012", "2009"], answer: "2011", cat: "year", detail: "Malick's Palme d'Or winner" },
  { q: "What year was Oldboy (Park Chan-wook) released?", options: ["2003", "2004", "2002", "2005"], answer: "2003", cat: "year", detail: "Grand Prix at Cannes" },
  { q: "What year was Spirited Away released?", options: ["2001", "2002", "2000", "2003"], answer: "2001", cat: "year", detail: "Won the Academy Award for Best Animated Feature" },
  { q: "What year was Roma released?", options: ["2018", "2017", "2019", "2016"], answer: "2018", cat: "year", detail: "Cuarón's black-and-white memoir" },
  { q: "Which film won the first Palme d'Or at Cannes?", options: ["Marty", "Othello", "The Third Man", "La Dolce Vita"], answer: "Marty", cat: "oscar", detail: "Also won Best Picture Oscar that year" },
  { q: "Who won Best Director for Roma?", options: ["Alfonso Cuarón", "Spike Lee", "Yorgos Lanthimos", "Adam McKay"], answer: "Alfonso Cuarón", cat: "oscar", detail: "Cuarón also served as cinematographer" },
  { q: "Which film won the Golden Bear at Berlin in 2024?", options: ["Dahomey", "The Zone of Interest", "Fallen Leaves", "Anatomy of a Fall"], answer: "Dahomey", cat: "oscar", detail: "Mati Diop's documentary" },
  { q: "Who composed the score for Phantom Thread?", options: ["Jonny Greenwood", "Hans Zimmer", "Alexandre Desplat", "Trent Reznor"], answer: "Jonny Greenwood", cat: "soundtrack", detail: "Radiohead guitarist turned film composer" },
  { q: "Who composed the score for The Grand Budapest Hotel?", options: ["Alexandre Desplat", "Wes Anderson", "Mark Mothersbaugh", "Randall Poster"], answer: "Alexandre Desplat", cat: "soundtrack", detail: "Won Best Original Score" },
  { q: "Who composed the iconic shower scene music in Psycho?", options: ["Bernard Herrmann", "John Williams", "Alfred Newman", "Max Steiner"], answer: "Bernard Herrmann", cat: "soundtrack", detail: "Hitchcock originally wanted the scene silent" },
  { q: "Which film's soundtrack features the song \"Girl, You'll Be a Woman Soon\"?", options: ["Pulp Fiction", "Reservoir Dogs", "Natural Born Killers", "True Romance"], answer: "Pulp Fiction", cat: "soundtrack", detail: "Urge Overkill's cover of the Neil Diamond song" },
  { q: "What was the first foreign-language film to be nominated for Best Picture?", options: ["Grand Illusion", "Z", "Life Is Beautiful", "Crouching Tiger, Hidden Dragon"], answer: "Grand Illusion", cat: "oscar", detail: "Jean Renoir's 1938 anti-war film, nominated in 1939" },
  { q: "Which film had the biggest opening weekend but didn't reach $1 billion worldwide?", options: ["Avengers: Age of Ultron", "Harry Potter and the Deathly Hallows Part 2", "Spider-Man: No Way Home", "The Lion King (2019)"], answer: "Avengers: Age of Ultron", cat: "boxoffice", detail: "Massive opening, slowed down quickly" },
  { q: "What was the highest-grossing non-English language film before Parasite?", options: ["Crouching Tiger, Hidden Dragon", "Life Is Beautiful", "Amelie", "Hero"], answer: "Crouching Tiger, Hidden Dragon", cat: "boxoffice", detail: "Over $213 million worldwide" },
  { q: "Which Wes Anderson film was his first to be nominated for Best Picture?", options: ["The Grand Budapest Hotel", "Moonrise Kingdom", "The Royal Tenenbaums", "The French Dispatch"], answer: "The Grand Budapest Hotel", cat: "oscar", detail: "9 nominations in 2015" },
  { q: "The corridor fight in Oldboy was filmed in how many takes?", options: ["One continuous take (after 17 attempts)", "3 takes", "One take (first attempt)", "12 takes stitched together"], answer: "One continuous take (after 17 attempts)", cat: "bts", detail: "A 3-minute unbroken side-scrolling shot" },
  { q: "Which director refused their Best Director Oscar?", options: ["George C. Scott's was for Acting — no director has refused", "John Ford", "David Lean", "Francis Ford Coppola"], answer: "George C. Scott's was for Acting — no director has refused", cat: "oscar", detail: "Scott refused Best Actor for Patton in 1971" },
  { q: "Who shot the cinematography for Birdman in what appears to be one continuous take?", options: ["Emmanuel Lubezki", "Roger Deakins", "Robert Richardson", "Janusz Kamiński"], answer: "Emmanuel Lubezki", cat: "bts", detail: "Lubezki won three consecutive Oscars" },
  { q: "What Stanley Kubrick film was banned in the UK for 27 years?", options: ["A Clockwork Orange", "Eyes Wide Shut", "Lolita", "Full Metal Jacket"], answer: "A Clockwork Orange", cat: "bts", detail: "Kubrick himself requested the ban after death threats" },
  { q: "Which cinematographer has the most Oscar wins?", options: ["Emmanuel Lubezki (3)", "Roger Deakins (2)", "Vittorio Storaro (3)", "Robert Richardson (3)"], answer: "Emmanuel Lubezki (3)", cat: "bts", detail: "Gravity, Birdman, The Revenant — three in a row" },
  { q: "Who directed Uncle Boonmee Who Can Recall His Past Lives?", options: ["Apichatpong Weerasethakul", "Wong Kar-wai", "Tsai Ming-liang", "Hou Hsiao-hsien"], answer: "Apichatpong Weerasethakul", cat: "director", detail: "Won the Palme d'Or in 2010" },
  { q: "Who directed Sátántangó?", options: ["Béla Tarr", "Andrei Tarkovsky", "Miklós Jancsó", "Krzysztof Kieślowski"], answer: "Béla Tarr", cat: "director", detail: "A 7-hour Hungarian masterpiece" },
  { q: "Who directed Celine and Julie Go Boating?", options: ["Jacques Rivette", "Jean-Luc Godard", "Éric Rohmer", "François Truffaut"], answer: "Jacques Rivette", cat: "director", detail: "Rivette's playful 1974 French New Wave film" },
  { q: "Who directed Close-Up (1990)?", options: ["Abbas Kiarostami", "Mohsen Makhmalbaf", "Asghar Farhadi", "Jafar Panahi"], answer: "Abbas Kiarostami", cat: "director", detail: "A docufiction about a real impersonation trial" },
  { q: "Who directed Jeanne Dielman, 23 Quai du Commerce, 1080 Bruxelles?", options: ["Chantal Akerman", "Agnès Varda", "Claire Denis", "Céline Sciamma"], answer: "Chantal Akerman", cat: "director", detail: "Voted best film ever in 2022 Sight & Sound poll" },
  { q: "Who directed An Elephant Sitting Still?", options: ["Hu Bo", "Jia Zhangke", "Bi Gan", "Wang Bing"], answer: "Hu Bo", cat: "director", detail: "Hu Bo's only film before his tragic death" },
  { q: "Who directed The Act of Killing?", options: ["Joshua Oppenheimer", "Werner Herzog", "Errol Morris", "Frederick Wiseman"], answer: "Joshua Oppenheimer", cat: "director", detail: "Indonesian killers reenact their murders" },
  { q: "Who directed Happy Together (1997)?", options: ["Wong Kar-wai", "Ang Lee", "Tsai Ming-liang", "Edward Yang"], answer: "Wong Kar-wai", cat: "director", detail: "Kar-wai won Best Director at Cannes" },
  { q: "Who directed Certified Copy?", options: ["Abbas Kiarostami", "Asghar Farhadi", "Nuri Bilge Ceylan", "Andrei Zvyagintsev"], answer: "Abbas Kiarostami", cat: "director", detail: "Kiarostami's first film outside Iran" },
  { q: "Who played the lead in The Diving Bell and the Butterfly?", options: ["Mathieu Amalric", "Jean-Louis Trintignant", "Daniel Auteuil", "Vincent Cassel"], answer: "Mathieu Amalric", cat: "cast", detail: "Communicated only by blinking one eye" },
  { q: "Who played the lead in Ida (2013)?", options: ["Agata Trzebuchowska", "Agata Kulesza", "Joanna Kulig", "Juliette Binoche"], answer: "Agata Trzebuchowska", cat: "cast", detail: "A nun discovers her Jewish heritage" },
  { q: "Who played the lead in Son of Saul?", options: ["Géza Röhrig", "László Nemes", "Levente Molnár", "Marcelo Mastroianni"], answer: "Géza Röhrig", cat: "cast", detail: "Hungarian poet's film debut" },
  { q: "Who played the father in The White Ribbon?", options: ["No single lead — ensemble cast", "Michael Haneke", "Ulrich Tukur", "Christian Friedel"], answer: "No single lead — ensemble cast", cat: "cast", detail: "Haneke's pre-WWI German village drama" },
  { q: "\"What's the most you ever lost on a coin toss?\"", options: ["No Country for Old Men", "The Dark Knight", "Casino", "Unforgiven"], answer: "No Country for Old Men", cat: "quote", detail: "Chigurh's terrifying gas station scene" },
  { q: "\"Every passing minute is another chance to turn it all around.\"", options: ["Vanilla Sky", "Eternal Sunshine of the Spotless Mind", "Memento", "Inception"], answer: "Vanilla Sky", cat: "quote", detail: "Cameron Crowe's 2001 thriller" },
  { q: "What year was Yi Yi released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Edward Yang's final masterpiece" },
  { q: "What year was Caché released?", options: ["2005", "2004", "2006", "2003"], answer: "2005", cat: "year", detail: "Haneke's surveillance thriller" },
  { q: "What year was The White Ribbon released?", options: ["2009", "2008", "2010", "2007"], answer: "2009", cat: "year", detail: "Won the Palme d'Or" },
  { q: "What year was 4 Months, 3 Weeks and 2 Days released?", options: ["2007", "2008", "2006", "2009"], answer: "2007", cat: "year", detail: "Cristian Mungiu's Palme d'Or winner" },
  { q: "What year was Goodbye to Language released?", options: ["2014", "2013", "2015", "2012"], answer: "2014", cat: "year", detail: "Godard's 3D experiment at age 83" },
  { q: "What year was The Handmaiden released?", options: ["2016", "2017", "2015", "2018"], answer: "2016", cat: "year", detail: "Park Chan-wook's erotic thriller" },
  { q: "Which film won the Palme d'Or in 2022?", options: ["Triangle of Sadness", "Decision to Leave", "Close", "Broker"], answer: "Triangle of Sadness", cat: "oscar", detail: "Ruben Östlund's class satire" },
  { q: "Which film won the Palme d'Or in 2023?", options: ["Anatomy of a Fall", "The Zone of Interest", "Monster", "May December"], answer: "Anatomy of a Fall", cat: "oscar", detail: "Justine Triet's courtroom drama" },
  { q: "Who won Best International Feature Film for A Separation?", options: ["Iran (Asghar Farhadi)", "South Korea (Bong Joon-ho)", "Japan (Hirokazu Kore-eda)", "Mexico (Alfonso Cuarón)"], answer: "Iran (Asghar Farhadi)", cat: "oscar", detail: "Iran's first Oscar win" },
  { q: "Who composed the score for Under the Skin?", options: ["Mica Levi", "Jonny Greenwood", "Trent Reznor", "Cliff Martinez"], answer: "Mica Levi", cat: "soundtrack", detail: "Unsettling avant-garde strings" },
  { q: "Who composed the score for There Will Be Blood?", options: ["Jonny Greenwood", "Hans Zimmer", "Alexandre Desplat", "Trent Reznor"], answer: "Jonny Greenwood", cat: "soundtrack", detail: "Greenwood's first film score" },
  { q: "Who composed the score for The Social Network?", options: ["Trent Reznor & Atticus Ross", "Hans Zimmer", "Jonny Greenwood", "Cliff Martinez"], answer: "Trent Reznor & Atticus Ross", cat: "soundtrack", detail: "Won Best Original Score" },
  { q: "Which film's soundtrack features Nusrat Fateh Ali Khan's vocals?", options: ["Dead Man Walking", "The Last Temptation of Christ", "Natural Born Killers", "Heat"], answer: "Dead Man Walking", cat: "soundtrack", detail: "Pakistani qawwali master in a Tim Robbins film" },
  { q: "What was the first animated film to earn more than $1 billion outside the US?", options: ["Frozen", "Toy Story 3", "Finding Dory", "The Lion King (2019)"], answer: "Frozen", cat: "boxoffice", detail: "Massive international success especially in Japan" },
  { q: "Which art-house director also makes commercials for luxury brands?", options: ["Wong Kar-wai", "Terrence Malick", "David Lynch", "Andrei Tarkovsky"], answer: "Wong Kar-wai", cat: "bts", detail: "Made ads for BMW, Chanel, and Lancôme" },
  { q: "Which film used a real bear attack in its production?", options: ["Grizzly Man (footage)", "The Revenant", "The Edge", "Backcountry"], answer: "Grizzly Man (footage)", cat: "bts", detail: "Werner Herzog's documentary about Timothy Treadwell" },
  { q: "How long is Béla Tarr's Sátántangó?", options: ["7 hours 12 minutes", "4 hours 30 minutes", "5 hours 45 minutes", "9 hours"], answer: "7 hours 12 minutes", cat: "bts", detail: "One of the longest narrative films" },
  { q: "Which film was entirely shot in one take (no hidden cuts)?", options: ["Russian Ark", "Birdman", "1917", "Rope"], answer: "Russian Ark", cat: "bts", detail: "Alexander Sokurov's 2002 single-take film through the Hermitage" },
  { q: "Who shot the cinematography for The Tree of Life?", options: ["Emmanuel Lubezki", "Roger Deakins", "Robert Richardson", "Vittorio Storaro"], answer: "Emmanuel Lubezki", cat: "bts", detail: "Natural light photography" },
  { q: "Which director shot a film in secret while under house arrest?", options: ["Jafar Panahi", "Abbas Kiarostami", "Mohsen Makhmalbaf", "Asghar Farhadi"], answer: "Jafar Panahi", cat: "bts", detail: "This Is Not a Film (2011), smuggled out on a USB drive in a cake" },
  { q: "Who directed The Mirror (1975)?", options: ["Andrei Tarkovsky", "Ingmar Bergman", "Krzysztof Kieślowski", "Carl Theodor Dreyer"], answer: "Andrei Tarkovsky", cat: "director", detail: "Tarkovsky's autobiographical poem-film" },
  { q: "Who directed Werckmeister Harmonies?", options: ["Béla Tarr", "Andrei Tarkovsky", "Miklós Jancsó", "Aleksandr Sokurov"], answer: "Béla Tarr", cat: "director", detail: "Only 39 shots in the entire film" },
  { q: "Who directed Tropical Malady?", options: ["Apichatpong Weerasethakul", "Tsai Ming-liang", "Lav Diaz", "Brillante Mendoza"], answer: "Apichatpong Weerasethakul", cat: "director", detail: "Won Jury Prize at Cannes 2004" },
  { q: "Who directed The Conformist?", options: ["Bernardo Bertolucci", "Luchino Visconti", "Federico Fellini", "Pier Paolo Pasolini"], answer: "Bernardo Bertolucci", cat: "director", detail: "Bertolucci's 1970 fascism study" },
  { q: "Who directed Sans Soleil?", options: ["Chris Marker", "Alain Resnais", "Jean-Luc Godard", "Agnès Varda"], answer: "Chris Marker", cat: "director", detail: "Marker's 1983 essay film" },
  { q: "Who directed Vivre Sa Vie?", options: ["Jean-Luc Godard", "François Truffaut", "Jacques Rivette", "Éric Rohmer"], answer: "Jean-Luc Godard", cat: "director", detail: "Godard's 1962 portrait of a Parisian prostitute" },
  { q: "Who directed Blue Is the Warmest Colour?", options: ["Abdellatif Kechiche", "Jacques Audiard", "Céline Sciamma", "Claire Denis"], answer: "Abdellatif Kechiche", cat: "director", detail: "Won the Palme d'Or in 2013" },
  { q: "Who directed Shoplifters?", options: ["Hirokazu Kore-eda", "Naomi Kawase", "Ryusuke Hamaguchi", "Hayao Miyazaki"], answer: "Hirokazu Kore-eda", cat: "director", detail: "Won the Palme d'Or in 2018" },
  { q: "Who directed Drive My Car?", options: ["Ryusuke Hamaguchi", "Hirokazu Kore-eda", "Naomi Kawase", "Makoto Shinkai"], answer: "Ryusuke Hamaguchi", cat: "director", detail: "Won Best International Feature Film Oscar" },
  { q: "Who played the lead in Tokyo Story?", options: ["Chishū Ryū", "Toshiro Mifune", "Takashi Shimura", "Tatsuya Nakadai"], answer: "Chishū Ryū", cat: "cast", detail: "Ozu's regular leading man" },
  { q: "Who played the lead in Wild Strawberries?", options: ["Victor Sjöström", "Max von Sydow", "Gunnar Björnstrand", "Erland Josephson"], answer: "Victor Sjöström", cat: "cast", detail: "Silent film director turned actor for Bergman" },
  { q: "Who played the lead in The 400 Blows?", options: ["Jean-Pierre Léaud", "Jean-Paul Belmondo", "Alain Delon", "Gérard Depardieu"], answer: "Jean-Pierre Léaud", cat: "cast", detail: "Léaud was 14 years old" },
  { q: "Who played the lead in Breathless (1960)?", options: ["Jean-Paul Belmondo", "Alain Delon", "Jean-Pierre Léaud", "Marcello Mastroianni"], answer: "Jean-Paul Belmondo", cat: "cast", detail: "Godard's French New Wave landmark" },
  { q: "\"Last year at Marienbad\" — who directed it?", options: ["Alain Resnais", "Jean-Luc Godard", "Chris Marker", "Jacques Rivette"], answer: "Alain Resnais", cat: "director", detail: "Resnais' enigmatic 1961 puzzle film" },
  { q: "What year was Rashomon released?", options: ["1950", "1951", "1949", "1952"], answer: "1950", cat: "year", detail: "Kurosawa introduced Japanese cinema to the West" },
  { q: "What year was The 400 Blows released?", options: ["1959", "1960", "1958", "1961"], answer: "1959", cat: "year", detail: "The birth of the French New Wave" },
  { q: "What year was 2001: A Space Odyssey released?", options: ["1968", "1969", "1967", "1970"], answer: "1968", cat: "year", detail: "Kubrick's sci-fi masterpiece" },
  { q: "What year was Breathless released?", options: ["1960", "1959", "1961", "1962"], answer: "1960", cat: "year", detail: "Godard's debut feature" },
  { q: "What year was 8½ released?", options: ["1963", "1962", "1964", "1961"], answer: "1963", cat: "year", detail: "Fellini's meta-masterpiece" },
  { q: "What year was Solaris (Tarkovsky) released?", options: ["1972", "1971", "1973", "1974"], answer: "1972", cat: "year", detail: "The Soviet response to 2001" },
  { q: "What year was Blue Velvet released?", options: ["1986", "1987", "1985", "1988"], answer: "1986", cat: "year", detail: "Lynch's suburban nightmare" },
  { q: "What year was Chungking Express released?", options: ["1994", "1995", "1993", "1996"], answer: "1994", cat: "year", detail: "Wong Kar-wai shot it in 23 days" },
  { q: "Which film won the first Golden Lion at Venice?", options: ["No award given at the first festival", "Poil de Carotte", "À Nous la Liberté", "Grand Hotel"], answer: "No award given at the first festival", cat: "oscar", detail: "Venice 1932 gave Mussolini Cup, not Golden Lion" },
  { q: "Who composed the score for Mulholland Drive?", options: ["Angelo Badalamenti", "Jonny Greenwood", "Trent Reznor", "Cliff Martinez"], answer: "Angelo Badalamenti", cat: "soundtrack", detail: "Lynch's regular collaborator" },
  { q: "Who composed the score for Drive (2011)?", options: ["Cliff Martinez", "Nicolas Winding Refn", "Johnny Jewel", "Kavinsky"], answer: "Cliff Martinez", cat: "soundtrack", detail: "Synth-heavy neo-noir score" },
  { q: "Who composed the score for Spirited Away?", options: ["Joe Hisaishi", "Ryuichi Sakamoto", "Yoko Kanno", "Toru Takemitsu"], answer: "Joe Hisaishi", cat: "soundtrack", detail: "Miyazaki's longtime collaborator" },
  { q: "Who composed the score for The Thin Red Line?", options: ["Hans Zimmer", "John Williams", "James Horner", "Thomas Newman"], answer: "Hans Zimmer", cat: "soundtrack", detail: "Malick's WWII meditation" },
  { q: "Which film was shot in 15 takes over 12 minutes each?", options: ["Rope (Alfred Hitchcock)", "Russian Ark", "Birdman", "Victoria"], answer: "Rope (Alfred Hitchcock)", cat: "bts", detail: "Hitchcock hid the cuts in camera movements" },
  { q: "Which cinematographer won for 1917?", options: ["Roger Deakins", "Emmanuel Lubezki", "Hoyte van Hoytema", "Robert Richardson"], answer: "Roger Deakins", cat: "bts", detail: "Deakins' second Oscar" },
  { q: "What was the first film to use the Steadicam?", options: ["Bound for Glory (1976)", "Rocky", "The Shining", "Halloween"], answer: "Bound for Glory (1976)", cat: "bts", detail: "Invented by Garrett Brown" },
  { q: "Which director's films total runtime exceeds 72 hours?", options: ["Lav Diaz", "Béla Tarr", "Jacques Rivette", "Andy Warhol"], answer: "Lav Diaz", cat: "bts", detail: "Filipino director known for 4-10 hour films" },
  { q: "What film technique did Orson Welles pioneer in Citizen Kane?", options: ["Deep focus cinematography", "Handheld camera", "Jump cuts", "Slow motion"], answer: "Deep focus cinematography", cat: "bts", detail: "Gregg Toland's revolutionary camerawork" },
  { q: "Which country has won the most Palme d'Or awards?", options: ["United States", "France", "Italy", "Japan"], answer: "United States", cat: "oscar", detail: "Though France is close behind" },
  { q: "What was the first non-English film to win Best Picture?", options: ["Parasite", "The Artist", "Amour", "Roma"], answer: "Parasite", cat: "oscar", detail: "Bong Joon-ho's 2020 historic win" },
  { q: "Who directed Syndromes and a Century?", options: ["Apichatpong Weerasethakul", "Tsai Ming-liang", "Lav Diaz", "Hong Sang-soo"], answer: "Apichatpong Weerasethakul", cat: "director", detail: "Thai filmmaker's memory-loop film" },
  { q: "Who directed Landscape in the Mist?", options: ["Theo Angelopoulos", "Nuri Bilge Ceylan", "Andrei Tarkovsky", "Béla Tarr"], answer: "Theo Angelopoulos", cat: "director", detail: "Greek master's children's odyssey" },
  { q: "Who directed L'Avventura?", options: ["Michelangelo Antonioni", "Federico Fellini", "Luchino Visconti", "Roberto Rossellini"], answer: "Michelangelo Antonioni", cat: "director", detail: "Booed at Cannes, now considered a masterpiece" },
  { q: "Who directed The Colour of Pomegranates?", options: ["Sergei Parajanov", "Andrei Tarkovsky", "Aleksandr Sokurov", "Elem Klimov"], answer: "Sergei Parajanov", cat: "director", detail: "Armenian visual poetry" },
  { q: "Who directed Pather Panchali?", options: ["Satyajit Ray", "Ritwik Ghatak", "Mrinal Sen", "Shyam Benegal"], answer: "Satyajit Ray", cat: "director", detail: "The first film of the Apu Trilogy" },
  { q: "Who directed Wanda (1970)?", options: ["Barbara Loden", "Chantal Akerman", "Agnès Varda", "Elaine May"], answer: "Barbara Loden", cat: "director", detail: "Loden's only film as director" },
  { q: "Who directed Touki Bouki?", options: ["Djibril Diop Mambéty", "Ousmane Sembène", "Med Hondo", "Abderrahmane Sissako"], answer: "Djibril Diop Mambéty", cat: "director", detail: "Senegalese New Wave masterpiece from 1973" },
  { q: "Who played the lead in Au Hasard Balthazar?", options: ["A donkey (no human lead)", "Anna Karina", "Anne Wiazemsky", "Nathalie Baye"], answer: "A donkey (no human lead)", cat: "cast", detail: "Robert Bresson's 1966 film about a donkey's life" },
  { q: "Who played the lead in L'Atalante?", options: ["Jean Dasté", "Michel Simon", "Jean Vigo", "Jean Gabin"], answer: "Jean Dasté", cat: "cast", detail: "Jean Vigo's 1934 masterpiece" },
  { q: "What year was Bicycle Thieves released?", options: ["1948", "1949", "1947", "1950"], answer: "1948", cat: "year", detail: "De Sica's Italian neorealist classic" },
  { q: "What year was Tokyo Story released?", options: ["1953", "1952", "1954", "1951"], answer: "1953", cat: "year", detail: "Ozu's family masterpiece" },
  { q: "What year was Seven Samurai released?", options: ["1954", "1953", "1955", "1952"], answer: "1954", cat: "year", detail: "Kurosawa's epic action film" },
  { q: "What year was Vertigo released?", options: ["1958", "1959", "1957", "1960"], answer: "1958", cat: "year", detail: "Hitchcock's obsession masterpiece" },
  { q: "What year was Persona released?", options: ["1966", "1967", "1965", "1968"], answer: "1966", cat: "year", detail: "Bergman's identity crisis" },
  { q: "What year was Aguirre, the Wrath of God released?", options: ["1972", "1973", "1971", "1974"], answer: "1972", cat: "year", detail: "Herzog and Kinski's first collaboration" },
  { q: "What year was Wings of Desire released?", options: ["1987", "1988", "1986", "1989"], answer: "1987", cat: "year", detail: "Wim Wenders' Berlin angels" },
  { q: "Who composed the scores for most of Fellini's films?", options: ["Nino Rota", "Ennio Morricone", "Carlo Rustichelli", "Piero Piccioni"], answer: "Nino Rota", cat: "soundtrack", detail: "Also composed The Godfather theme" },
  { q: "Who composed the score for Nostalghia?", options: ["No original score — uses Beethoven and Verdi", "Alfred Schnittke", "Arvo Pärt", "Toru Takemitsu"], answer: "No original score — uses Beethoven and Verdi", cat: "soundtrack", detail: "Tarkovsky preferred existing classical music" },
  { q: "Which film pioneered the use of deep focus photography?", options: ["Citizen Kane", "Casablanca", "The Rules of the Game", "Stagecoach"], answer: "Citizen Kane", cat: "bts", detail: "Gregg Toland's revolutionary camerawork" },
  { q: "How many films did Andrei Tarkovsky direct in his career?", options: ["7", "5", "9", "12"], answer: "7", cat: "bts", detail: "Ivan's Childhood through The Sacrifice" },
  { q: "Which film was shot entirely using a phone hidden in a bread tin?", options: ["This Is Not a Film (Jafar Panahi)", "Tangerine", "Unsane", "High Flying Bird"], answer: "This Is Not a Film (Jafar Panahi)", cat: "bts", detail: "Smuggled out of Iran on a USB in a cake" },
  { q: "Who coined the term 'auteur theory'?", options: ["Andrew Sarris (popularized in English)", "François Truffaut", "André Bazin", "Jean-Luc Godard"], answer: "Andrew Sarris (popularized in English)", cat: "bts", detail: "Based on Truffaut and Bazin's French writings" },
  { q: "Who directed The Spirit of the Beehive?", options: ["Víctor Erice", "Carlos Saura", "Luis Buñuel", "Pedro Almodóvar"], answer: "Víctor Erice", cat: "director", detail: "Erice's 1973 Spanish masterpiece" },
  { q: "Who directed Cleo from 5 to 7?", options: ["Agnès Varda", "Chantal Akerman", "Claire Denis", "Catherine Breillat"], answer: "Agnès Varda", cat: "director", detail: "Varda's 1962 French New Wave film" },
  { q: "Who directed World on a Wire?", options: ["Rainer Werner Fassbinder", "Werner Herzog", "Wim Wenders", "Volker Schlöndorff"], answer: "Rainer Werner Fassbinder", cat: "director", detail: "Fassbinder's 1973 proto-Matrix sci-fi" },
  { q: "Who directed Ran?", options: ["Akira Kurosawa", "Yasujirō Ozu", "Kenji Mizoguchi", "Masaki Kobayashi"], answer: "Akira Kurosawa", cat: "director", detail: "Kurosawa's King Lear adaptation" },
  { q: "Who directed Spring in a Small Town (1948)?", options: ["Fei Mu", "Zhang Yimou", "Chen Kaige", "King Hu"], answer: "Fei Mu", cat: "director", detail: "Often called the greatest Chinese film" },
  { q: "Who directed Come and See?", options: ["Elem Klimov", "Andrei Tarkovsky", "Sergei Parajanov", "Larisa Shepitko"], answer: "Elem Klimov", cat: "director", detail: "The most harrowing war film ever made" },
  { q: "Who directed Ashes and Diamonds?", options: ["Andrzej Wajda", "Krzysztof Kieślowski", "Roman Polanski", "Jerzy Skolimowski"], answer: "Andrzej Wajda", cat: "director", detail: "Polish cinema's defining post-war film" },
  { q: "Who directed Late Spring?", options: ["Yasujirō Ozu", "Akira Kurosawa", "Kenji Mizoguchi", "Mikio Naruse"], answer: "Yasujirō Ozu", cat: "director", detail: "Ozu's 1949 father-daughter masterpiece" },
  { q: "Who played the lead in Contempt (1963)?", options: ["Brigitte Bardot", "Anna Karina", "Catherine Deneuve", "Jeanne Moreau"], answer: "Brigitte Bardot", cat: "cast", detail: "Godard's film about filmmaking" },
  { q: "Who played Death in The Seventh Seal?", options: ["Bengt Ekerot", "Max von Sydow", "Gunnar Björnstrand", "Bibi Andersson"], answer: "Bengt Ekerot", cat: "cast", detail: "Cinema's most iconic chess game" },
  { q: "Who played the lead in Ikiru?", options: ["Takashi Shimura", "Toshiro Mifune", "Tatsuya Nakadai", "Chishū Ryū"], answer: "Takashi Shimura", cat: "cast", detail: "Kurosawa's 1952 meditation on mortality" },
  { q: "What year was Citizen Kane released?", options: ["1941", "1940", "1942", "1939"], answer: "1941", cat: "year", detail: "Welles was 25 years old" },
  { q: "What year was The Rules of the Game released?", options: ["1939", "1940", "1938", "1941"], answer: "1939", cat: "year", detail: "Renoir's satire of French society" },
  { q: "What year was Sunrise: A Song of Two Humans released?", options: ["1927", "1928", "1926", "1929"], answer: "1927", cat: "year", detail: "Murnau's silent masterpiece" },
  { q: "What year was Metropolis released?", options: ["1927", "1926", "1928", "1925"], answer: "1927", cat: "year", detail: "Fritz Lang's dystopian vision" },
  { q: "What year was Late Spring released?", options: ["1949", "1950", "1948", "1951"], answer: "1949", cat: "year", detail: "Ozu's quiet masterpiece" },
  { q: "What year was Stalker released?", options: ["1979", "1980", "1978", "1981"], answer: "1979", cat: "year", detail: "Tarkovsky's Zone odyssey" },
  { q: "Who composed the score for Ran?", options: ["Toru Takemitsu", "Joe Hisaishi", "Ryuichi Sakamoto", "Fumio Hayasaka"], answer: "Toru Takemitsu", cat: "soundtrack", detail: "Takemitsu used Mahler and traditional Japanese music" },
  { q: "Who composed the score for most of Ozu's later films?", options: ["No composer — Ozu used no music in late films", "Toru Takemitsu", "Fumio Hayasaka", "Akira Ifukube"], answer: "No composer — Ozu used no music in late films", cat: "soundtrack", detail: "Ozu increasingly stripped away non-diegetic sound" },
  { q: "Which Sight & Sound poll voted Jeanne Dielman as greatest film?", options: ["2022", "2012", "2002", "1992"], answer: "2022", cat: "oscar", detail: "Dethroning Vertigo and Citizen Kane" },
  { q: "Which film won the first Palme d'Or under that name?", options: ["Othello (1952)", "Marty (1955)", "The Third Man (1949)", "Wages of Fear (1953)"], answer: "Othello (1952)", cat: "oscar", detail: "Orson Welles' Shakespeare adaptation" },
  { q: "How many films did Yasujirō Ozu direct?", options: ["54", "35", "72", "23"], answer: "54", cat: "bts", detail: "Including many silent films" },
  { q: "Which filmmaker created the essay film genre?", options: ["Chris Marker", "Jean-Luc Godard", "Agnès Varda", "Alain Resnais"], answer: "Chris Marker", cat: "bts", detail: "Letter from Siberia (1957) coined the term" },
  { q: "What is Ozu's signature camera position?", options: ["Low angle (tatami shot)", "Bird's eye view", "Dutch angle", "Over-the-shoulder"], answer: "Low angle (tatami shot)", cat: "bts", detail: "Camera placed at the height of someone sitting on a tatami mat" },
  { q: "Who directed A Man Escaped?", options: ["Robert Bresson", "Jean-Pierre Melville", "Jacques Becker", "Henri-Georges Clouzot"], answer: "Robert Bresson", cat: "director", detail: "Bresson's 1956 prison escape masterpiece" },
  { q: "Who directed Pickpocket?", options: ["Robert Bresson", "Jean-Pierre Melville", "Jacques Becker", "Jean-Luc Godard"], answer: "Robert Bresson", cat: "director", detail: "Bresson's 1959 crime study" },
  { q: "Who directed The Passion of Joan of Arc?", options: ["Carl Theodor Dreyer", "Robert Bresson", "Ingmar Bergman", "F.W. Murnau"], answer: "Carl Theodor Dreyer", cat: "director", detail: "Dreyer's 1928 silent masterpiece" },
  { q: "Who directed Raise the Red Lantern?", options: ["Zhang Yimou", "Chen Kaige", "Ang Lee", "Wong Kar-wai"], answer: "Zhang Yimou", cat: "director", detail: "Zhang's 1991 visual masterpiece" },
  { q: "Who directed The Leopard?", options: ["Luchino Visconti", "Federico Fellini", "Michelangelo Antonioni", "Bernardo Bertolucci"], answer: "Luchino Visconti", cat: "director", detail: "Won the Palme d'Or in 1963" },
  { q: "Who directed Where Is the Friend's House?", options: ["Abbas Kiarostami", "Mohsen Makhmalbaf", "Asghar Farhadi", "Majid Majidi"], answer: "Abbas Kiarostami", cat: "director", detail: "Kiarostami's 1987 children's film" },
  { q: "Who directed Tokyo Drifter?", options: ["Seijun Suzuki", "Akira Kurosawa", "Yasujirō Ozu", "Kenji Mizoguchi"], answer: "Seijun Suzuki", cat: "director", detail: "Suzuki's psychedelic 1966 yakuza film" },
  { q: "Who directed Fitzcarraldo?", options: ["Werner Herzog", "Rainer Werner Fassbinder", "Wim Wenders", "Volker Schlöndorff"], answer: "Werner Herzog", cat: "director", detail: "Actually pulled a steamship over a mountain" },
  { q: "Who played the lead in Fitzcarraldo?", options: ["Klaus Kinski", "Bruno Ganz", "Max von Sydow", "Michael Lonsdale"], answer: "Klaus Kinski", cat: "cast", detail: "Herzog and Kinski's volatile collaboration" },
  { q: "Who played the lead in The Passion of Joan of Arc?", options: ["Maria Falconetti", "Lillian Gish", "Greta Garbo", "Louise Brooks"], answer: "Maria Falconetti", cat: "cast", detail: "Often called the greatest performance in cinema" },
  { q: "Who played the lead in Ugetsu?", options: ["Masayuki Mori", "Toshiro Mifune", "Takashi Shimura", "Tatsuya Nakadai"], answer: "Masayuki Mori", cat: "cast", detail: "Mizoguchi's 1953 ghost story" },
  { q: "\"I wanted to be a good wife and mother.\"", options: ["Jeanne Dielman", "The Piano Teacher", "A Woman Under the Influence", "Scenes from a Marriage"], answer: "Jeanne Dielman", cat: "quote", detail: "Akerman's domestic horror" },
  { q: "What year was The Passion of Joan of Arc released?", options: ["1928", "1927", "1929", "1930"], answer: "1928", cat: "year", detail: "Dreyer's silent masterpiece" },
  { q: "What year was L'Avventura released?", options: ["1960", "1961", "1959", "1962"], answer: "1960", cat: "year", detail: "Antonioni's mystery of absence" },
  { q: "What year was Pather Panchali released?", options: ["1955", "1956", "1954", "1957"], answer: "1955", cat: "year", detail: "Ray's debut, the start of the Apu Trilogy" },
  { q: "What year was Come and See released?", options: ["1985", "1984", "1986", "1983"], answer: "1985", cat: "year", detail: "Klimov's devastating war film" },
  { q: "What year was In the Mood for Love released?", options: ["2000", "2001", "1999", "2002"], answer: "2000", cat: "year", detail: "Wong Kar-wai's masterpiece of longing" },
  { q: "What year was Celine and Julie Go Boating released?", options: ["1974", "1975", "1973", "1976"], answer: "1974", cat: "year", detail: "Rivette's 3-hour playful fantasy" },
  { q: "Who composed the score for In the Mood for Love?", options: ["Michael Galasso & Shigeru Umebayashi", "Joe Hisaishi", "Ryuichi Sakamoto", "Toru Takemitsu"], answer: "Michael Galasso & Shigeru Umebayashi", cat: "soundtrack", detail: "The haunting waltz theme" },
  { q: "Who composed the music for Pather Panchali?", options: ["Ravi Shankar", "Ali Akbar Khan", "Vilayat Khan", "Zakir Hussain"], answer: "Ravi Shankar", cat: "soundtrack", detail: "Sitar maestro's first film score" },
  { q: "Which film was famously rejected at Cannes then became a classic?", options: ["L'Avventura", "Pulp Fiction", "Taxi Driver", "Blue Velvet"], answer: "L'Avventura", cat: "bts", detail: "Booed at its premiere, won the Jury Prize anyway" },
  { q: "How many films did Robert Bresson direct in his career?", options: ["13", "20", "8", "25"], answer: "13", cat: "bts", detail: "Each one meticulously crafted" },
  { q: "Which film used actual wartime footage mixed with new material?", options: ["Come and See", "Schindler's List", "Dunkirk", "1917"], answer: "Come and See", cat: "bts", detail: "Klimov used live ammunition near actors" },
  { q: "What technique is Bresson famous for requiring from actors?", options: ["Flat, emotionless delivery (models, not actors)", "Method acting", "Improvisation", "Whispering all lines"], answer: "Flat, emotionless delivery (models, not actors)", cat: "bts", detail: "He called his performers 'models'" },
  { q: "Who directed Meshes of the Afternoon?", options: ["Maya Deren", "Stan Brakhage", "Kenneth Anger", "Jonas Mekas"], answer: "Maya Deren", cat: "director", detail: "Deren's 1943 experimental short" },
  { q: "Who directed Playtime?", options: ["Jacques Tati", "Jean-Luc Godard", "Jacques Rivette", "Éric Rohmer"], answer: "Jacques Tati", cat: "director", detail: "Tati's 1967 modernist comedy" },
  { q: "Who directed The Discreet Charm of the Bourgeoisie?", options: ["Luis Buñuel", "Pedro Almodóvar", "Carlos Saura", "Víctor Erice"], answer: "Luis Buñuel", cat: "director", detail: "Won Best Foreign Film Oscar in 1973" },
  { q: "Who directed Fallen Angels (1995)?", options: ["Wong Kar-wai", "Tsai Ming-liang", "Hou Hsiao-hsien", "John Woo"], answer: "Wong Kar-wai", cat: "director", detail: "Originally part of Chungking Express" },
  { q: "Who directed Nostalghia?", options: ["Andrei Tarkovsky", "Sergei Parajanov", "Elem Klimov", "Aleksandr Sokurov"], answer: "Andrei Tarkovsky", cat: "director", detail: "Tarkovsky's first film made outside Russia" },
  { q: "Who directed Happy Hour (2015)?", options: ["Ryusuke Hamaguchi", "Hirokazu Kore-eda", "Hong Sang-soo", "Naomi Kawase"], answer: "Ryusuke Hamaguchi", cat: "director", detail: "A 5-hour film about four women in Kobe" },
  { q: "Who played the lead in Andrei Rublev?", options: ["Anatoly Solonitsyn", "Nikolai Burlyayev", "Donatas Banionis", "Oleg Yankovsky"], answer: "Anatoly Solonitsyn", cat: "cast", detail: "As the medieval icon painter" },
  { q: "Who played the lead in Stalker?", options: ["Aleksandr Kaidanovsky", "Anatoly Solonitsyn", "Nikolai Grinko", "Oleg Yankovsky"], answer: "Aleksandr Kaidanovsky", cat: "cast", detail: "Tarkovsky's Zone guide" },
  { q: "What year was Andrei Rublev released?", options: ["1966 (completed), 1969 (released)", "1972", "1964", "1975"], answer: "1966 (completed), 1969 (released)", cat: "year", detail: "Suppressed by Soviet authorities for 3 years" },
  { q: "What year was Nostalghia released?", options: ["1983", "1982", "1984", "1981"], answer: "1983", cat: "year", detail: "Tarkovsky's Italian exile" },
  { q: "What year was Playtime released?", options: ["1967", "1968", "1966", "1969"], answer: "1967", cat: "year", detail: "Nearly bankrupted Tati" },
  { q: "What year was The Colour of Pomegranates released?", options: ["1969", "1970", "1968", "1971"], answer: "1969", cat: "year", detail: "Parajanov's visual poetry" },
  { q: "What year was Meshes of the Afternoon released?", options: ["1943", "1944", "1942", "1945"], answer: "1943", cat: "year", detail: "American experimental cinema landmark" },
  { q: "What year was Pickpocket released?", options: ["1959", "1960", "1958", "1961"], answer: "1959", cat: "year", detail: "Bresson's dexterous crime film" },
  { q: "Who composed the score for Stalker?", options: ["Eduard Artemyev", "Alfred Schnittke", "Arvo Pärt", "Toru Takemitsu"], answer: "Eduard Artemyev", cat: "soundtrack", detail: "Electronic and orchestral blending" },
  { q: "Who composed the music for most of Wong Kar-wai's films?", options: ["Various artists — Kar-wai curates eclectic soundtracks", "Joe Hisaishi", "Ryuichi Sakamoto", "Ennio Morricone"], answer: "Various artists — Kar-wai curates eclectic soundtracks", cat: "soundtrack", detail: "From Xavier Cugat to The Cranberries" },
  { q: "What building did Jacques Tati construct for Playtime?", options: ["An entire fake city (Tativille)", "A replica of the Pompidou Centre", "A glass office tower", "A full-size airport terminal"], answer: "An entire fake city (Tativille)", cat: "bts", detail: "The cost nearly bankrupted him" },
  { q: "Which filmmaker was imprisoned for their art?", options: ["Sergei Parajanov", "Jafar Panahi", "Andrei Tarkovsky", "Both Parajanov and Panahi"], answer: "Both Parajanov and Panahi", cat: "bts", detail: "Parajanov served 4 years; Panahi was arrested in 2010" },
  { q: "How long is Lav Diaz's longest film?", options: ["11 hours (Evolution of a Filipino Family)", "8 hours", "14 hours", "6 hours"], answer: "11 hours (Evolution of a Filipino Family)", cat: "bts", detail: "Filmed over 10 years" },
  { q: "Who directed the original Solaris (1972)?", options: ["Andrei Tarkovsky", "Ingmar Bergman", "Federico Fellini", "Akira Kurosawa"], answer: "Andrei Tarkovsky", cat: "director", detail: "Soviet science fiction masterpiece" },
  { q: "Who directed A Separation (2011)?", options: ["Asghar Farhadi", "Abbas Kiarostami", "Majid Majidi", "Jafar Panahi"], answer: "Asghar Farhadi", cat: "director", detail: "Iranian film that won the Oscar" },
  { q: "Who directed Yi Yi (2000)?", options: ["Edward Yang", "Hou Hsiao-hsien", "Wong Kar-wai", "Tsai Ming-liang"], answer: "Edward Yang", cat: "director", detail: "Taiwanese masterpiece" },
  { q: "Who directed Jeanne Dielman?", options: ["Chantal Akerman", "Agnès Varda", "Claire Denis", "Marguerite Duras"], answer: "Chantal Akerman", cat: "director", detail: "Voted greatest film of all time in 2022 Sight & Sound poll" },
  { q: "Who directed Au Hasard Balthazar?", options: ["Robert Bresson", "Jean-Luc Godard", "François Truffaut", "Jacques Rivette"], answer: "Robert Bresson", cat: "director", detail: "Bresson's 1966 film about a donkey's life" },
  { q: "Who played Tadashi Hisamatsu in Tokyo Story?", options: ["Chishū Ryū", "Toshiro Mifune", "Takashi Shimura", "Masayuki Mori"], answer: "Chishū Ryū", cat: "cast", detail: "Ozu's favorite actor" },
  { q: "Who played the lead in Taste of Cherry?", options: ["Homayoun Ershadi", "Shahab Hosseini", "Behrouz Vossoughi", "Reza Kianian"], answer: "Homayoun Ershadi", cat: "cast", detail: "Kiarostami's 1997 Palme d'Or winner" },
  { q: "What film technique did Hitchcock use in Rope to simulate one take?", options: ["Hidden cuts behind actors' backs", "Fast camera movement", "Long lenses", "Split screen"], answer: "Hidden cuts behind actors' backs", cat: "bts", detail: "Each reel ran ~10 minutes" },
  { q: "Which film used NASA lenses originally built for moonlighting?", options: ["Barry Lyndon", "2001: A Space Odyssey", "Gravity", "Interstellar"], answer: "Barry Lyndon", cat: "bts", detail: "Kubrick used Zeiss f/0.7 lenses to film by candlelight" },
  { q: "What film was shot at 96 frames per second?", options: ["Gemini Man", "The Hobbit", "Avatar: The Way of Water", "Billy Lynn's Long Halftime Walk"], answer: "Gemini Man", cat: "bts", detail: "Ang Lee's 2019 high frame rate experiment" },
  { q: "Who is the only person to be nominated for Oscar acting and Best Picture as producer for the same film?", options: ["Warren Beatty", "Clint Eastwood", "Brad Pitt", "George Clooney"], answer: "Warren Beatty", cat: "oscar", detail: "For Heaven Can Wait (1978)" },
  { q: "What film holds the record for most Oscar nominations without winning any?", options: ["The Turning Point", "The Color Purple", "Gangs of New York", "True Grit"], answer: "The Turning Point", cat: "oscar", detail: "11 nominations, 0 wins in 1977" },
  { q: "Which composer scored both There Will Be Blood and Phantom Thread?", options: ["Jonny Greenwood", "Hans Zimmer", "Mica Levi", "Nicholas Britell"], answer: "Jonny Greenwood", cat: "soundtrack", detail: "Radiohead guitarist turned film composer" },
  { q: "What year was Wings (first Best Picture winner) released?", options: ["1927", "1929", "1930", "1925"], answer: "1927", cat: "year", detail: "Silent WWI aviation film" },
  { q: "What is the longest film to win the Palme d'Or?", options: ["The Best of Youth", "Titane", "Pulp Fiction", "Once Upon a Time in America"], answer: "The Best of Youth", cat: "trivia", detail: "Over 6 hours long, won in 2003" },
  { q: "What is the Kuleshov Effect?", options: ["Editing creates meaning from juxtaposed shots", "A camera trick for forced perspective", "A lighting technique for noir", "A sound design principle"], answer: "Editing creates meaning from juxtaposed shots", cat: "trivia", detail: "Foundational editing theory from the 1920s" },
  { q: "What film technique is named after Alfred Hitchcock?", options: ["Dolly zoom (Vertigo effect)", "Jump cut", "Dutch angle", "Tracking shot"], answer: "Dolly zoom (Vertigo effect)", cat: "trivia", detail: "First used in Vertigo (1958)" },
  { q: "What does \"diegetic sound\" mean in film?", options: ["Sound that exists within the film's world", "Sound added in post-production", "Background music", "Sound effects"], answer: "Sound that exists within the film's world", cat: "trivia", detail: "Characters can hear it too" },
  { q: "Who directed Come and See (1985)?", options: ["Elem Klimov", "Andrei Tarkovsky", "Nikita Mikhalkov", "Aleksandr Sokurov"], answer: "Elem Klimov", cat: "director", detail: "Harrowing Belarusian WWII film" },
  { q: "Who directed Tokyo Story?", options: ["Yasujirō Ozu", "Akira Kurosawa", "Kenji Mizoguchi", "Mikio Naruse"], answer: "Yasujirō Ozu", cat: "director", detail: "1953 family drama masterpiece" },
  { q: "Who directed Breathless (1960)?", options: ["Jean-Luc Godard", "François Truffaut", "Alain Resnais", "Claude Chabrol"], answer: "Jean-Luc Godard", cat: "director", detail: "French New Wave landmark" },
  { q: "Who directed Ugetsu (1953)?", options: ["Kenji Mizoguchi", "Akira Kurosawa", "Yasujirō Ozu", "Mikio Naruse"], answer: "Kenji Mizoguchi", cat: "director", detail: "Japanese ghost story classic" },
  { q: "Who played the lead in The Passion of Joan of Arc (1928)?", options: ["Renée Jeanne Falconetti", "Lillian Gish", "Louise Brooks", "Greta Garbo"], answer: "Renée Jeanne Falconetti", cat: "cast", detail: "Often called the greatest performance in cinema" },
  { q: "What is the Rashomon Effect?", options: ["Multiple contradictory accounts of the same event", "A camera tracking technique", "A type of film noir lighting", "A narrative structure with flashbacks"], answer: "Multiple contradictory accounts of the same event", cat: "trivia", detail: "Named after Kurosawa's 1950 film" },
  { q: "What is a Steadicam and which film popularized it?", options: ["Camera stabilizer; The Shining", "A type of crane; Citizen Kane", "A dolly system; Goodfellas", "A shoulder rig; Saving Private Ryan"], answer: "Camera stabilizer; The Shining", cat: "trivia", detail: "Garrett Brown invented it in the 1970s" },
  { q: "What film movement was Breathless (1960) a part of?", options: ["French New Wave", "Italian Neorealism", "German Expressionism", "Dogme 95"], answer: "French New Wave", cat: "trivia", detail: "Nouvelle Vague" },
  { q: "What is Italian Neorealism?", options: ["Post-WWII movement using non-actors and real locations", "A style of opera filmmaking", "Renaissance-era film restoration", "A type of documentary technique"], answer: "Post-WWII movement using non-actors and real locations", cat: "trivia", detail: "Bicycle Thieves, Rome Open City" },
  { q: "Which film is considered the first German Expressionist film?", options: ["The Cabinet of Dr. Caligari", "Nosferatu", "M", "Metropolis"], answer: "The Cabinet of Dr. Caligari", cat: "trivia", detail: "1920, with its distorted sets" },
  { q: "Who composed the score for Mishima: A Life in Four Chapters?", options: ["Philip Glass", "John Williams", "Ryuichi Sakamoto", "Hans Zimmer"], answer: "Philip Glass", cat: "soundtrack", detail: "Glass's minimalist masterpiece" },
  { q: "Who composed the score for The Assassination of Jesse James?", options: ["Nick Cave & Warren Ellis", "Jonny Greenwood", "Gustavo Santaolalla", "Clint Mansell"], answer: "Nick Cave & Warren Ellis", cat: "soundtrack", detail: "Haunting Americana" },
  { q: "What year was Psycho released?", options: ["1960", "1958", "1962", "1959"], answer: "1960", cat: "year", detail: "Hitchcock's shower scene shocker" },
  { q: "What year was Apocalypse Now released?", options: ["1979", "1978", "1980", "1977"], answer: "1979", cat: "year", detail: "Coppola's Vietnam opus" },
  { q: "What year was Taxi Driver released?", options: ["1976", "1975", "1977", "1974"], answer: "1976", cat: "year", detail: "Scorsese's New York nightmare" },
  { q: "What is the Bechdel Test?", options: ["Two women talk to each other about something other than a man", "A film must have a female director", "Women must have equal screen time", "A film passes racial diversity checks"], answer: "Two women talk to each other about something other than a man", cat: "trivia", detail: "Named after cartoonist Alison Bechdel" },
  { q: "Which film's production went so over-budget it bankrupted United Artists?", options: ["Heaven's Gate", "Apocalypse Now", "Cleopatra", "Waterworld"], answer: "Heaven's Gate", cat: "bts", detail: "Michael Cimino's 1980 western disaster" },
  { q: "Who invented the match cut technique famously used in 2001: A Space Odyssey?", options: ["Stanley Kubrick", "Sergei Eisenstein", "D.W. Griffith", "Georges Méliès"], answer: "Stanley Kubrick", cat: "bts", detail: "Bone to satellite — cinema's greatest cut" },
  { q: "Who directed Goodbye to Language?", options: ["Jean-Luc Godard", "Michael Haneke", "Lars von Trier", "Terrence Malick"], answer: "Jean-Luc Godard", cat: "director", detail: "Godard's 3D experiment at age 83" },
  { q: "Who directed Beau Travail?", options: ["Claire Denis", "Agnès Varda", "Chantal Akerman", "Céline Sciamma"], answer: "Claire Denis", cat: "director", detail: "French Foreign Legion in Djibouti" },
  { q: "Who directed Winter Sleep?", options: ["Nuri Bilge Ceylan", "Asghar Farhadi", "Abbas Kiarostami", "Andrei Zvyagintsev"], answer: "Nuri Bilge Ceylan", cat: "director", detail: "Turkish Palme d'Or winner" },
  { q: "What is the Dogme 95 movement?", options: ["Stripped-down filmmaking with strict rules", "Danish horror cinema", "Experimental silent film revival", "A visual effects technique"], answer: "Stripped-down filmmaking with strict rules", cat: "trivia", detail: "Founded by Lars von Trier and Thomas Vinterberg" },
  { q: "What is a 'long take' and which director is famous for them?", options: ["Unbroken shot; Tarkovsky", "Slow motion; Kubrick", "Handheld camera; Spielberg", "Time-lapse; Nolan"], answer: "Unbroken shot; Tarkovsky", cat: "trivia", detail: "Tarkovsky's takes often exceed 4 minutes" },
  { q: "What film was the first to win the Palme d'Or?", options: ["Marty (shared)", "The Third Man", "La Dolce Vita", "The Wages of Fear"], answer: "Marty (shared)", cat: "trivia", detail: "1955, shared with a documentary" },
  { q: "What year was The Leopard released?", options: ["1963", "1960", "1965", "1958"], answer: "1963", cat: "year", detail: "Visconti's Italian epic with Burt Lancaster" },
  { q: "What year was Sans Soleil released?", options: ["1983", "1985", "1980", "1978"], answer: "1983", cat: "year", detail: "Chris Marker's essay film" },
  { q: "What year was Caché (Hidden) released?", options: ["2005", "2007", "2003", "2009"], answer: "2005", cat: "year", detail: "Haneke's surveillance thriller" },
  { q: "Who composed the score for The Revenant?", options: ["Ryuichi Sakamoto & Alva Noto", "Hans Zimmer", "Jonny Greenwood", "Johann Johannsson"], answer: "Ryuichi Sakamoto & Alva Noto", cat: "soundtrack", detail: "Electronic ambient meets frontier survival" },
  { q: "Who composed the score for Arrival?", options: ["Jóhann Jóhannsson", "Hans Zimmer", "Max Richter", "Mica Levi"], answer: "Jóhann Jóhannsson", cat: "soundtrack", detail: "Icelandic composer's alien linguistics score" },
  { q: "Who composed the score for Blade Runner?", options: ["Vangelis", "Hans Zimmer", "John Williams", "Tangerine Dream"], answer: "Vangelis", cat: "soundtrack", detail: "Greek composer's synth masterpiece" },
  { q: "Which director has the most Palme d'Or wins?", options: ["No director has won more than two", "Terrence Malick", "Lars von Trier", "Michael Haneke"], answer: "No director has won more than two", cat: "oscar", detail: "Several directors have won twice" },
  { q: "What was the first animated film to be nominated for the Palme d'Or?", options: ["Waltz with Bashir", "Persepolis", "The Tale of the Princess Kaguya", "Spirited Away"], answer: "Waltz with Bashir", cat: "oscar", detail: "2008 Israeli animated documentary" },
  { q: "Which film won both the Golden Bear (Berlin) and the Oscar for Best Picture?", options: ["No film has done both", "12 Angry Men", "Shakespeare in Love", "The Artist"], answer: "No film has done both", cat: "oscar", detail: "The festivals rarely overlap in taste" },
  { q: "What was the first documentary to win the Palme d'Or?", options: ["Fahrenheit 9/11", "The Thin Blue Line", "Man on Wire", "Bowling for Columbine"], answer: "Fahrenheit 9/11", cat: "oscar", detail: "Michael Moore's 2004 controversial win" },
  { q: "What technique did Kubrick borrow from NASA for Barry Lyndon?", options: ["Ultra-fast lenses for candlelight filming", "Satellite imagery", "Zero-gravity simulation", "Space suit cooling systems"], answer: "Ultra-fast lenses for candlelight filming", cat: "bts", detail: "Zeiss f/0.7 lenses originally made for moon photography" },
  { q: "Which filmmaker famously shot a film in one single 96-minute take?", options: ["Alexander Sokurov (Russian Ark)", "Alejandro González Iñárritu", "Sam Mendes", "Alfred Hitchcock"], answer: "Alexander Sokurov (Russian Ark)", cat: "bts", detail: "2002, shot in the Hermitage Museum" },
];
...
const CAT_COLORS = {
  year: "#BBA149", cast: "#EBE4CF", director: "#BBA149", oscar: "#EBE4CF", quote: "#BBA149", trivia: "#EBE4CF", bts: "#BBA149", soundtrack: "#EBE4CF", boxoffice: "#BBA149",
};
...
export default function Reel() {
  ...
  const catColor = currentQ ? CAT_COLORS[currentQ.cat] : "#EBE4CF";
    ...
    <div style={{
      ...
      {pulse && (
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(230,234,215,0.06) 0%, transparent 60%)",
      ...
      <div style={{
        ...
        {gameState === "menu" && (
          <div style={{ textAlign: "center", paddingTop: 80 }}>
            ...
            <button onClick={startGame} style={{
              background: "#D03D01", color: "#EBE4CF", border: "none",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 0 }}>
                <span style={{
                  fontSize: 28, fontFamily: "'Space Mono', monospace", fontWeight: 700, color: "#EBE4CF",
                }}>{chain}</span>
              </div>
            </div>

            <div style={{ height: 3, background: "#EBE4CF15", borderRadius: 2, marginBottom: 32, overflow: "hidden" }}>
              <div style={{
                height: "100%",
                width: `${Math.min(((current) / Math.max(questions.length - 1, 1)) * 100, 100)}%`,
                background: "#D03D01", borderRadius: 2, transition: "width 0.5s ease",
              }} />
            </div>

            <div style={{
              background: "#EBE4CF08", borderRadius: 16, padding: "36px 28px",
              marginBottom: 20, border: "1px solid #EBE4CF10",
            }}>
              <h2 style={{
                fontSize: 22, fontWeight: 600, fontFamily: "'Syne', sans-serif",
                color: "#EBE4CF", margin: 0, lineHeight: 1.35, textAlign: "center",
              }}>
                {currentQ.q}
              </h2>
            </div>
              ...
              {currentQ.options.map((opt, i) => {
                ...
                if (showResult) {
                  if (opt === currentQ.answer) {
                    bg = "#EBE4CF"; border = "#EBE4CF"; color = "#26302E"; weight = 600;
                  } else if (opt === selected && !isCorrect) {
                    bg = "#D03D01"; border = "#D03D01"; color = "#EBE4CF"; weight = 600;
                  } else {
                    bg = "#EBE4CF04"; border = "#EBE4CF08"; color = "#EBE4CF22";
                  }
                }
                ...
                return (
                  ...
                  onMouseEnter={(e) => {
                    if (!showResult) { e.target.style.borderColor = "#EBE4CF50"; e.target.style.background = "#EBE4CF10"; }
                  }}
                  onMouseLeave={(e) => {
                    if (!showResult && opt !== selected) { e.target.style.borderColor = "#EBE4CF18"; e.target.style.background = "#EBE4CF06"; }
                  }}
                  >
                    <span style={{
                      width: 28, height: 28, borderRadius: 8,
                      background: showResult && opt === currentQ.answer ? "#EBE4CF20" : showResult && opt === selected && !isCorrect ? "#EBE4CF20" : "#EBE4CF10",
                      border: `1px solid ${showResult && (opt === currentQ.answer || (opt === selected && !isCorrect)) ? "#EBE4CF15" : "#EBE4CF15"}`,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontSize: 12, fontFamily: "'Space Mono', monospace", fontWeight: 700,
                      color: showResult && (opt === currentQ.answer || (opt === selected && !isCorrect)) ? "#26302E" : "#BBA14960",
                      flexShrink: 0,
                    }}>
            ...
            {showResult && (
              <div style={{
                ...
                color: "#BBA149", animation: "fadeIn 0.3s ease",
              }}>
                {currentQ.detail}
              </div>
            )}
        ...
        {(gameState === "wrong" || gameState === "gameover") && (
          <div style={{
            ...
            <div style={{ width: 36, height: 3, background: "#D03D01", borderRadius: 2, margin: "8px auto 12px" }} />
            ...
            {showRank && pastReels.length > 0 && (() => {
              ...
              const showBestBar = allTimeBest > 0;
              const maxVal = Math.max(allTimeBest, 1);
              return (
                <div style={{
                  background: "#EBE4CF06", borderRadius: 16, padding: "20px 24px",
                  marginBottom: 20, textAlign: "left", border: "1px solid #EBE4CF08",
                }}>
                  <div style={{
                    fontSize: 11, letterSpacing: 2, color: "#BBA149",
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {reversed.map((score, i) => {
                      ...
                      return (
                        <div key={`session-${i}`} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                          <span style={{
                            fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#BBA149",
                            minWidth: 20, textAlign: "right",
                          }}>{gameNum}</span>
                          <div style={{ flex: 1, height: 32, background: "#EBE4CF08", borderRadius: 8, overflow: "hidden" }}>
                            <div style={{
                              height: "100%", width: `${Math.max((score / maxVal) * 100, 12)}%`,
                              background: isLatest ? "#EBE4CF" : "#EBE4CF40",
                              ...
                              <span style={{
                                ...
                                fontWeight: 700, color: isLatest ? "#26302E" : "#EBE4CF",
                              }}>{score}</span>
                            </div>
                          </div>
                        </div>
                    ...
                    {showBestBar && (() => {
                      ...
                      <div style={{
                        ...
                        borderTop: "1px solid #EBE4CF10", paddingTop: 12,
                      }}>
                        <span style={{
                          fontFamily: "'Space Mono', monospace", fontSize: 9, color: "#EBE4CF",
                          minWidth: 20, textAlign: "right", letterSpacing: 1,
                        }}>best</span>
                        <div style={{ flex: 1, height: 32, background: "#EBE4CF08", borderRadius: 8, overflow: "hidden" }}>
                          <div style={{
                            height: "100%", width: `${Math.max((allTimeBest / maxVal) * 100, 12)}%`,
                            background: "#BBA149", borderRadius: 8,
                            display: "flex", alignItems: "center", justifyContent: "flex-end", paddingRight: 10,
                          }}>
                            <span style={{
                              fontFamily: "'Space Mono', monospace", fontSize: 12,
                              fontWeight: 700, color: "#26302E",
                            }}>{allTimeBest}</span>
                          </div>
                        </div>
                        <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, color: "#BBA149", letterSpacing: 1 }}>{bestRank.title}</span>
                      </div>
                      );
                    })()}
                  </div>
            ...
            {showRank && <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap", animation: "fadeIn 0.5s ease" }}>
              <button onClick={startGame} style={{
                background: "#EBE4CF", color: "#26302E", border: "none",
              ...
              <button onClick={() => {
                ...
                background: "transparent", color: "#EBE4CF",
                border: "1.5px solid #EBE4CF40",
                padding: "14px 28px", borderRadius: 30,
                fontSize: 14, fontWeight: 700, fontFamily: "'Syne', sans-serif",
                letterSpacing: 2, textTransform: "uppercase", cursor: "pointer",
                transition: "all 0.2s",
              }}
              onMouseEnter={(e) => { e.target.style.borderColor = "#EBE4CF80"; }}
              onMouseLeave={(e) => { e.target.style.borderColor = "#EBE4CF40"; }}
              >
                SHARE
              </button>
            </div>}
      ...
      <style>{`
        ...
        ::-webkit-scrollbar-thumb { background: #BBA149; border-radius: 4px; }
      `}</style>
    </div>
  );
}
